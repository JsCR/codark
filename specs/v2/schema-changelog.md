...
- Canonical tagged tool file sources in `@codark-ai/llm`.
...
- Canonicalize ambient instruction traversal boundaries, honor `CODARK_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.
