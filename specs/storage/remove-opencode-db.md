# Remove `packages/codark/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/codark/src/storage/db.ts` module.
...
Production imports from `packages/codark/src/storage/db.ts` are concentrated in 22 source files:

- `packages/codark/src/account/repo.ts`
- `packages/codark/src/cli/cmd/db.ts`
- `packages/codark/src/cli/cmd/import.ts`
- `packages/codark/src/cli/cmd/stats.ts`
- `packages/codark/src/control-plane/workspace.ts`
- `packages/codark/src/index.ts`
- `packages/codark/src/node.ts`
- `packages/codark/src/permission/index.ts`
- `packages/codark/src/project/project.ts`
- `packages/codark/src/server/projectors.ts`
- `packages/codark/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/codark/src/server/shared/fence.ts`
- `packages/codark/src/session/message-v2.ts`
- `packages/codark/src/session/projectors.ts`
- `packages/codark/src/session/prompt.ts`
- `packages/codark/src/session/session.ts`
- `packages/codark/src/session/todo.ts`
- `packages/codark/src/share/share-next.ts`
- `packages/codark/src/storage/db.ts`
- `packages/codark/src/sync/index.ts`
- `packages/codark/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/codark/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/codark/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/codark`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/codark/src`
- `bun typecheck` from `packages/codark`
- Relevant package tests from `packages/codark`, not the repo root
