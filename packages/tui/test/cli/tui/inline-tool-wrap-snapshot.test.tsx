...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/codark/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/codark (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/codark/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/codark/src/index.ts [offset=1, limit=100]",
