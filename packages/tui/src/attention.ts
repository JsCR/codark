...
import defaultSoundPath from "@codark-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@codark-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@codark-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@codark-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@codark-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@codark-ai/ui/audio/yup-01.mp3" with { type: "file" }
