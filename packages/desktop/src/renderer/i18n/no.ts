export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Codark",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Codark er lastet ned. Vil du installere den og starte på nytt?",
