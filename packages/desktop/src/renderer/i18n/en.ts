export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Codark",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Codark has been downloaded, would you like to install it and relaunch?",
