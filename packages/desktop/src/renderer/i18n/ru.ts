export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Codark",
  ...
  "desktop.updater.downloaded.prompt": "Версия Codark {{version}} загружена. Хотите установить и перезапустить?",
