export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Codark",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Codark، هل ترغب في تثبيته وإعادة تشغيله؟",
