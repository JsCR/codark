export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Codark",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Codark er blevet downloadet. Vil du installere den og genstarte?",
