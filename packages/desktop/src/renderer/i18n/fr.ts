export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Codark",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Codark a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
