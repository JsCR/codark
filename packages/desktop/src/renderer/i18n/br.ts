export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Codark",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Codark foi baixada. Você gostaria de instalá-la e reiniciar?",
