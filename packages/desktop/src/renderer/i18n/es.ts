export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Codark",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Codark. ¿Quieres instalarla y reiniciar?",
