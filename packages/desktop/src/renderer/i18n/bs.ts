export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Codark-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Codark-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
