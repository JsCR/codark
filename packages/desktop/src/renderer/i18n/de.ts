export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Codark",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Codark wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
