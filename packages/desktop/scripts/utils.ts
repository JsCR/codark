...
export function resolveChannel(): Channel {
  const raw = Bun.env.CODARK_CHANNEL
...
export const CLI_BINARIES: Array<{ rustTarget: string; package: string; os: string; cpu: string }> = [
  {
    ...
    package: "@codark-ai/cli-darwin-arm64",
    os: "darwin",
    cpu: "arm64",
  },
  {
    rustTarget: "x86_64-apple-darwin",
    package: "@codark-ai/cli-darwin-x64-baseline",
    os: "darwin",
    cpu: "x64",
  },
  {
    rustTarget: "aarch64-pc-windows-msvc",
    package: "@codark-ai/cli-windows-arm64",
    os: "win32",
    cpu: "arm64",
  },
  {
    rustTarget: "x86_64-pc-windows-msvc",
    package: "@codark-ai/cli-windows-x64-baseline",
    os: "win32",
    cpu: "x64",
  },
  {
    rustTarget: "x86_64-unknown-linux-gnu",
    package: "@codark-ai/cli-linux-x64-baseline",
    os: "linux",
    cpu: "x64",
  },
  {
    rustTarget: "aarch64-unknown-linux-gnu",
    package: "@codark-ai/cli-linux-arm64",
    os: "linux",
    cpu: "arm64",
  },
]
...
export async function downloadCliToResources() {
  ...
  const directory = await mkdtemp(join(tmpdir(), "codark-cli-"))
  const dest = windowsify("resources/codark-cli")
  try {
