...
const releaseId = process.env.CODARK_RELEASE
if (!releaseId) throw new Error("CODARK_RELEASE is required")

const version = process.env.CODARK_VERSION
if (!version) throw new Error("CODARK_VERSION is required")
...
const macxTarGz = "codark-desktop-mac-x64.app.tar.gz"
const macaTarGz = "codark-desktop-mac-arm64.app.tar.gz"
