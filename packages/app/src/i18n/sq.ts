export const dict = {
  ...
  "dialog.provider.codark.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.codark.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.codarkGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "provider.connect.codarkZen.visit.prefix": "Vizitoni ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode është gati në {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode është gati.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode nuk është i instaluar",
