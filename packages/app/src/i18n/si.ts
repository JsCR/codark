export const dict: Record<string, string> = {
  ...
  "dialog.provider.codark.note": "Claude, GPT, Gemini සහ තවත් දේ ඇතුළුව සංවෘත ආකෘති",
  "dialog.provider.codark.tagline": "විශ්වසනීය ප්රශස්ත මාදිලි",
  "dialog.provider.codarkGo.tagline": "සෑම කෙනෙකුටම අඩු වියදම් දායකත්වයක්",
  ...
  "provider.connect.codarkZen.visit.prefix": "පිවිසෙන්න",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "ඔබගේ API යතුර එකතු කිරීමට.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}} හි සූදානම්ය.",
  "wsl.onboarding.codarkReady": "OpenCode සූදානම්.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode ස්ථාපනය කර නැත",
