...
export const dict = {
  ...
  "dialog.provider.codark.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.codark.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.codarkGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Codark",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Codark zu nutzen.",
  ...
  "provider.connect.codarkZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Codark zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Codark zu nutzen.",
  ...
  "dialog.plugins.empty": "In codark.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Codark-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Codark wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Codark in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Codark wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Codark in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Codark in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Codark aktualisieren",
  "wsl.onboarding.codarkReadyIn": "Codark ist in {{distro}} bereit.",
  "wsl.onboarding.codarkReady": "Codark ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Codark in {{distro}}.",
  "wsl.onboarding.installOpencode": "Codark installieren",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Codark einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Codark konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Codark erneut.",
  ...
  "toast.update.description": "Eine neue Version von Codark ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Codark-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (codark.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Codark unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Codark mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Codark enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Codark Desktop",
  ...
  "settings.desktop.wsl.description": "Codark-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Codark ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Codark auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Codark dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Codark anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Codark automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Codark ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Codark wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Codark konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Codark-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Codark reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Codark-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Codark-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Codark Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
