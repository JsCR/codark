...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Codark zu nutzen.",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (codark.json) auf Anbieter-/Modellnamen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Codark.",
