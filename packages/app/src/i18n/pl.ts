export const dict = {
  ...
  "dialog.provider.codark.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.codark.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.codarkGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w codark.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (codark.json) nazwy dostawców/modeli",
