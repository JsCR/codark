export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Codark",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Codark",
  "desktop.recovery.terminated": "Okno Codark zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Codark nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Codark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Codark została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.codark.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.codark.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.codarkGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Codark",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Codark.",
  ...
  "provider.connect.codarkZen.visit.prefix": "Odwiedź ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Codark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Codark.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku codark.json",
  ...
  "dialog.server.description": "Przełącz serwer Codark, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Codark...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Codark w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Codark...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Codark w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Codark w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Codark",
  "wsl.onboarding.codarkReadyIn": "Codark jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.codarkReady": "Codark jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Codark w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Codark",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Codark będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Codark nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Codark.",
  ...
  "help.tabs.introduction": "Codark Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Codark ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Codark",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (codark.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Codark nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Codark zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Codark wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Codark",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Codark na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Codark ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Codark.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Codark",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Codark.",
