export const dict = {
  ...
  "dialog.provider.codark.note": "Подбрани модели, включително Claude, GPT, Gemini и други",
  "dialog.provider.codark.tagline": "Надеждни оптимизирани модели",
  "dialog.provider.codarkGo.tagline": "Абонамент на ниска цена за всеки",
  ...
  "provider.connect.codarkZen.visit.suffix": "за да вземете своя ключ API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode е готов в {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode е готов.",
