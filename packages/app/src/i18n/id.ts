export const dict = {
  ...
  "dialog.provider.codark.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.codark.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.codarkGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "provider.connect.codarkZen.visit.prefix": "Kunjungi ",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode siap di {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode siap.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode belum terinstal",
