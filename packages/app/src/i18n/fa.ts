export const dict = {
  ...
  "dialog.provider.codark.note": "مدل های انتخاب شده از جمله Claude، GPT، Gemini و موارد دیگر",
  "dialog.provider.codark.tagline": "مدل های بهینه شده قابل اعتماد",
  "dialog.provider.codarkGo.tagline": "اشتراک کم هزینه برای همه",
  ...
  "provider.connect.codarkZen.visit.prefix": "بازدید کنید ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " برای جمع آوری کلید API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode در {{distro}} آماده است.",
  "wsl.onboarding.codarkReady": "OpenCode آماده است.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode نصب نشده است",
