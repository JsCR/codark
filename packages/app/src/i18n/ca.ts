export const dict = {
  ...
  "dialog.provider.codark.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.codark.tagline": "Models optimitzats fiables",
  "dialog.provider.codarkGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "provider.connect.codarkZen.visit.suffix": " per recollir la teva clau API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode està llest a {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode està llest.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode no instal·lat",
