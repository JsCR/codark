export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Codark",
  ...
  "desktop.menu.ariaLabel": "Menu Codark",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Codark",
  "desktop.recovery.terminated": "La fenêtre Codark s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Codark ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Codark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Codark est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.codark.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.codark.tagline": "Modèles optimisés et fiables",
  "dialog.provider.codarkGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Codark",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Codark.",
  ...
  "provider.connect.codarkZen.visit.prefix": "Visitez ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Codark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Codark.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans codark.json",
  ...
  "dialog.server.description": "Changez le serveur Codark auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Codark...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Codark dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Codark...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Codark dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Codark dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Codark",
  "wsl.onboarding.codarkReadyIn": "Codark est prêt dans {{distro}}.",
  "wsl.onboarding.codarkReady": "Codark est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Codark dans {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Codark puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Codark n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Codark.",
  ...
  "help.tabs.introduction": "Codark Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Codark ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Codark",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (codark.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Codark ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Codark inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Codark dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Codark",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Codark sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Codark suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Codark.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Codark",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Codark.",
