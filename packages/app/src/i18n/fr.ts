export const dict = {
  ...
  "wsl.onboarding.opencodeReadyIn": "Codark est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codark est prêt.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codark non installé",
