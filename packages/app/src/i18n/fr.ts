export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans codark.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (codark.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Codark ne supporte pas encore l'authentification MCP.",
