export const dict = {
  ...
  "dialog.provider.codark.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.codark.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.codarkGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "provider.connect.codarkZen.line1": "OpenCode ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.codarkZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.codarkZen.visit.prefix": "ጎብኝ ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  ...
  "wsl.onboarding.step.codark": "OpenCode",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.codarkReady": "OpenCode ዝግጁ ነው።",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCodeአልተጫነም",
