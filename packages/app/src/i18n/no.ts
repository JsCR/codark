...
export const dict = {
  ...
  "desktop.menu.documentation": "Codark-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Codark-meny",
  ...
  "desktop.recovery.loadFailed": "Codark kunne ikke lastes inn",
  "desktop.recovery.terminated": "Codark-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Codark svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Codark mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Codark er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.codark.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.codark.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.codarkGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Codark",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Codark.",
  ...
  "provider.connect.codarkZen.visit.prefix": "Besøk ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Codark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Codark.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i codark.json",
  ...
  "dialog.server.description": "Bytt hvilken Codark-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Codark ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Codark-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (codark.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Codark ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Codark inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Codark-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Codark",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Codark ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Codark skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Codark.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Codark starter",
  ...
  "settings.updates.toast.latest.title": "Codark er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Codark.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Codark...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Codark i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Codark...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Codark i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Codark i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Codark",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Codark kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Codark kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Codark på nytt.",
  ...
  "help.tabs.introduction": "Codark Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
