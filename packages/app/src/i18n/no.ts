...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Codark.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i codark.json",
  ...
  "settings.general.row.colorScheme.description": "Velg om Codark skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Codark er tematisert.",
