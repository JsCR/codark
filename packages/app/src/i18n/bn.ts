export const dict: Record<string, string> = {
  ...
  "dialog.provider.codark.note": "Claude, GPT, Gemini এবং আরও অনেক কিছু সহ কিউরেট করা মডেল",
  "dialog.provider.codark.tagline": "নির্ভরযোগ্য অপ্টিমাইজ করা মডেল",
  "dialog.provider.codarkGo.tagline": "সবার জন্য কম খরচে সাবস্ক্রিপশন",
  ...
  "provider.connect.codarkZen.visit.prefix": "ভিজিট করুন",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "আপনার API কী সংগ্রহ করতে।",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}}-এ প্রস্তুত।",
  "wsl.onboarding.codarkReady": "OpenCode প্রস্তুত।",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode ইনস্টল করা নেই",
