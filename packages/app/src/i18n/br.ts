export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Codark",
  ...
  "desktop.menu.ariaLabel": "Menu do Codark",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Codark",
  "desktop.recovery.terminated": "A janela do Codark foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Codark não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Codark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Codark não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Codark foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.codark.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.codark.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.codarkGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Codark",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Codark.",
  ...
  "provider.connect.codarkZen.visit.prefix": "Visite ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Codark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Codark.",
  ...
  "dialog.plugins.empty": "Plugins configurados em codark.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Codark este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Codark...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Codark em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Codark...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Codark em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Codark em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Codark",
  "wsl.onboarding.codarkReadyIn": "O Codark está pronto em {{distro}}.",
  "wsl.onboarding.codarkReady": "O Codark está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Codark em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Codark",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Codark possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Codark não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Codark novamente.",
  ...
  "help.tabs.introduction": "Agora, o Codark Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Codark ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Codark",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (codark.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Codark ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Codark inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Codark dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Codark",
  ...
  "settings.general.row.appearance.description": "Personalize como o Codark aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Codark segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Codark é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Codark iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Codark.",
