export const dict = {
  ...
  "wsl.onboarding.opencodeReadyIn": "O Codark está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Codark está pronto.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codark não instalado",
