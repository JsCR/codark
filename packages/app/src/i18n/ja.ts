export const dict = {
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のCodarkの準備ができました。",
  "wsl.onboarding.opencodeReady": "Codarkの準備ができました。",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codarkがインストールされていません",
