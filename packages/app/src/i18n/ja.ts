export const dict = {
  ...
  "desktop.recovery.loadFailed": "Codarkを読み込めませんでした",
  "desktop.recovery.terminated": "Codarkのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Codarkが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Codarkのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはCodarkがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Codarkのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.codark.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.codark.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.codarkGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Codarkが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Codarkで{{provider}}モデルを使用します。",
  ...
  "provider.connect.codarkZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.codarkZen.visit.prefix": " ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCodarkで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Codarkで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "codark.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するCodarkサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Codarkを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のCodarkを確認中...",
  "wsl.onboarding.updatingOpencode": "Codarkを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のCodarkを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のCodarkを更新してください。",
  "wsl.onboarding.updateOpencode": "Codarkを更新",
  "wsl.onboarding.codarkReadyIn": "{{distro}}内のCodarkの準備ができました。",
  "wsl.onboarding.codarkReady": "Codarkの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にCodarkをインストールしてください。",
  "wsl.onboarding.installOpencode": "Codarkをインストール",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codarkがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CodarkでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Codarkをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Codark Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Codarkの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCodarkチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (codark.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CodarkはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Codarkには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCodarkサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Codarkの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCodarkの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Codarkがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Codarkのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Codark の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Codark は最新バージョンです。",
