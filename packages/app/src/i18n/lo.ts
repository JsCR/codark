export const dict = {
  ...
  "dialog.provider.codark.note": "ແບບທີ່ຄັດສັນມາລວມທັງ Claude, GPT, Gemini ແລະອື່ນໆ",
  "dialog.provider.codark.tagline": "ຮູບແບບການເພີ່ມປະສິດທິພາບທີ່ເຊື່ອຖືໄດ້",
  "dialog.provider.codarkGo.tagline": "ການສະໝັກໃຊ້ລາຄາຕໍ່າສຳລັບທຸກຄົນ",
  ...
  "provider.connect.codarkZen.visit.prefix": "ຢ້ຽມຢາມ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "ເພື່ອເກັບກຳລະຫັດ API ຂອງທ່ານ.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode ແມ່ນພ້ອມແລ້ວໃນ {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode ພ້ອມແລ້ວ.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode ບໍ່ໄດ້ຕິດຕັ້ງ",
