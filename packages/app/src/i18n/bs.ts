export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Codark",
  ...
  "desktop.menu.ariaLabel": "Codark meni",
  ...
  "desktop.recovery.loadFailed": "Codark se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Codark-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Codark ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Codark-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Codark-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.codark.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.codark.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.codarkGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Codark",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Codark-u.",
  ...
  "provider.connect.codarkZen.visit.prefix": "Posjeti ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Codark-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Codark-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u codark.json",
  ...
  "dialog.server.description": "Promijeni na koji se Codark server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Codark...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Codark u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Codark...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Codark u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Codark u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Codark",
  "wsl.onboarding.codarkReadyIn": "Codark je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.codarkReady": "Codark je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Codark u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Codark",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Codark mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Codark nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Codark.",
  ...
  "help.tabs.introduction": "Codark Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Codark-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Codark timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (codark.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Codark još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Codark uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Codark server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Codark-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Codark izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Codark prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Codark-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Codark pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Codark-a.",
