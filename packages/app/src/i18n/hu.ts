...
export const dict = {
  ...
  "dialog.provider.codark.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.codark.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.codarkGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "provider.connect.codarkZen.visit.prefix": "Látogatás",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "hogy átvegye a API kulcsát.",
  ...
  "wsl.onboarding.codarkReadyIn": "A OpenCode készen áll a {{distro}}-ben.",
  "wsl.onboarding.codarkReady": "A OpenCode készen áll.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "A OpenCode nincs telepítve",
