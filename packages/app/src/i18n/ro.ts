export const dict = {
  ...
  "dialog.provider.codark.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.codark.tagline": "Modele optimizate, fiabile",
  "dialog.provider.codarkGo.tagline": "Abonament accesibil pentru toți",
  ...
  "provider.connect.codarkZen.visit.prefix": "Vizitează",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "pentru a obține cheia ta API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode este gata în {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode este gata.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode nu este instalat",
