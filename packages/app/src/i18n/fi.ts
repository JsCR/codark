export const dict = {
  ...
  "dialog.provider.codark.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.codark.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.codarkGo.tagline": "Edullinen tilaus kaikille",
  ...
  "provider.connect.codarkZen.visit.prefix": "Avaa ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " ja hae API-avaimesi.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode on valmis jakelussa {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCodea ei ole asennettu",
