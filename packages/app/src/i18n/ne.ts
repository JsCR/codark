export const dict: Record<string, string> = {
  ...
  "dialog.provider.codark.note": "Claude, GPT, Gemini र थप सहित क्युरेट गरिएका मोडेलहरू",
  "dialog.provider.codark.tagline": "भरपर्दो अनुकूलित मोडेलहरू",
  "dialog.provider.codarkGo.tagline": "सबैको लागि कम लागत सदस्यता",
  ...
  "provider.connect.codarkZen.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "तपाईँको API कुञ्जी सङ्कलन गर्न।",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}} मा तयार छ।",
  "wsl.onboarding.codarkReady": "OpenCode तयार छ।",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode स्थापित छैन",
