...
export const dict = {
  ...
  "dialog.provider.codark.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Codark",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Codark.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Codark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Codark.",
  ...
  "dialog.plugins.empty": "Plugins configured in codark.json",
  ...
  "dialog.server.description": "Switch which Codark server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Codark...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Codark in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Codark...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Codark in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Codark in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Codark",
  "wsl.onboarding.codarkReadyIn": "Codark is ready in {{distro}}.",
  "wsl.onboarding.codarkReady": "Codark is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Codark in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Codark",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Codark can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Codark could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Codark.",
  ...
  "help.tabs.introduction": "Codark Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Codark ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Codark team",
  ...
  "error.chain.checkConfig": "Check your config (codark.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Codark does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Codark includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Codark server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Codark",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Codark looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Codark follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Codark is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Codark launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Codark.",
