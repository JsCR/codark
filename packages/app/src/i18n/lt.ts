...
export const dict = {
  ...
  "dialog.provider.codark.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.codark.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.codarkGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "provider.connect.codarkZen.visit.prefix": "Aplankykite",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode yra paruoštas {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode yra paruoštas.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode neįdiegtas",
