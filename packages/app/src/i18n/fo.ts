export const dict = {
  ...
  "dialog.provider.codark.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.codark.tagline": "Álítandi optimerað modell",
  "dialog.provider.codarkGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "provider.connect.codarkZen.visit.prefix": "Vitja ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " fyri at savna tín API lykil.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode er klárt í {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode er klárt.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode ikki innstillað",
