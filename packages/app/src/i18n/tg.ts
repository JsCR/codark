export const dict = {
  ...
  "dialog.provider.codark.note": "Моделҳои интихобшуда, аз ҷумла Claude, GPT, Gemini ва ғайра",
  "dialog.provider.codark.tagline": "Моделҳои боэътимоди оптимизатсияшуда",
  "dialog.provider.codarkGo.tagline": "Обунаи арзон барои ҳама",
  ...
  "provider.connect.codarkZen.visit.prefix": "Ташриф",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "барои гирифтани калиди API худ.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode дар {{distro}} тайёр аст.",
  "wsl.onboarding.codarkReady": "OpenCode тайёр аст.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode насб нашудааст",
