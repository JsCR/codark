export const dict = {
  ...
  "dialog.provider.codark.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.codark.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.codarkGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "provider.connect.codarkZen.visit.prefix": "Ga naar ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " om je API-sleutel op te halen.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode is gereed in {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode is klaar.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode niet geïnstalleerd",
