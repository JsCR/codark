export const dict = {
  ...
  "dialog.provider.codark.note": "Claude, GPT, Gemini болон бусад загваруудыг сонгон шалгаруулсан",
  "dialog.provider.codark.tagline": "Найдвартай оновчтой загварууд",
  "dialog.provider.codarkGo.tagline": "Хүн бүрт зориулсан хямд өртөгтэй захиалга",
  ...
  "provider.connect.codarkZen.visit.prefix": "зочилно уу",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "API түлхүүрээ авахын тулд.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}}-д бэлэн боллоо.",
  "wsl.onboarding.codarkReady": "OpenCode бэлэн боллоо.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode суулгаагүй байна",
