export const dict = {
  ...
  "dialog.provider.codark.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.codark.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.codarkGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "provider.connect.codarkZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode είναι έτοιμο.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode δεν έχει εγκατασταθεί",
