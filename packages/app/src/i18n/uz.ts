export const dict = {
  ...
  "dialog.provider.codark.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.codark.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.codarkGo.tagline": "Hamma uchun arzon obuna",
  ...
  "provider.connect.codarkZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " API kalitingizni olish uchun.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}} da tayyor.",
  "wsl.onboarding.codarkReady": "OpenCode tayyor.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode o'rnatilmagan",
