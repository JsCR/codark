...
export const dict = {
  ...
  "dialog.provider.codark.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.codark.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.codarkGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "provider.connect.codarkZen.visit.prefix": "Heimsókn",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "til að safna API lykilnum þínum.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode er tilbúið í {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode er tilbúinn.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode ekki uppsett",
