export const dict = {
  ...
  "dialog.provider.codark.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.codark.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.codarkGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.unpaid.freeModels.title": "Codark에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Codark에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.codarkZen.line2": "단일 API 키로 Claude, GPT, Gemini, GLM 등 다양한 모델에 액세스할 수 있습니다.",
  "provider.connect.codarkZen.visit.prefix": "다음 ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "을 방문하여 API 키를 받으세요.",
  "provider.connect.oauth.code.visit.prefix": "다음 ",
  "provider.connect.oauth.code.visit.link": "이 링크",
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Codark에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Codark에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "codark.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 Codark 서버를 전환합니다.",
  ...
  "toast.update.description": "Codark의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Codark 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(codark.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Codark는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Codark에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Codark 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Codark 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Codark가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Codark가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Codark 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Codark를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Codark를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "Codark 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Codark 확인 중...",
  "wsl.onboarding.updatingOpencode": "Codark 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Codark 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 Codark를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "Codark 업데이트",
  "wsl.onboarding.codarkReadyIn": "{{distro}}에서 Codark를 사용할 준비가 되었습니다.",
  "wsl.onboarding.codarkReady": "Codark가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Codark를 설치하세요.",
  "wsl.onboarding.installOpencode": "Codark 설치",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Codark에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "Codark에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Codark를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 Codark Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "Codark를 불러오지 못했습니다",
  "desktop.recovery.terminated": "Codark 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "Codark가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpencode": "Codark 설치 실패",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 Codark가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "Codark 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
