export const dict = {
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 Codark를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "Codark가 준비되었습니다.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codark가 설치되지 않음",
