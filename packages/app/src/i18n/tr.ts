...
export const dict = {
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Codark hazır.",
  "wsl.onboarding.opencodeReady": "Codark hazır.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codark kurulu değil",
