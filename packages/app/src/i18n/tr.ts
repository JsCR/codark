...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Codark yüklenemedi",
  "desktop.recovery.terminated": "Codark penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Codark yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Codark kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Codark güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.codark.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.codark.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.codarkGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Codark tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Codark'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.codarkZen.visit.prefix": "",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Codark'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Codark'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler codark.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Codark sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Codark kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Codark kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Codark güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Codark güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Codark'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Codark'u güncelle",
  "wsl.onboarding.codarkReadyIn": "{{distro}} içinde Codark hazır.",
  "wsl.onboarding.codarkReady": "Codark hazır.",
  "wsl.onboarding.installOpencodeIn": "Codark'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Codark'u kur",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Codark'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Codark bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Codark'u tekrar açın.",
  ...
  "help.tabs.introduction": "Codark Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Codark'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Codark ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (codark.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Codark henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Codark ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Codark Masaüstü",
  ...
  "settings.desktop.wsl.description": "Codark sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Codark'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Codark'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Codark'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Codark'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Codark başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Codark'un en son sürümünü kullanıyorsunuz.",
