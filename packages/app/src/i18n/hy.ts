export const dict = {
  ...
  "dialog.provider.codark.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.codark.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.codarkGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "provider.connect.codarkZen.visit.prefix": "Այցելություն ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.codarkReady": "OpenCode պատրաստ է։",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode տեղադրված չէ",
