export const dict = {
  ...
  "desktop.recovery.loadFailed": "โหลด Codark ไม่สำเร็จ",
  "desktop.recovery.terminated": "หน้าต่าง Codark หยุดทำงานโดยไม่คาดคิด",
  "desktop.recovery.unresponsive": "Codark ไม่ตอบสนอง",
  ...
  "desktop.wsl.error.installOpencode": "การติดตั้ง Codark ล้มเหลว",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "ไม่ได้ติดตั้ง Codark ใน {{distro}}",
  "desktop.wsl.error.updateVersion":
    "อัปเดต Codark เสร็จแล้ว แต่ {{distro}} ยังคงรายงานเวอร์ชัน {{installed}} ทั้งที่ควรเป็น {{expected}}",
  ...
  "dialog.provider.codark.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.codark.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.codarkGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Codark",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Codark",
  ...
  "provider.connect.codarkZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " เพื่อรับคีย์ API ของคุณ",
  "provider.connect.oauth.code.visit.prefix": "เยี่ยมชม ",
  "provider.connect.oauth.code.visit.link": "ลิงก์นี้",
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรับรหัสการอนุญาตสำหรับเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Codark",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Codark",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน codark.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Codark ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "wsl.onboarding.checkingOpencode": "กำลังตรวจสอบ Codark...",
  "wsl.onboarding.checkingOpencodeIn": "กำลังตรวจสอบ Codark ใน {{distro}}...",
  "wsl.onboarding.updatingOpencode": "กำลังอัปเดต Codark...",
  "wsl.onboarding.updatingOpencodeIn": "กำลังอัปเดต Codark ใน {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "อัปเดต Codark ใน {{distro}}",
  "wsl.onboarding.updateOpencode": "อัปเดต Codark",
  "wsl.onboarding.codarkReadyIn": "Codark พร้อมใช้งานใน {{distro}} แล้ว",
  "wsl.onboarding.codarkReady": "Codark พร้อมใช้งานแล้ว",
  "wsl.onboarding.installOpencodeIn": "ติดตั้ง Codark ใน {{distro}}",
  "wsl.onboarding.installOpencode": "ติดตั้ง Codark",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "ยังไม่ได้ติดตั้ง Codark",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ต้องมี WSL (Windows Subsystem for Linux) ก่อนที่ Codark จะเพิ่มเซิร์ฟเวอร์ WSL ได้",
  "wsl.onboarding.wslUnavailable.title": "WSL ไม่พร้อมใช้งาน",
  "wsl.onboarding.wslUnavailable.description": "Codark ไม่สามารถตรวจสอบ WSL บนเครื่องนี้ได้",
  "wsl.onboarding.installWsl": "ติดตั้ง WSL",
  "wsl.onboarding.windowsRestartRequired":
    "รีสตาร์ท Windows เพื่อให้การติดตั้ง WSL เสร็จสมบูรณ์ แล้วเปิด Codark อีกครั้ง",
  ...
  "help.tabs.introduction": "ตอนนี้ Codark Desktop สร้างขึ้นโดยใช้แท็บเป็นหลัก",
  "help.tabs.sessions":
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Codark ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Codark",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (codark.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Codark ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "sidebar.gettingStarted.line1": "Codark รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Codark ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Codark",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งรูปลักษณ์ของ Codark บนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Codark ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งธีมของ Codark",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Codark เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Codark เวอร์ชันล่าสุด",
