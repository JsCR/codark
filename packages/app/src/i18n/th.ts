export const dict = {
  ...
  "wsl.onboarding.opencodeReadyIn": "Codark พร้อมใช้งานใน {{distro}} แล้ว.",
  "wsl.onboarding.opencodeReady": "Codark พร้อมใช้งานแล้ว.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "ยังไม่ได้ติดตั้ง Codark",
