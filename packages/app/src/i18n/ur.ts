export const dict = {
  ...
  "dialog.provider.codark.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.codark.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.codarkGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "provider.connect.codarkZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}} میں تیار ہے۔",
  "wsl.onboarding.codarkReady": "OpenCode تیار ہے۔",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode انسٹال نہیں ہے۔",
