export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Codark",
  ...
  "desktop.menu.ariaLabel": "Menú de Codark",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Codark",
  "desktop.recovery.terminated": "La ventana de Codark se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Codark no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Codark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Codark finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.codark.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Codark",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Codark.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Codark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Codark.",
  ...
  "dialog.server.description": "Cambiar el servidor de Codark al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Codark...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Codark en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Codark...",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Codark pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Codark no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Codark.",
  ...
  "help.tabs.introduction": "Codark Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Codark ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Codark",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Codark aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Codark incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Codark dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Codark",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Codark en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Codark sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Codark.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Codark",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Codark.",
