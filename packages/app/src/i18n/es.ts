export const dict = {
  ...
  "dialog.server.description": "Cambiar a qué servidor de Codark se conecta esta app.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Codark",
