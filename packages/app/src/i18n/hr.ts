...
export const dict = {
  ...
  "dialog.provider.codark.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.codark.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.codarkGo.tagline": "Niska cijena pretplate za sve",
  ...
  "provider.connect.codarkZen.visit.prefix": "Posjetiti",
  "provider.connect.codarkZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "da preuzmete svoj ključ API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode je spreman u {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode je spreman.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode nije instaliran",
