export const dict = {
  ...
  "dialog.provider.codark.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.codark.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.codarkGo.tagline": "Abbonamento economico per tutti",
  ...
  "provider.connect.codarkZen.visit.suffix": " per ottenere la tua chiave API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode è pronto in {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode è pronto.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode non installato",
