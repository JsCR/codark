export const dict = {
  ...
  "dialog.provider.codark.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.codark.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.codarkGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "provider.connect.codarkZen.visit.prefix": "Obisk ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " za prevzem ključa API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode je pripravljen v {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode je pripravljen.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode ni nameščen",
