...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Codark 加载失败",
  "desktop.recovery.terminated": "Codark 窗口意外终止",
  "desktop.recovery.unresponsive": "Codark 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Codark 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Codark",
  "desktop.wsl.error.updateVersion":
    "Codark 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.codark.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.codark.tagline": "可靠的优化模型",
  "dialog.provider.codarkGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Codark 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Codark 中使用 {{provider}} 模型。",
  ...
  "provider.connect.codarkZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.codarkZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.codarkZen.visit.prefix": "访问 ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Codark 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Codark 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 codark.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Codark 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Codark...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Codark...",
  "wsl.onboarding.updatingOpencode": "正在更新 Codark...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Codark...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Codark。",
  "wsl.onboarding.updateOpencode": "更新 Codark",
  "wsl.onboarding.codarkReadyIn": "{{distro}} 中的 Codark 已就绪。",
  "wsl.onboarding.codarkReady": "Codark 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Codark。",
  "wsl.onboarding.installOpencode": "安装 Codark",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "未安装 Codark",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Codark 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Codark 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Codark。",
  ...
  "help.tabs.introduction": "Codark Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Codark 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Codark 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (codark.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Codark 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Codark 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Codark 服务器。",
  ...
  "settings.general.row.language.description": "更改 Codark 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Codark 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Codark 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Codark 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Codark 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Codark。",
