...
export const dict = {
  ...
  "dialog.provider.codark.note": "使用 OpenCode Zen 或 API 密钥连接",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Codark 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Codark 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Codark 中使用 {{provider}} 模型。",
