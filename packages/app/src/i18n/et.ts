export const dict = {
  ...
  "dialog.provider.codark.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.codark.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.codarkGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "provider.connect.codarkZen.visit.prefix": "Külastage ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " API võtme kättesaamiseks.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode on valmis {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode on valmis.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode pole installitud",
