export const dict = {
  ...
  "dialog.provider.codark.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.codark.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.codarkGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "provider.connect.codarkZen.visit.prefix": "Truy cập ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " để lấy khóa API của bạn.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode đã sẵn sàng.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode chưa được cài đặt",
