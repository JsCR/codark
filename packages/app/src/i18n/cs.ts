export const dict = {
  ...
  "dialog.provider.codark.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.codark.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.codarkGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.codarkZen.visit.prefix": "Návštěva ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " vyzvedněte svůj klíč API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode je připraveno v {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode je připraven.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode není nainstalováno",
