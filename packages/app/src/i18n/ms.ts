export const dict = {
  ...
  "dialog.provider.codark.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.codark.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.codarkGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "provider.connect.codarkZen.visit.prefix": "Layari",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode sedia digunakan.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode belum dipasang",
