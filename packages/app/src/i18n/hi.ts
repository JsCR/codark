export const dict = {
  ...
  "dialog.provider.codark.note": "Claude, GPT, Gemini और अधिक सहित क्यूरेटेड मॉडल",
  "dialog.provider.codark.tagline": "विश्वसनीय अनुकूलित मॉडल",
  "dialog.provider.codarkGo.tagline": "सभी के लिए कम लागत वाली सदस्यता",
  ...
  "provider.connect.codarkZen.line2": "एक API कुंजी से आपको Claude, GPT, Gemini, GLM जैसे कई मॉडलों तक पहुँच मिलेगी।",
  "provider.connect.codarkZen.visit.prefix": "यहाँ जाएँ: ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " अपनी API कुंजी प्राप्त करने के लिए।",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}} में तैयार है।",
  "wsl.onboarding.codarkReady": "OpenCode तैयार है।",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode स्थापित नहीं है",
