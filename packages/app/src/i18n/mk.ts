export const dict = {
  ...
  "dialog.provider.codark.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.codark.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.codarkGo.tagline": "Ниска цена претплата за секого",
  ...
  "provider.connect.codarkZen.visit.prefix": "Посетете",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": "да го соберете вашиот клуч API.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode е подготвен во {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode е подготвен.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode не е инсталиран",
