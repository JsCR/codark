...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Codark 載入失敗",
  "desktop.recovery.terminated": "Codark 視窗意外終止",
  "desktop.recovery.unresponsive": "Codark 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Codark 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Codark",
  "desktop.wsl.error.updateVersion":
    "Codark 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.codark.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.codark.tagline": "經過最佳化的可靠模型",
  "dialog.provider.codarkGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Codark 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Codark 中使用 {{provider}} 模型。",
  ...
  "provider.connect.codarkZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.codarkZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.codarkZen.visit.prefix": "造訪 ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Codark 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Codark 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 codark.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Codark 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Codark...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Codark...",
  ...
  "wsl.onboarding.codarkReadyIn": "{{distro}} 中的 Codark 已就緒。",
  "wsl.onboarding.codarkReady": "Codark 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Codark。",
  "wsl.onboarding.installOpencode": "安裝 Codark",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "未安裝 Codark",
  ...
  "wsl.onboarding.wslUnavailable.description": "Codark 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Codark。",
  ...
  "help.tabs.introduction": "Codark Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Codark 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Codark 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (codark.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Codark 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Codark 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Codark 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Codark 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Codark 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Codark 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Codark 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Codark 啟動時自動檢查更新",
