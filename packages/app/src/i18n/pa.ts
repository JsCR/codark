export const dict = {
  ...
  "dialog.provider.codark.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.codark.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.codarkGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "provider.connect.codarkZen.visit.prefix": "ویکھو ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}} چ تیار اے۔",
  "wsl.onboarding.codarkReady": "OpenCode تیار اے۔",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode انسٹال نئیں کیتا گیا",
