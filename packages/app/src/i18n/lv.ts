export const dict = {
  ...
  "dialog.provider.codark.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.codark.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.codarkGo.tagline": "Zemas cenas abonements visiem",
  ...
  "provider.connect.codarkZen.visit.prefix": "Apmeklējiet",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode ir gatavs.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode nav instalēts",
