export const dict = {
  ...
  "dialog.provider.codark.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.codark.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.codarkGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "provider.connect.codarkZen.visit.prefix": "Sapar ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " API açaryňyzy ýygnamak.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}}-de taýýar.",
  "wsl.onboarding.codarkReady": "OpenCode taýýar.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode gurulmady",
