export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Codark",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Codark.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Codark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Codark.",
  ...
  "dialog.server.description": "Skift hvilken Codark-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Codark...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Codark i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Codark...",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Codark kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Codark kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Codark igen.",
  ...
  "toast.update.description": "En ny version af Codark ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Codark-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (codark.json)",
  ...
  "sidebar.gettingStarted.line1": "Codark inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Codark-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Codark",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Codark ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Codark skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Codarks tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Codark starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Codark.",
  ...
  "desktop.recovery.loadFailed": "Codark kunne ikke indlæses",
  "desktop.recovery.terminated": "Codark-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Codark mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Codark er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Codark Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
