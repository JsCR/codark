export const dict = {
  ...
  "dialog.provider.codark.tagline": "Надежные оптимизированные модели",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Codark.",
  ...
  "provider.connect.codarkZen.visit.suffix": " чтобы получить ваш API ключ.",
  ...
  "dialog.server.description": "Переключите сервер Codark к которому подключается приложение.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Codark требуется WSL (Windows Subsystem for Linux)",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (codark.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Codark пока не поддерживает MCP авторизацию.',
  ...
  "settings.general.row.appearance.description": "Настройте как Codark выглядит на вашем устройстве",
