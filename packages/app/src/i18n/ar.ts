export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Codark",
  "desktop.recovery.terminated": "توقفت نافذة Codark بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Codark لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Codark",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Codark، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.codark.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.codark.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.codarkGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Codark",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Codark.",
  ...
  "provider.connect.codarkZen.visit.prefix": "قم بزيارة ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Codark.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Codark.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في codark.json",
  ...
  "dialog.server.description": "تبديل خادم Codark الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Codark...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Codark في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Codark...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Codark في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Codark في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Codark",
  "wsl.onboarding.codarkReadyIn": "Codark جاهز في {{distro}}.",
  "wsl.onboarding.codarkReady": "Codark جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Codark في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Codark",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "Codark غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Codark من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Codark التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Codark.",
  ...
  "help.tabs.introduction": "أصبح Codark Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Codark ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Codark",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (codark.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Codark لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Codark نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Codark داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Codark",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Codark على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Codark يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Codark.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Codark",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Codark.",
