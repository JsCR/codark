export const dict = {
  ...
  "wsl.onboarding.opencodeReadyIn": "Codark جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Codark جاهز.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Codark غير مثبت",
