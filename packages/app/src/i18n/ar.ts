export const dict = {
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Codark.",
  ...
  "toast.update.description": "نسخة جديدة من Codark ({{version}}) متاحة الآن للتثبيت.",
