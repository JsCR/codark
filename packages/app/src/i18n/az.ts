export const dict = {
  ...
  "dialog.provider.codark.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.codark.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.codarkGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "provider.connect.codarkZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode {{distro}}-də hazırdır.",
  "wsl.onboarding.codarkReady": "OpenCode hazırdır.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode quraşdırılmayıb",
