...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Codark failed to load",
  "desktop.recovery.terminated": "Codark window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Codark is not responding",
  ...
  "desktop.wsl.error.installOpencode": "Codark installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Codark is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Codark update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
