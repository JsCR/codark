export const dict = {
  ...
  "dialog.provider.codark.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.codark.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.codarkGo.tagline": "Lågprisprenumeration för alla",
  ...
  "provider.connect.codarkZen.visit.prefix": "Besök ",
  "provider.connect.codarkZen.visit.link": "opencode.ai/zen",
  "provider.connect.codarkZen.visit.suffix": " för att hämta din API-nyckel.",
  ...
  "wsl.onboarding.codarkReadyIn": "OpenCode är redo i {{distro}}.",
  "wsl.onboarding.codarkReady": "OpenCode är redo.",
  ...
  "wsl.onboarding.distroStatus.codarkMissing": "OpenCode är inte installerat",
