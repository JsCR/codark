...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Codark Documentation", href: "https://opencode.ai/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/codark-ai/codark/issues/new?template=feature-request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/codark-ai/codark/issues/new?template=bug-report.yml",
      },
    ],
  },
]
