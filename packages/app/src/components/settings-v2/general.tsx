...
import { Switch } from "@codark-ai/ui/v2/switch-v2"
import { TextInputV2 } from "@codark-ai/ui/v2/text-input-v2"
import { useTheme, type ColorScheme } from "@codark-ai/ui/theme/context"
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_CODARK_CHANNEL !== "prod"}>
          <SettingsRowV2
