...
beforeAll(async () => {
  ...
  mock.module("@codark-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codark-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codark-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codark-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
