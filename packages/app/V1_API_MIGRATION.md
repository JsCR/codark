...
The app is currently hybrid. In this document, V1 refers to the legacy unprefixed server APIs used by `@codark-ai/sdk/v2`, despite the SDK package name.
...
- [ ] Remove the `@codark-ai/sdk` runtime dependency after all legacy calls and types are gone.
  - `package.json`
