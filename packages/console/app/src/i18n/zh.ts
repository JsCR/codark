...
export const dict = {
  ...
  "app.meta.description": "Codark - 开源编程代理。",

  "home.title": "Codark | 开源 AI 编程代理",

  "temp.title": "Codark | 专为终端打造的 AI 编程代理",
  ...
  "temp.feature.zen.beforeLink": "由 Codark 提供的",
  ...
  "temp.screenshot.caption": "使用 Tokyonight 主题的 Codark TUI",
  "temp.screenshot.alt": "使用 Tokyonight 主题的 Codark TUI",
  ...
  "home.what.title": "什么是 Codark？",
  "home.what.body": "Codark 是一个开源代理，帮助您在终端、IDE 或桌面端编写代码。",
  ...
  "home.growth.body":
    "拥有超过 <strong>{{stars}}</strong> 颗 GitHub Star，<strong>{{contributors}}</strong> 位贡献者，以及超过 <strong>{{commits}}</strong> 次提交，Codark 每月被超过 <strong>{{monthlyUsers}}</strong> 名开发者使用并信赖。",
  "home.growth.githubStars": "GitHub Stars",
  "home.growth.contributors": "贡献者",
  "home.growth.monthlyDevs": "月活开发者",

  "home.privacy.title": "隐私优先的设计",
  "home.privacy.body": "Codark 不存储您的任何代码或上下文数据，确保可以在对隐私敏感的环境中运行。",
  "home.privacy.learnMore": "了解更多关于",
  "home.privacy.link": "隐私",

  "home.faq.q1": "什么是 Codark？",
  "home.faq.a1": "Codark 是一个开源代理，帮助您使用任意 AI 模型编写和运行代码。它提供终端界面、桌面应用及 IDE 扩展。",
  "home.faq.q2": "如何使用 Codark？",
  "home.faq.a2.before": "最简单的入门方式是阅读",
  "home.faq.a2.link": "介绍",
  "home.faq.q3": "使用 Codark 需要额外的 AI 订阅吗？",
  "home.faq.a3.p1": "不一定。Codark 自带一组免费模型，无需创建账户即可使用。",
  "home.faq.a3.p2.beforeZen": "此外，您可以通过创建",
  "home.faq.a3.p2.afterZen": "账户来使用流行的编程模型。",
  "home.faq.a3.p3": "虽然我们鼓励使用 Zen，但 Codark 也支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",
  "home.faq.a3.p4.beforeLocal": "您甚至可以连接您的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "我可以使用现有的 AI 订阅吗？",
  "home.faq.a4.p1":
    "可以，Codark 支持所有主流提供商的订阅计划。您可以使用您的 Claude Pro/Max, ChatGPT Plus/Pro, 或 GitHub Copilot 订阅。",
  "home.faq.q5": "Codark 只能在终端使用吗？",
  "home.faq.a5.beforeDesktop": "不再是了！Codark 现在也提供",
  "home.faq.a5.desktop": "桌面端应用",
  "home.faq.a5.and": "和",
  "home.faq.a5.web": "网页端",
  "home.faq.q6": "Codark 多少钱？",
  "home.faq.a6": "Codark 是 100% 免费使用的。它还自带一组免费模型。如果您连接其他提供商，可能会产生额外费用。",
  "home.faq.q7": "数据和隐私如何？",
  ...
  "home.faq.q8": "Codark 是开源的吗？",
  "home.faq.a8.p1": "是的，Codark 是完全开源的。源代码公开在",
  "home.faq.a8.p2": "遵循",
  ...
  "home.zenCta.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经过 Codark 专门针对编程代理的测试和基准测试。无需担心不同提供商之间不稳定的性能和质量，直接使用行之有效的验证模型。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "OpenCode Zen | 为编程代理精选的可靠、优化模型",
  "zen.hero.title": "为编程代理打造的可靠、优化模型",
  "zen.hero.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经过 Codark 专门针对编程代理的测试和基准测试。无需担心不稳定的性能和质量，直接使用行之有效的验证模型。",

  "zen.faq.q1": "什么是 OpenCode Zen？",
  "zen.faq.a1": "Zen 是一组由 Codark 团队创建的，专门针对编程代理进行测试和基准测试的 AI 模型精选集。",
  "zen.faq.q2": "为什么 Zen 更准确？",
  "zen.faq.a2":
    "Zen 仅提供经过专门针对编程代理测试和基准测试的模型。正如你不会用黄油刀切牛排一样，也不要用糟糕的模型来写代码。",
  "zen.faq.q3": "Zen 更便宜吗？",
  "zen.faq.a3":
    "Zen 不以盈利为目的。Zen 将模型提供商的成本直接传递给您。Zen 的使用量越高，Codark 就越能协商出更好的费率并回馈给您。",
  "zen.faq.q4": "Zen 多少钱？",
  ...
  "zen.faq.a4.p3": "为覆盖成本，Codark 仅收取少量支付处理费，每充值 $20 收取 $1.23。",
  "zen.faq.q5": "数据和隐私如何？",
  ...
  "zen.faq.a8":
    "虽然 Zen 与 Codark 配合效果极佳，但您可以在任何代理中使用 Zen。请按照您首选编程代理中的设置说明进行操作。",
  ...
  "go.problem.body":
    "我们致力于将 Codark 体验带给尽可能多的人。OpenCode Go 是一款低成本订阅服务：首月 $5，之后 $10/月。它提供充裕的额度，并让您能可靠地使用最强大的开源模型。",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 起价为首月 $5，之后 $10/月。您可以将其与 Codark 或任何代理搭配使用。",
  ...
  "workspace.newUser.feature.lockin.body":
    "将 Zen 与任何编程代理结合使用，并在需要时继续在 Codark 中使用其他提供商。",
  ...
  "workspace.newUser.step.login.after": "并选择 Codark",
  "workspace.newUser.step.pasteKey": "粘贴您的 API 密钥",
  "workspace.newUser.step.models.before": "启动 Codark 并运行",
  ...
  "workspace.keys.subtitle": "管理访问 Codark 服务的 API 密钥。",
  "workspace.keys.create": "创建 API 密钥",
  "workspace.keys.placeholder": "输入密钥名称",
  "workspace.keys.empty": "创建 Codark 网关 API 密钥",
  ...
  "download.title": "Codark | 下载",
  "download.meta.description": "下载适用于 macOS, Windows, 和 Linux 的 Codark",
  "download.hero.title": "下载 Codark 桌面版",
  "download.hero.subtitle": "适用于 macOS, Windows, 和 Linux 的 Beta 版",
  "download.hero.button": "下载 {{os}} 版",
  "download.section.terminal": "Codark 终端",
  "download.section.desktop": "Codark 桌面版",
  "download.section.extensions": "Codark 扩展",
  "download.section.integrations": "Codark 集成",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但可能需要。如果您想将 Codark 连接到付费提供商，您需要 AI 订阅，尽管您可以配合",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免费使用。虽然我们鼓励用户使用",
  "download.faq.a3.afterZen": "，但 Codark 支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",

  "download.faq.a5.p1": "Codark 是 100% 免费使用的。",
  "download.faq.a5.p2.beforeZen":
    "任何额外费用都来自您对模型提供商的订阅。虽然 Codark 支持任何模型提供商，但我们建议使用",
  "download.faq.a5.p2.afterZen": "。",

  "download.faq.a6.p1": "只有当您在 Codark 中创建分享链接时，您的数据和信息才会被存储。",
  "download.faq.a6.p2.beforeShare": "了解更多关于",
  "download.faq.a6.shareLink": "分享页面",

  "enterprise.title": "Codark | 面向组织的 Codark 企业版解决方案",
  "enterprise.meta.description": "联系 Codark 获取企业版解决方案",
  "enterprise.hero.title": "您的代码属于您",
  "enterprise.hero.body1":
    "Codark 在您的组织内部安全运行，不存储任何数据或上下文，也没有许可限制或所有权主张。您可以先与团队开始试用，然后通过集成 SSO 和内部 AI 网关将其部署到整个组织。",
  ...
  "enterprise.faq.q1": "什么是 Codark 企业版？",
  "enterprise.faq.a1":
    "Codark 企业版专为那些希望确保代码和数据永远不离开其基础设施的组织而设计。它通过使用集中式配置，与您的 SSO 和内部 AI 网关集成来实现这一点。",
  "enterprise.faq.q2": "如何开始使用 Codark 企业版？",
  "enterprise.faq.a2":
    "只需从您的团队内部试用开始即可。Codark 默认不存储您的代码或上下文数据，使得入门非常容易。然后联系我们讨论定价和实施选项。",
  "enterprise.faq.q3": "企业版定价如何运作？",
  "enterprise.faq.a3":
    "我们提供按席位计费的企业定价。如果您拥有自己的 LLM 网关，我们不收取 token 使用费。如需了解更多详情，请联系我们获取基于您组织需求的定制报价。",
  "enterprise.faq.q4": "Codark 企业版安全吗？",
  "enterprise.faq.a4":
    "是的。Codark 不存储您的代码或上下文数据。所有处理均在本地进行，或通过直接 API 调用您的 AI 提供商。通过集中配置和 SSO 集成，您的数据始终保留在您组织的基础设施内。",

  "brand.title": "Codark | 品牌",
  "brand.meta.description": "Codark 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "帮助您使用 Codark 品牌的资源和资产。",
  "brand.downloadAll": "下载所有资产",

  "changelog.title": "Codark | 更新日志",
  "changelog.meta.description": "Codark 发布说明和更新日志",
  "changelog.hero.title": "更新日志",
  "changelog.hero.subtitle": "Codark 的新更新和改进",
