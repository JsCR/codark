...
export const dict = {
  ...
  "notFound.title": "Nicht gefunden | Codark",
  "notFound.heading": "404 - Seite nicht gefunden",
  "notFound.home": "Startseite",
  "notFound.docs": "Dokumentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "Codark Logo hell",
  "notFound.logoDarkAlt": "Codark Logo dunkel",
  ...
  "app.meta.description": "Codark - Der Open-Source Coding-Agent.",

  "home.title": "Codark | Der Open-Source AI-Coding-Agent",

  "temp.title": "Codark | Für das Terminal gebauter AI-Coding-Agent",
  ...
  "temp.feature.zen.afterLink": "bereitgestellt von Codark",
  ...
  "temp.screenshot.caption": "Codark TUI mit dem Tokyonight-Theme",
  "temp.screenshot.alt": "Codark TUI mit Tokyonight-Theme",
  "temp.logoLightAlt": "Codark Logo hell",
  "temp.logoDarkAlt": "Codark Logo dunkel",
  ...
  "home.what.title": "Was ist Codark?",
  "home.what.body":
    "Codark ist ein Open-Source-Agent, der dir hilft, Code in deinem Terminal, deiner IDE oder auf dem Desktop zu schreiben.",
  ...
  "home.growth.body":
    "Mit über <strong>{{stars}}</strong> GitHub-Stars, <strong>{{contributors}}</strong> Contributors und über <strong>{{commits}}</strong> Commits wird Codark von über <strong>{{monthlyUsers}}</strong> Entwickler:innen jeden Monat genutzt und geschätzt.",
  ...
  "home.privacy.body":
    "Codark speichert keinen deiner Codes oder Kontextdaten, sodass es in datenschutzsensiblen Umgebungen arbeiten kann.",
  "home.privacy.learnMore": "Erfahre mehr über",
  "home.privacy.link": "Datenschutz",

  "home.faq.q1": "Was ist Codark?",
  "home.faq.a1":
    "Codark ist ein Open-Source-Agent, der dir hilft, Code mit jedem KI-Modell zu schreiben und auszuführen. Er ist als Terminal-Interface, Desktop-App oder IDE-Erweiterung verfügbar.",
  "home.faq.q2": "Wie nutze ich Codark?",
  "home.faq.a2.before": "Der einfachste Weg zu starten ist, die",
  "home.faq.a2.link": "Einführung zu lesen",
  "home.faq.q3": "Brauche ich zusätzliche AI-Abos, um Codark zu nutzen?",
  "home.faq.a3.p1":
    "Nicht unbedingt, Codark kommt mit einer Reihe kostenloser Modelle, die du ohne Account nutzen kannst.",
  ...
  "home.faq.a3.p3":
    "Während wir dazu raten, Zen zu nutzen, funktioniert Codark auch mit allen beliebten Anbietern wie OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Du kannst sogar deine",
  "home.faq.a3.p4.localLink": "lokalen Modelle verbinden",
  "home.faq.q4": "Kann ich meine bestehenden AI-Abos mit Codark nutzen?",
  "home.faq.a4.p1":
    "Ja, Codark unterstützt Abos von allen großen Anbietern. Du kannst deine Claude Pro/Max, ChatGPT Plus/Pro oder GitHub Copilot Abos nutzen.",
  "home.faq.q5": "Kann ich Codark nur im Terminal nutzen?",
  "home.faq.a5.beforeDesktop": "Nicht mehr! Codark ist jetzt als App für",
  "home.faq.a5.desktop": "Desktop",
  "home.faq.a5.and": "und",
  "home.faq.a5.web": "Web verfügbar",
  "home.faq.q6": "Wie viel kostet Codark?",
  "home.faq.a6":
    "Codark ist zu 100% kostenlos. Es enthält auch eine Reihe kostenloser Modelle. Zusätzliche Kosten können entstehen, wenn du andere Anbieter verbindest.",
  ...
  "home.faq.q8": "Ist Codark Open Source?",
  "home.faq.a8.p1": "Ja, Codark ist vollständig Open Source. Der Quellcode ist öffentlich auf",
  ...
  "home.zenCta.body":
    "Zen gibt dir Zugriff auf ein handverlesenes Set an AI-Modellen, die Codark speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität bei verschiedenen Anbietern – nutze validierte Modelle, die funktionieren.",
  ...
  "zen.hero.body":
    "Zen gibt dir Zugriff auf ein kuratiertes Set an AI-Modellen, die Codark speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität – nutze validierte Modelle, die funktionieren.",

  "zen.faq.q1": "Was ist OpenCode Zen?",
  "zen.faq.a1":
    "Zen ist ein kuratiertes Set an AI-Modellen, getestet und bewertet für Coding-Agents, erstellt vom Team hinter Codark.",
  ...
  "zen.faq.a3":
    "Zen ist nicht gewinnorientiert. Zen gibt die Kosten der Modellanbieter an dich weiter. Je höher die Nutzung von Zen, desto besser kann Codark Preise verhandeln und diese an dich weitergeben.",
  ...
  "zen.faq.a4.p3":
    "Um die Kosten zu decken, fügt Codark nur eine kleine Bearbeitungsgebühr von $1.23 pro $20 Guthabenaufladung hinzu.",
  ...
  "zen.faq.a8":
    "Während Zen großartig mit Codark funktioniert, kannst du Zen mit jedem Agent nutzen. Folge den Einrichtungsanweisungen in deinem bevorzugten Coding-Agent.",
  ...
  "zen.problem.subtitle": "Wir beheben das für alle, nicht nur für Codark-Nutzer.",
  ...
  "zen.how.body": "Während wir dir raten, Zen mit Codark zu nutzen, kannst du Zen mit jedem Agent nutzen.",
  ...
  "go.problem.body":
    "Wir konzentrieren uns darauf, die Codark-Erfahrung so vielen Menschen wie möglich zugänglich zu machen. OpenCode Go ist ein kostengünstiges Abonnement: $5 im ersten Monat, danach $10/Monat. Es bietet großzügige Limits und zuverlässigen Zugang zu den leistungsfähigsten Open-Source-Modellen.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go beginnt bei $5 für den ersten Monat, danach $10/Monat. Du kannst es mit Codark oder jedem Agenten nutzen.",
  ...
  "workspace.newUser.feature.lockin.body":
    "Nutze Zen mit jedem Coding-Agent und nutze weiterhin andere Anbieter mit Codark, wann immer du willst.",
  ...
  "workspace.newUser.step.login.after": "aus und wähle Codark",
  "workspace.newUser.step.pasteKey": "Füge deinen API Key ein",
  "workspace.newUser.step.models.before": "Starte Codark und führe",
  ...
  "workspace.keys.subtitle": "Verwalte deine API Keys für den Zugriff auf Codark-Dienste.",
  "workspace.keys.create": "API Key erstellen",
  "workspace.keys.placeholder": "Key-Namen eingeben",
  "workspace.keys.empty": "Erstelle einen Codark Gateway API Key",
  ...
  "download.title": "Codark | Download",
  "download.meta.description": "Lade Codark für macOS, Windows und Linux herunter",
  "download.hero.title": "Codark Desktop herunterladen",
  ...
  "download.section.extensions": "Codark Extensions",
  "download.section.integrations": "Codark Integrationen",
  ...
  "download.faq.a3.beforeLocal":
    "Nicht unbedingt, aber wahrscheinlich. Du brauchst ein AI-Abo, wenn du Codark mit einem bezahlten Anbieter verbinden willst, obwohl du mit",
  ...
  "download.faq.a3.afterZen":
    " zu nutzen, funktioniert Codark mit allen populären Anbietern wie OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Codark ist 100% kostenlos.",
  "download.faq.a5.p2.beforeZen":
    "Zusätzliche Kosten entstehen durch dein Abo bei einem Modellanbieter. Während Codark mit jedem Modellanbieter funktioniert, empfehlen wir",
  "download.faq.a5.p2.afterZen": " zu nutzen.",

  "download.faq.a6.p1":
    "Deine Daten und Informationen werden nur gespeichert, wenn du teilbare Links in Codark erstellst.",
  "download.faq.a6.p2.beforeShare": "Erfahre mehr über",
  "download.faq.a6.shareLink": "Share-Pages",

  "enterprise.title": "Codark | Enterprise-Lösungen für Ihre Organisation",
  "enterprise.meta.description": "Kontaktieren Sie Codark für Enterprise-Lösungen",
  "enterprise.hero.title": "Ihr Code gehört Ihnen",
  "enterprise.hero.body1":
    "Codark arbeitet sicher innerhalb Ihrer Organisation, ohne dass Daten oder Kontext gespeichert werden und ohne Lizenzbeschränkungen oder Eigentumsansprüche. Starten Sie einen Testlauf mit Ihrem Team, dann rollen Sie es in Ihrer Organisation aus, indem Sie es in Ihr SSO und internes AI-Gateway integrieren.",
  ...
  "enterprise.faq.a2":
    "Starten Sie einfach mit einem internen Testlauf mit Ihrem Team. Codark speichert standardmäßig weder Code noch Kontextdaten, was den Einstieg erleichtert. Kontaktieren Sie uns dann, um Preise und Implementierungsoptionen zu besprechen.",
  ...
  "enterprise.faq.a4":
    "Ja. Codark speichert weder Ihren Code noch Kontextdaten. Alle Verarbeitungen finden lokal oder über direkte API-Aufrufe an Ihren AI-Anbieter statt. Mit zentraler Konfiguration und SSO-Integration bleiben Ihre Daten sicher innerhalb der Infrastruktur Ihrer Organisation.",

  "brand.title": "Codark | Marke",
  "brand.meta.description": "Codark Markenrichtlinien",
  "brand.heading": "Markenrichtlinien",
  "brand.subtitle": "Ressourcen und Assets, die dir helfen, mit der Codark-Marke zu arbeiten.",
  "brand.downloadAll": "Alle Assets herunterladen",

  "changelog.title": "Codark | Changelog",
  "changelog.meta.description": "Codark Release Notes und Changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Neue Updates und Verbesserungen für Codark",
