...
export const dict = {
  ...
  "app.meta.description": "Codark - O agente de codificação de código aberto.",

  "home.title": "Codark | O agente de codificação de código aberto com IA",
  ...
  "temp.screenshot.caption": "Codark TUI com o tema tokyonight",
  "temp.screenshot.alt": "Codark TUI com tema tokyonight",
  ...
  "home.what.title": "O que é Codark?",
  "home.what.body":
    "Codark é um agente de código aberto que ajuda você a escrever código no seu terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, Codark é usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "Codark não armazena nenhum código seu nem dados de contexto, para que possa operar em ambientes sensíveis à privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que é Codark?",
  "home.faq.a1":
    "Codark é um agente de código aberto que ajuda você a escrever e executar código com qualquer modelo de IA. Está disponível como interface de terminal, app desktop ou extensão de IDE.",
  "home.faq.q2": "Como eu uso o Codark?",
  "home.faq.a2.before": "A maneira mais fácil de começar é ler a",
  "home.faq.a2.link": "introdução",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o Codark?",
  "home.faq.a3.p1":
    "Não necessariamente, Codark vem com um conjunto de modelos grátis que você pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen":
    "Além disso, você pode usar qualquer um dos modelos de codificação populares criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuários a usar o Zen, Codark também funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Você pode até conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o Codark?",
  "home.faq.a4.p1":
    "Sim, Codark suporta planos de assinatura de todos os principais provedores. Você pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o Codark apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Não mais! Codark agora está disponível como um app para o seu",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o Codark?",
  "home.faq.a6":
    "Codark é 100% gratuito para usar. Ele também vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se você conectar qualquer outro provedor.",
  ...
  "home.faq.q8": "Codark é código aberto?",
  "home.faq.a8.p1": "Sim, Codark é totalmente open source. O código-fonte é público no",
  ...
  "home.zenCta.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a Codark testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes entre provedores, use modelos validados que funcionam.",
  ...
  "zen.hero.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a Codark testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes, use modelos validados que funcionam.",

  "zen.faq.q1": "O que é OpenCode Zen?",
  "zen.faq.a1":
    "Zen é um conjunto selecionado de modelos de IA testados e avaliados para agentes de codificação, criado pela equipe por trás do Codark.",
  ...
  "zen.faq.a3":
    "O Zen não tem fins lucrativos. O Zen repassa os custos dos provedores de modelos para você. Quanto maior o uso do Zen, mais a Codark pode negociar melhores taxas e repassá-las para você.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a Codark adiciona apenas uma pequena taxa de processamento de pagamento de $1,23 por recarga de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o Codark, você pode usar o Zen com qualquer agente. Siga as instruções de configuração no seu agente de codificação preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários do Codark.",
  ...
  "zen.how.body": "Embora sugerimos que você use o Zen com o Codark, você pode usá-lo com qualquer agente.",
  ...
  "go.problem.body":
    "Estamos focados em levar a experiência do Codark para o maior número de pessoas possível. OpenCode Go é uma assinatura de baixo custo: $5 no primeiro mês, depois $10/mês. Oferece limites generosos e acesso confiável aos modelos open source mais capazes.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "O Go começa em $5 no primeiro mês, depois $10/mês. Você pode usá-lo com o Codark ou qualquer agente.",
  ...
  "download.title": "Codark | Baixar",
  "download.meta.description": "Baixe o Codark para macOS, Windows e Linux",
  "download.hero.title": "Baixar Codark Desktop",
  ...
  "download.section.extensions": "Extensões Codark",
  "download.section.integrations": "Integrações Codark",
  ...
  "download.faq.a3.beforeLocal":
    "Não necessariamente, mas provavelmente. Você precisará de uma assinatura de IA se quiser conectar o Codark a um provedor pago, embora você possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o Codark funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "O Codark é 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Quaisquer custos adicionais virão da sua assinatura de um provedor de modelo. Embora o Codark funcione com qualquer provedor de modelo, recomendamos o uso do",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informações só são armazenados quando você cria links compartilháveis no Codark.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "páginas de compartilhamento",

  "enterprise.title": "Codark | Soluções empresariais para sua organização",
  "enterprise.meta.description": "Contate a Codark para soluções empresariais",
  "enterprise.hero.title": "Seu código é seu",
  "enterprise.hero.body1":
    "O Codark opera com segurança dentro da sua organização, sem dados ou contexto armazenados e sem restrições de licenciamento ou reivindicações de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organização integrando-o ao seu SSO e gateway de IA interno.",
  ...
  "enterprise.faq.a2":
    "Basta começar com um teste interno com sua equipe. O Codark por padrão não armazena seu código ou dados de contexto, facilitando o início. Em seguida, entre em contato conosco para discutir opções de preços e implementação.",
  ...
  "enterprise.faq.a4":
    "Sim. O Codark não armazena seu código ou dados de contexto. Todo o processamento acontece localmente ou por meio de chamadas de API diretas para seu provedor de IA. Com configuração centralizada e integração de SSO, seus dados permanecem seguros dentro da infraestrutura de sua organização.",

  "brand.title": "Codark | Marca",
  "brand.meta.description": "Diretrizes da marca Codark",
  "brand.heading": "Diretrizes da marca",
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca Codark.",
  "brand.downloadAll": "Baixar todos os recursos",

  "changelog.title": "Codark | Changelog",
  "changelog.meta.description": "Notas de versão e changelog do Codark",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Novas atualizações e melhorias no Codark",
