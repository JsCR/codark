...
export const dict = {
  ...
  "app.meta.description": "Codark - Den open source kodningsagent.",

  "home.title": "Codark | Den open source AI-kodningsagent",
  ...
  "home.what.title": "Hvad er Codark?",
  "home.what.body":
    "Codark er en open source agent, der hjælper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsydere og over <strong>{{commits}}</strong> commits bruges Codark af over <strong>{{monthlyUsers}}</strong> udviklere hver måned.",
  ...
  "home.privacy.body":
    "Codark gemmer ikke din kode eller kontekstdata, så den kan bruges i privatlivsfølsomme miljøer.",
  "home.privacy.learnMore": "Læs mere om",
  "home.privacy.link": "privatliv",

  "home.faq.q1": "Hvad er Codark?",
  "home.faq.a1":
    "Codark er en open source agent, der hjælper dig med at skrive og køre kode med enhver AI-model. Den er tilgængelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  "home.faq.q2": "Hvordan bruger jeg Codark?",
  "home.faq.a2.before": "Den nemmeste måde at komme i gang på er at læse",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Skal jeg have ekstra AI-abonnementer for at bruge Codark?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. Codark kommer med gratis modeller, som du kan bruge uden at oprette en konto.",
  "home.faq.a3.p2.beforeZen": "Derudover kan du bruge populære kodningsmodeller ved at oprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi opfordrer til at bruge Zen, men Codark virker også med populære udbydere som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan endda forbinde dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruge mine eksisterende AI-abonnementer med Codark?",
  "home.faq.a4.p1":
    "Ja. Codark understøtter abonnementer fra alle store udbydere. Du kan bruge Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg kun bruge Codark i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! Codark er nu tilgængelig som en app til",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hvad koster Codark?",
  "home.faq.a6":
    "Codark er 100% gratis at bruge. Det kommer også med et sæt gratis modeller. Der kan være ekstra omkostninger, hvis du forbinder en anden udbyder.",
  ...
  "home.faq.q8": "Er Codark open source?",
  "home.faq.a8.p1": "Ja, Codark er fuldt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen giver dig adgang til et håndplukket sæt AI-modeller, som Codark har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet på tværs af udbydere: brug validerede modeller, der virker.",
  ...
  "zen.hero.body":
    "Zen giver dig adgang til et kurateret sæt AI-modeller, som Codark har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet: brug validerede modeller, der virker.",

  "zen.faq.q1": "Hvad er OpenCode Zen?",
  "zen.faq.a1":
    "Zen er et kurateret sæt AI-modeller testet og benchmarked til kodningsagenter, skabt af teamet bag Codark.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profit. Zen videregiver omkostningerne fra modeludbyderne til dig. Jo mere Zen bruges, desto mere kan Codark forhandle bedre priser og give dem videre til dig.",
  ...
  "zen.faq.a4.p3":
    "For at dække omkostninger tilføjer Codark kun et lille betalingsgebyr på $1.23 per $20 saldo-opfyldning.",
  ...
  "zen.faq.a8":
    "Selvom Zen fungerer godt med Codark, kan du bruge Zen med enhver agent. Følg opsætningsinstruktionerne i din foretrukne kodningsagent.",
  ...
  "zen.problem.subtitle": "Vi løser dette for alle, ikke kun Codark-brugere.",
  ...
  "zen.how.body": "Selvom vi foreslår, at du bruger Zen med Codark, kan du bruge Zen med enhver agent.",
  ...
  "go.problem.body":
    "Vi fokuserer på at bringe Codark-oplevelsen ud til så mange som muligt. OpenCode Go er et lavprisabonnement: $5 for den første måned, derefter $10/måned. Det giver generøse grænser og pålidelig adgang til de mest kapable open source-modeller.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter ved $5 for den første måned, derefter $10/måned. Du kan bruge det med Codark eller enhver agent.",
  ...
  "download.meta.description": "Download Codark til macOS, Windows og Linux",
  "download.hero.title": "Download Codark Desktop",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sandsynligvis. Du skal bruge et AI-abonnement hvis du vil forbinde Codark til en betalt udbyder, men du kan arbejde med",
  ...
  "download.faq.a3.afterZen": ", fungerer Codark med alle populære udbydere som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "Codark er 100% gratis at bruge.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra omkostninger kommer fra dit abonnement hos en modeludbyder. Selvom Codark fungerer med enhver modeludbyder, anbefaler vi at bruge",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dine data og oplysninger gemmes kun når du opretter delbare links i Codark.",
  "download.faq.a6.p2.beforeShare": "Læs mere om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "Codark | Enterprise-løsninger til din organisation",
  "enterprise.meta.description": "Kontakt Codark for enterprise-løsninger",
  "enterprise.hero.title": "Din kode er din egen",
  "enterprise.hero.body1":
    "Codark fungerer sikkert inde i din organisation uden at lagre data eller kontekst og uden licensbegrænsninger eller ejerskabskrav. Start en prøveperiode med dit team, og udrul det derefter i hele din organisation ved at integrere det med dit SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.a2":
    "Start blot med en intern prøveperiode med dit team. Codark gemmer som standard ikke din kode eller kontekstdata, hvilket gør det nemt at komme i gang. Kontakt os derefter for at tale om priser og implementeringsmuligheder.",
  ...
  "enterprise.faq.a4":
    "Ja. Codark gemmer ikke din kode eller kontekstdata. Al behandling sker lokalt eller via direkte API-kald til din AI-udbyder. Med central konfiguration og SSO-integration forbliver dine data sikre inden for din organisations infrastruktur.",

  "brand.title": "Codark | Brand",
  "brand.meta.description": "OpenCode brandretningslinjer",
  "brand.heading": "Brandretningslinjer",
  "brand.subtitle": "Ressourcer og assets, der hjælper dig med at arbejde med Codark-brandet.",
  "brand.downloadAll": "Download alle assets",

  "changelog.title": "Codark | Changelog",
  "changelog.meta.description": "Codark versionsnoter og changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nye opdateringer og forbedringer til Codark",
