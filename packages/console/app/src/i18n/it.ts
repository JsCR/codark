...
export const dict = {
  ...
  "app.meta.description": "Codark - L'agente di programmazione open source.",

  "home.title": "Codark | L'agente di coding IA open source",
  ...
  "temp.screenshot.caption": "Codark TUI con il tema tokyonight",
  "temp.screenshot.alt": "Codark TUI con tema tokyonight",
  ...
  "home.what.title": "Che cos'è Codark?",
  "home.what.body": "Codark è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, Codark è usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "Codark non archivia il tuo codice né i dati di contesto, così può operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di più su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'è Codark?",
  "home.faq.a1":
    "Codark è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso Codark?",
  "home.faq.a2.before": "Il modo più semplice per iniziare è leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare Codark?",
  "home.faq.a3.p1":
    "Non necessariamente: Codark include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, Codark funziona anche con i provider più diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con Codark?",
  "home.faq.a4.p1":
    "Sì, Codark supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare Codark solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! Codark ora è disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa Codark?",
  "home.faq.a6":
    "Codark è gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "Codark è open source?",
  "home.faq.a8.p1": "Sì, Codark è completamente open source. Il codice sorgente è pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti dà accesso a una selezione di modelli di IA che Codark ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",
  ...
  "zen.faq.a1":
    "Zen è un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro Codark.",
  ...
  "zen.faq.a3":
    "Zen non è a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. Più Zen viene usato, più Codark può negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, Codark aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con Codark, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti Codark.",
  ...
  "zen.how.body": "Anche se ti consigliamo di utilizzare Zen con Codark, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza Codark a quante più persone possibile. OpenCode Go è un abbonamento a basso costo: $5 il primo mese, poi $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source più capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go inizia a $5 per il primo mese, poi $10/mese. Puoi usarlo con Codark o qualsiasi agente.",
  ...
  "download.meta.description": "Scarica Codark per macOS, Windows e Linux",
  "download.hero.title": "Scarica Codark Desktop",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare Codark a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", Codark funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "Codark è gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre Codark funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in Codark.",
  "download.faq.a6.p2.beforeShare": "Scopri di più sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "Codark | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta Codark per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice è tuo",
  "enterprise.hero.body1":
    "Codark opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietà. Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. Codark per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.a4":
    "Sì. Codark non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "Codark | Brand",
  "brand.meta.description": "Linee guida del brand Codark",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand Codark.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "Codark | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog Codark",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a Codark",
