...
export const dict = {
  ...
  "app.meta.description": "Codark - オープンソースのコーディングエージェント。",

  "home.title": "Codark | オープンソースのAIコーディングエージェント",

  "temp.title": "Codark | ターミナル向けに構築されたAIコーディングエージェント",
  ...
  "temp.feature.zen.beforeLink": "Codarkが提供する",
  ...
  "temp.screenshot.caption": "tokyonight テーマを使用した Codark TUI",
  "temp.screenshot.alt": "tokyonight テーマの Codark TUI",
  ...
  "home.what.title": "Codarkとは？",
  "home.what.body":
    "Codarkは、ターミナル、IDE、またはデスクトップでのコード作成を支援するオープンソースのエージェントです。",
  ...
  "home.privacy.body":
    "Codarkはコードやコンテキストデータを一切保存しないため、プライバシーが重視される環境でも利用できます。",
  "home.privacy.learnMore": "詳しくは",
  "home.privacy.link": "プライバシー",

  "home.faq.q1": "Codarkとは？",
  "home.faq.a1":
    "Codarkは、任意のAIモデルでコードの作成・実行を支援するオープンソースのエージェントです。ターミナルベースのインターフェース、デスクトップアプリ、IDE拡張として利用できます。",
  "home.faq.q2": "Codarkの使い方は？",
  "home.faq.a2.before": "最も簡単な始め方は",
  "home.faq.a2.link": "イントロを読む",
  "home.faq.q3": "Codarkには追加のAIサブスクリプションが必要ですか？",
  "home.faq.a3.p1": "必ずしも必要ではありません。Codarkには、アカウント不要で使える無料モデルが含まれています。",
  "home.faq.a3.p2.beforeZen": "これらに加えて、",
  "home.faq.a3.p2.afterZen": " アカウントを作成することで、人気のコーディングモデルを利用できます。",
  "home.faq.a3.p3":
    "Zenの利用を推奨していますが、CodarkはOpenAI、Anthropic、xAIなどの主要プロバイダーにも対応しています。",
  "home.faq.a3.p4.beforeLocal": "さらに、",
  "home.faq.a3.p4.localLink": "ローカルモデル",
  "home.faq.q4": "既存のAIサブスクリプションをCodarkで使えますか？",
  "home.faq.a4.p1":
    "はい、Codarkは主要プロバイダーのサブスクリプションプランに対応しています。Claude Pro/Max、ChatGPT Plus/Pro、GitHub Copilotのサブスクリプションを利用できます。",
  "home.faq.q5": "ターミナルだけで使えますか？",
  "home.faq.a5.beforeDesktop": "もう違います！Codarkは今は",
  "home.faq.a5.desktop": "デスクトップ",
  "home.faq.a5.and": "と",
  "home.faq.a5.web": "ウェブ",
  "home.faq.q6": "Codarkの価格は？",
  "home.faq.a6":
    "Codarkは100%無料で使えます。無料モデルも含まれています。他のプロバイダーに接続する場合は追加費用が発生することがあります。",
  ...
  "home.faq.q8": "Codarkはオープンソースですか？",
  "home.faq.a8.p1": "はい、Codarkは完全にオープンソースです。ソースコードは",
  "home.faq.a8.p2": "の",
  ...
  "home.zenCta.body":
    "Zenは、Codarkがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",
  ...
  "zen.faq.a1":
    "Zenは、Codarkのチームが作成した、コーディングエージェント向けにテスト・ベンチマークされたAIモデルの厳選セットです。",
  ...
  "zen.faq.a3":
    "Zenは営利目的ではありません。Zenはモデル提供元のコストをそのままあなたに渡します。Zenの利用が増えるほど、Codarkはより良いレートを交渉し、その分をあなたに還元できます。",
  "zen.faq.q4": "Zenの料金は？",
  ...
  "zen.faq.a4.p3": "コストを賄うために、Codarkは$20の残高チャージあたり$1.23の小さな決済手数料のみを追加します。",
  ...
  "zen.faq.a8":
    "ZenはCodarkとの相性が良いですが、どのエージェントでもZenを利用できます。お使いのコーディングエージェントのセットアップ手順に従ってください。",
  ...
  "zen.problem.subtitle": "Codarkユーザーだけでなく、すべての人を対象にこの問題を修正しています。",
  ...
  "zen.how.body": "ZenをCodarkとともに使用することをお勧めしますが、Zenはどのエージェントでも使用できます。",
  ...
  "go.problem.body":
    "私たちはCodarkの体験をできるだけ多くの人に届けることに注力しています。OpenCode Goは低価格のサブスクリプションで、最初の月は$5、その後は$10/月です。ゆとりある上限と、最も高性能なオープンソースモデルへの信頼できるアクセスを提供します。",
  "go.problem.subtitle": " ",
  ...
  "go.how.title": "Goの仕組み",
  "go.how.body": "Goは最初の月$5、その後$10/月で始まります。Codarkまたは任意のエージェントで使えます。",
  ...
  "workspace.newUser.feature.lockin.body":
    "任意のコーディングエージェントでZenを使用でき、必要に応じていつでもCodarkを備えた他のプロバイダーを使用し続けることができます。",
  ...
  "workspace.newUser.step.login.after": "してCodarkを選択",
  "workspace.newUser.step.pasteKey": "APIキーを貼り付け",
  "workspace.newUser.step.models.before": "Codarkを起動し実行",
  ...
  "workspace.keys.subtitle": "CodarkサービスにアクセスするためのAPIキーを管理します。",
  "workspace.keys.create": "APIキーの作成",
  "workspace.keys.placeholder": "キー名を入力してください",
  "workspace.keys.empty": "CodarkゲートウェイAPIキーを作成する",
  ...
  "download.title": "Codark | ダウンロード",
  "download.meta.description": "Codark を macOS、Windows、Linux 向けにダウンロード",
  "download.hero.title": "Codark デスクトップ版をダウンロード",
  ...
  "download.faq.a3.beforeLocal":
    "必ずしもそうではありませんが、おそらく必要です。Codarkを有料プロバイダーに接続したい場合はAIサブスクリプションが必要ですが、",
  "download.faq.a3.localLink": "ローカルモデル",
  "download.faq.a3.afterLocal.beforeZen": "であれば無料で利用できます。ユーザーには",
  "download.faq.a3.afterZen":
    "の利用をお勧めしていますが、CodarkはOpenAI、Anthropic、xAIなどの主要なプロバイダーに対応しています。",

  "download.faq.a5.p1": "Codarkは100%無料で利用できます。",
  "download.faq.a5.p2.beforeZen":
    "追加コストはモデルプロバイダーのサブスクリプションから発生します。Codarkはどのモデルプロバイダーでも利用できますが、",
  "download.faq.a5.p2.afterZen": "の利用をおすすめします。",

  "download.faq.a6.p1": "あなたのデータと情報は、Codarkで共有リンクを作成したときにのみ保存されます。",
  "download.faq.a6.p2.beforeShare": "詳しくは",
  "download.faq.a6.shareLink": "共有ページ",

  "enterprise.title": "Codark | 組織向けエンタープライズソリューション",
  "enterprise.meta.description": "エンタープライズソリューションについてCodarkに問い合わせる",
  "enterprise.hero.title": "あなたのコードはあなたのもの",
  "enterprise.hero.body1":
    "Codarkは、データやコンテキストを一切保存せず、ライセンス制限や所有権の主張もなく、組織内で安全に動作します。チームでのトライアルから始め、SSOや社内AIゲートウェイと統合して組織全体に展開できます。",
  ...
  "enterprise.faq.a2":
    "まずはチームでの社内トライアルから始めてください。Codarkはデフォルトでコードやコンテキストデータを保存しないため、簡単に始められます。その後、価格や導入オプションについてお問い合わせください。",
  ...
  "enterprise.faq.a4":
    "はい。Codarkはコードやコンテキストデータを保存しません。すべての処理はローカル、またはAIプロバイダーへの直接API呼び出しを通じて行われます。集中設定とSSO統合により、データは組織のインフラ内で安全に保たれます。",

  "brand.title": "Codark | ブランド",
  "brand.meta.description": "Codark ブランドガイドライン",
  "brand.heading": "ブランドガイドライン",
  "brand.subtitle": "Codarkブランドを扱うためのリソースと素材です。",
  "brand.downloadAll": "すべての素材をダウンロード",

  "changelog.title": "Codark | 変更履歴",
  "changelog.meta.description": "Codark リリースノートと変更履歴",
  "changelog.hero.title": "変更履歴",
  "changelog.hero.subtitle": "Codarkの新しいアップデートと改善",
