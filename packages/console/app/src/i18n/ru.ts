...
export const dict = {
  ...
  "app.meta.description": "Codark - AI-агент с открытым кодом для программирования.",

  "home.title": "Codark | AI-агент с открытым кодом для программирования",
  ...
  "temp.screenshot.caption": "Codark TUI с темой tokyonight",
  "temp.screenshot.alt": "Codark TUI с темой tokyonight",
  ...
  "home.what.title": "Что такое Codark?",
  "home.what.body":
    "Codark — это агент с открытым исходным кодом, который помогает писать код в терминале, IDE или на десктопе.",
  ...
  "home.growth.body":
    "С более чем <strong>{{stars}}</strong> звезд на GitHub, <strong>{{contributors}}</strong> контрибьюторов и <strong>{{commits}}</strong> коммитов, Codark доверяют более <strong>{{monthlyUsers}}</strong> разработчиков ежемесячно.",
  ...
  "home.privacy.body":
    "Codark не хранит ваш код или контекстные данные, поэтому он может работать в средах, чувствительных к приватности.",
  "home.privacy.learnMore": "Подробнее о",
  "home.privacy.link": "приватности",

  "home.faq.q1": "Что такое Codark?",
  "home.faq.a1":
    "Codark — это агент с открытым исходным кодом, который помогает писать и запускать код с любой AI-моделью. Доступен как терминальный интерфейс, десктопное приложение или расширение для IDE.",
  "home.faq.q2": "Как использовать Codark?",
  "home.faq.a2.before": "Проще всего начать с чтения",
  "home.faq.a2.link": "введения",
  "home.faq.q3": "Нужны ли дополнительные подписки на AI для использования Codark?",
  "home.faq.a3.p1":
    "Не обязательно, Codark поставляется с набором бесплатных моделей, которые можно использовать без создания аккаунта.",
  "home.faq.a3.p2.beforeZen":
    "Помимо этого, вы можете использовать любые популярные модели для кодинга, создав аккаунт",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хотя мы рекомендуем использовать Zen, Codark также работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",
  "home.faq.a3.p4.beforeLocal": "Вы даже можете подключить ваши",
  "home.faq.a3.p4.localLink": "локальные модели",
  "home.faq.q4": "Могу ли я использовать мои существующие AI-подписки с Codark?",
  "home.faq.a4.p1":
    "Да, Codark поддерживает подписки всех основных провайдеров. Вы можете использовать ваши подписки Claude Pro/Max, ChatGPT Plus/Pro или GitHub Copilot.",
  "home.faq.q5": "Можно ли использовать Codark только в терминале?",
  "home.faq.a5.beforeDesktop": "Больше нет! Codark теперь доступен как приложение для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "и",
  "home.faq.a5.web": "веба",
  "home.faq.q6": "Сколько стоит Codark?",
  "home.faq.a6":
    "Codark на 100% бесплатен. Он также включает набор бесплатных моделей. Дополнительные расходы могут возникнуть, если вы подключите другого провайдера.",
  ...
  "home.faq.q8": "Codark — это open source?",
  "home.faq.a8.p1": "Да, Codark полностью open source. Исходный код доступен публично на",
  "home.faq.a8.p2": "под",
  ...
  "home.zenCta.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые Codark протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве разных провайдеров, используйте проверенные модели, которые работают.",
  ...
  "zen.hero.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые Codark протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве, используйте проверенные модели, которые работают.",

  "zen.faq.q1": "Что такое OpenCode Zen?",
  "zen.faq.a1":
    "Zen — это отобранный набор AI-моделей, протестированных и проверенных для кодинг-агентов командой, стоящей за Codark.",
  ...
  "zen.faq.a3":
    "Zen — некоммерческий проект. Zen транслирует расходы от провайдеров моделей вам. Чем больше использование Zen, тем лучшие тарифы Codark может согласовать и передать вам.",
  ...
  "zen.faq.a4.p3":
    "Для покрытия расходов Codark добавляет лишь небольшую комиссию за обработку платежа в размере $1.23 при пополнении баланса на $20.",
  ...
  "zen.faq.a8":
    "Хотя Zen отлично работает с Codark, вы можете использовать Zen с любым агентом. Следуйте инструкциям по настройке в вашем любимом агенте.",
  ...
  "zen.problem.subtitle": "Мы исправляем это для всех, а не только для пользователей Codark.",
  ...
  "zen.how.body": "Хотя мы предлагаем использовать Zen с Codark, вы можете использовать его с любым агентом.",
  ...
  "go.problem.body":
    "Мы стремимся сделать Codark доступным для как можно большего числа людей. OpenCode Go - это недорогая подписка: $5 за первый месяц, затем $10/месяц. Она предоставляет щедрые лимиты и надежный доступ к самым мощным моделям с открытым исходным кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go начинается с $5 за первый месяц, затем $10/месяц. Вы можете использовать его с Codark или любым агентом.",
  ...
  "download.title": "Codark | Скачать",
  "download.meta.description": "Скачать Codark для macOS, Windows и Linux",
  "download.hero.title": "Скачать Codark Desktop",
  ...
  "download.section.extensions": "Расширения Codark",
  "download.section.integrations": "Интеграции Codark",
  ...
  "download.faq.a3.beforeLocal":
    "Не обязательно, но возможно. Вам понадобится AI подписка, если вы хотите подключить Codark к платному провайдеру, хотя вы можете работать с",
  ...
  "download.faq.a3.afterZen":
    ", Codark работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",

  "download.faq.a5.p1": "Codark на 100% бесплатен.",
  "download.faq.a5.p2.beforeZen":
    "Любые дополнительные расходы будут связаны с вашей подпиской у провайдера моделей. Хотя Codark работает с любым провайдером моделей, мы рекомендуем использовать",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваши данные и информация сохраняются только при создании ссылок для шеринга в Codark.",
  "download.faq.a6.p2.beforeShare": "Подробнее о",
  "download.faq.a6.shareLink": "страницах шеринга",

  "enterprise.title": "Codark | Корпоративные решения для вашей организации",
  "enterprise.meta.description": "Свяжитесь с Codark для корпоративных решений",
  "enterprise.hero.title": "Ваш код принадлежит вам",
  "enterprise.hero.body1":
    "Codark безопасно работает внутри вашей организации: не хранит данные и контекст, без лицензионных ограничений и претензий на собственность. Начните пробный период с командой, затем разверните по всей организации, интегрировав с SSO и внутренним AI-шлюзом.",
  ...
  "enterprise.faq.a2":
    "Просто начните с внутреннего триала с вашей командой. Codark по умолчанию не хранит ваш код или контекстные данные, поэтому начать легко. Затем свяжитесь с нами, чтобы обсудить цены и варианты внедрения.",
  ...
  "enterprise.faq.a4":
    "Да. Codark не хранит ваш код или контекстные данные. Вся обработка происходит локально или через прямые вызовы API к вашему AI-провайдеру. Благодаря централизованной конфигурации и интеграции SSO ваши данные остаются защищенными внутри инфраструктуры вашей организации.",

  "brand.title": "Codark | Бренд",
  "brand.meta.description": "Гайдлайны бренда Codark",
  "brand.heading": "Гайдлайны бренда",
  "brand.subtitle": "Ресурсы и активы, которые помогут вам работать с брендом Codark.",
  "brand.downloadAll": "Скачать все ресурсы",

  "changelog.title": "Codark | Список изменений",
  "changelog.meta.description": "Примечания к релизам и список изменений Codark",
  "changelog.hero.title": "Список изменений",
  "changelog.hero.subtitle": "Новые обновления и улучшения Codark",
