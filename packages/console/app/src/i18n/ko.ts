...
export const dict = {
  ...
  "notFound.title": "페이지를 찾을 수 없음 | Codark",
  ...
  "app.meta.description": "Codark - 오픈 소스 코딩 에이전트.",

  "home.title": "Codark | 오픈 소스 AI 코딩 에이전트",

  "temp.title": "Codark | 터미널을 위해 만들어진 AI 코딩 에이전트",
  ...
  "temp.feature.zen.beforeLink": "Codark가 제공하는",
  ...
  "temp.screenshot.caption": "tokyonight 테마가 적용된 Codark TUI",
  "temp.screenshot.alt": "tokyonight 테마가 적용된 Codark TUI",
  ...
  "home.what.title": "Codark란 무엇인가요?",
  "home.what.body":
    "Codark는 터미널, IDE, 또는 데스크톱에서 코드를 작성할 수 있도록 도와주는 오픈 소스 에이전트입니다.",
  ...
  "home.growth.body":
    "<strong>{{stars}}</strong>개 이상의 GitHub 스타, <strong>{{contributors}}</strong>명의 기여자, <strong>{{commits}}</strong>개 이상의 커밋과 함께, Codark는 매달 <strong>{{monthlyUsers}}</strong>명 이상의 개발자가 사용하고 신뢰합니다.",
  ...
  "home.privacy.body":
    "Codark는 코드나 컨텍스트 데이터를 저장하지 않으므로, 프라이버시에 민감한 환경에서도 안전하게 작동합니다.",
  "home.privacy.learnMore": "더 알아보기:",
  "home.privacy.link": "프라이버시",

  "home.faq.q1": "Codark란 무엇인가요?",
  "home.faq.a1":
    "Codark는 어떤 AI 모델로든 코드를 작성하고 실행할 수 있도록 도와주는 오픈 소스 에이전트입니다. 터미널 기반 인터페이스, 데스크톱 앱, 또는 IDE 확장 프로그램으로 사용할 수 있습니다.",
  "home.faq.q2": "Codark는 어떻게 사용하나요?",
  "home.faq.a2.before": "가장 쉬운 시작 방법은",
  "home.faq.a2.link": "소개",
  "home.faq.q3": "Codark를 사용하려면 별도의 AI 구독이 필요한가요?",
  "home.faq.a3.p1": "꼭 그렇지는 않습니다. Codark에는 계정 없이도 사용할 수 있는 무료 모델 세트가 포함되어 있습니다.",
  "home.faq.a3.p2.beforeZen": "이 외에도,",
  "home.faq.a3.p2.afterZen": " 계정을 생성하여 인기 있는 코딩 모델들을 사용할 수 있습니다.",
  "home.faq.a3.p3": "Zen 사용을 권장하지만, Codark는 OpenAI, Anthropic, xAI 등 모든 인기 제공자와도 작동합니다.",
  "home.faq.a3.p4.beforeLocal": "또한",
  "home.faq.a3.p4.localLink": "로컬 모델",
  "home.faq.q4": "기존 AI 구독을 Codark에서 사용할 수 있나요?",
  "home.faq.a4.p1":
    "네, Codark는 모든 주요 제공자의 구독 플랜을 지원합니다. Claude Pro/Max, ChatGPT Plus/Pro, 또는 GitHub Copilot 구독을 사용할 수 있습니다.",
  "home.faq.q5": "Codark는 터미널에서만 사용할 수 있나요?",
  "home.faq.a5.beforeDesktop": "이제 아닙니다! Codark는 이제",
  "home.faq.a5.desktop": "데스크톱",
  "home.faq.a5.and": "및",
  "home.faq.a5.web": "웹",
  "home.faq.q6": "Codark 비용은 얼마인가요?",
  "home.faq.a6":
    "Codark는 100% 무료로 사용할 수 있습니다. 무료 모델 세트도 포함되어 있습니다. 다른 제공자를 연결할 경우 추가 비용이 발생할 수 있습니다.",
  ...
  "home.faq.q8": "Codark는 오픈 소스인가요?",
  "home.faq.a8.p1": "네, Codark는 완전히 오픈 소스입니다. 소스 코드는",
  ...
  "home.zenCta.body":
    "Zen은 Codark가 코딩 에이전트를 위해 특별히 테스트하고 벤치마킹한 엄선된 AI 모델 세트에 대한 액세스를 제공합니다. 제공자 간의 일관되지 않은 성능과 품질에 대해 걱정할 필요 없이, 검증된 모델을 사용하세요.",
  ...
  "zen.hero.body":
    "Zen은 Codark가 코딩 에이전트를 위해 특별히 테스트하고 벤치마킹한 엄선된 AI 모델 세트에 대한 액세스를 제공합니다. 일관되지 않은 성능과 품질에 대해 걱정할 필요 없이, 검증된 모델을 사용하세요.",

  "zen.faq.q1": "OpenCode Zen이란 무엇인가요?",
  "zen.faq.a1": "Zen은 Codark 팀이 코딩 에이전트를 위해 테스트하고 벤치마킹한 엄선된 AI 모델 세트입니다.",
  ...
  "zen.faq.a3":
    "Zen은 영리를 목적으로 하지 않습니다. Zen은 모델 제공자의 비용을 사용자에게 그대로 전달합니다. Zen 사용량이 늘어날수록 Codark는 더 좋은 요율을 협상하여 그 혜택을 사용자에게 돌려드릴 수 있습니다.",
  ...
  "zen.faq.a4.p3": "비용을 충당하기 위해 Codark는 $20 잔액 충전 시 $1.23의 소액 결제 처리 수수료만 추가합니다.",
  ...
  "zen.faq.a8":
    "Zen은 Codark와 훌륭하게 작동하지만, 어떤 에이전트와도 Zen을 사용할 수 있습니다. 선호하는 코딩 에이전트의 설정 지침을 따르세요.",
  ...
  "zen.problem.subtitle": "우리는 Codark 사용자뿐만 아니라 모든 분들을 위해 이 문제를 해결하고 있습니다.",
  ...
  "zen.how.body": "Codark와 함께 사용하는 것을 권장하지만, Zen은 어떤 에이전트와도 사용할 수 있습니다.",
  ...
  "go.problem.body":
    "우리는 가능한 많은 사람들에게 Codark 경험을 제공하는 데 집중하고 있습니다. OpenCode Go는 저렴한 구독 서비스로, 첫 달 $5, 이후 $10/월입니다. 넉넉한 한도와 가장 뛰어난 오픈 소스 모델에 대한 안정적인 액세스를 제공합니다.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go는 첫 달 $5, 이후 $10/월로 시작합니다. Codark 또는 어떤 에이전트와도 함께 사용할 수 있습니다.",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen을 어떤 코딩 에이전트와도 함께 사용할 수 있으며, 원할 때 언제든지 Codark와 함께 다른 제공자를 계속 사용할 수 있습니다.",
  ...
  "workspace.newUser.step.login.after": "후 Codark 선택",
  "workspace.newUser.step.pasteKey": "API 키 붙여넣기",
  "workspace.newUser.step.models.before": "Codark를 시작하고 실행",
  ...
  "workspace.keys.subtitle": "Codark 서비스 액세스를 위한 API 키를 관리하세요.",
  "workspace.keys.create": "API 키 생성",
  "workspace.keys.placeholder": "키 이름 입력",
  "workspace.keys.empty": "Codark 게이트웨이 API 키 생성",
  ...
  "download.title": "Codark | 다운로드",
  "download.meta.description": "macOS, Windows, Linux용 Codark 다운로드",
  "download.hero.title": "Codark 데스크톱 다운로드",
  "download.hero.subtitle": "macOS, Windows, Linux용 베타 버전 사용 가능",
  "download.hero.button": "{{os}}용 다운로드",
  "download.section.terminal": "Codark 터미널",
  "download.section.desktop": "Codark 데스크톱",
  "download.section.extensions": "Codark 확장 프로그램",
  "download.section.integrations": "Codark 통합",
  ...
  "download.faq.a3.beforeLocal":
    "꼭 그렇지는 않지만, 아마도 필요할 것입니다. Codark를 유료 제공자에 연결하려면 AI 구독이 필요할 수 있습니다. 하지만",
  "download.faq.a3.localLink": "로컬 모델",
  "download.faq.a3.afterLocal.beforeZen": "은 무료로 사용할 수 있습니다. 우리는",
  "download.faq.a3.afterZen": " 사용을 권장하지만, Codark는 OpenAI, Anthropic, xAI 등 모든 인기 제공자와 작동합니다.",

  "download.faq.a5.p1": "Codark는 100% 무료로 사용할 수 있습니다.",
  "download.faq.a5.p2.beforeZen":
    "추가 비용은 모델 제공자 구독에서 발생합니다. Codark는 모든 모델 제공자와 작동하지만, 우리는",
  "download.faq.a5.p2.afterZen": " 사용을 권장합니다.",

  "download.faq.a6.p1": "데이터와 정보는 Codark에서 공유 링크를 생성할 때만 저장됩니다.",
  "download.faq.a6.p2.beforeShare": "더 알아보기:",
  "download.faq.a6.shareLink": "공유 페이지",

  "enterprise.title": "Codark | 조직을 위한 엔터프라이즈 솔루션",
  "enterprise.meta.description": "Codark 엔터프라이즈 솔루션 문의",
  "enterprise.hero.title": "여러분의 코드는 여러분의 것입니다",
  "enterprise.hero.body1":
    "Codark는 조직 내부에서 안전하게 작동하며, 데이터나 컨텍스트를 저장하지 않고 라이선스 제한이나 소유권 주장도 없습니다. 팀과 함께 트라이얼을 시작한 후, SSO 및 내부 AI 게이트웨이와 통합하여 조직 전체에 배포하세요.",
  ...
  "enterprise.faq.q1": "Codark 엔터프라이즈란 무엇인가요?",
  "enterprise.faq.a1":
    "Codark 엔터프라이즈는 코드와 데이터가 인프라 외부로 유출되지 않도록 보장하려는 조직을 위한 솔루션입니다. SSO 및 내부 AI 게이트웨이와 통합되는 중앙 집중식 설정을 통해 이를 구현합니다.",
  "enterprise.faq.q2": "Codark 엔터프라이즈는 어떻게 시작하나요?",
  "enterprise.faq.a2":
    "팀과 함께 내부 트라이얼로 간단히 시작해보세요. Codark는 기본적으로 코드나 컨텍스트 데이터를 저장하지 않아 시작하기 쉽습니다. 그 후 가격 및 구현 옵션에 대해 문의해주세요.",
  ...
  "enterprise.faq.q4": "Codark 엔터프라이즈에서 데이터는 안전한가요?",
  "enterprise.faq.a4":
    "네. Codark는 코드나 컨텍스트 데이터를 저장하지 않습니다. 모든 처리는 로컬에서 이루어지거나 AI 제공자에 대한 직접 API 호출을 통해 이루어집니다. 중앙 설정 및 SSO 통합을 통해 데이터는 조직의 인프라 내에서 안전하게 유지됩니다.",

  "brand.title": "Codark | 브랜드",
  "brand.meta.description": "Codark 브랜드 가이드라인",
  "brand.heading": "브랜드 가이드라인",
  "brand.subtitle": "Codark 브랜드를 활용하는 데 도움이 되는 리소스와 자산입니다.",
  "brand.downloadAll": "모든 자산 다운로드",

  "changelog.title": "Codark | 변경 내역",
  "changelog.meta.description": "Codark 릴리스 노트 및 변경 내역",
  "changelog.hero.title": "변경 내역",
  "changelog.hero.subtitle": "Codark의 새로운 업데이트 및 개선 사항",
