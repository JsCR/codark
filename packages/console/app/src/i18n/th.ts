...
export const dict = {
  ...
  "notFound.title": "ไม่พบหน้า | Codark",
  ...
  "app.meta.description": "Codark - เอเจนต์เขียนโค้ดแบบโอเพนซอร์ส",

  "home.title": "Codark | เอเจนต์เขียนโค้ดด้วย AI แบบโอเพนซอร์ส",

  "temp.title": "Codark | เอเจนต์เขียนโค้ด AI ที่สร้างมาเพื่อเทอร์มินัล",
  ...
  "temp.feature.zen.afterLink": "โดย Codark",
  "temp.feature.models.beforeLink": "รองรับผู้ให้บริการ LLM กว่า 75 รายผ่าน",
  "temp.feature.models.afterLink": "รวมถึงโมเดล Local",
  "temp.screenshot.caption": "Codark TUI พร้อมธีม tokyonight",
  "temp.screenshot.alt": "Codark TUI พร้อมธีม tokyonight",
  ...
  "home.what.title": "Codark คืออะไร?",
  "home.what.body": "Codark คือเอเจนต์โอเพนซอร์สที่ช่วยคุณเขียนโค้ดในเทอร์มินัล, IDE หรือเดสก์ท็อป",
  ...
  "home.growth.body":
    "ด้วยยอดดาวบน GitHub กว่า <strong>{{stars}}</strong> ดวง, ผู้ร่วมพัฒนา <strong>{{contributors}}</strong> คน, และการคอมมิตกว่า <strong>{{commits}}</strong> ครั้ง, Codark ได้รับความไว้วางใจจากนักพัฒนากว่า <strong>{{monthlyUsers}}</strong> คนในทุกเดือน",
  ...
  "home.privacy.body":
    "Codark ไม่จัดเก็บโค้ดหรือข้อมูลบริบทของคุณ เพื่อให้สามารถทำงานในสภาพแวดล้อมที่ให้ความสำคัญกับความเป็นส่วนตัวได้",
  "home.privacy.learnMore": "เรียนรู้เพิ่มเติมเกี่ยวกับ",
  "home.privacy.link": "ความเป็นส่วนตัว",

  "home.faq.q1": "Codark คืออะไร?",
  "home.faq.a1":
    "Codark เป็นเอเจนต์โอเพนซอร์สที่ช่วยให้คุณเขียนและรันโค้ดด้วยโมเดล AI ใดก็ได้ มีให้เลือกใช้ทั้งแบบอินเทอร์เฟซเทอร์มินัล, แอปเดสก์ท็อป หรือส่วนขยาย IDE",
  "home.faq.q2": "ฉันจะเริ่มใช้ Codark ได้อย่างไร?",
  "home.faq.a2.before": "วิธีเริ่มต้นที่ง่ายที่สุดคืออ่าน",
  "home.faq.a2.link": "บทนำ",
  "home.faq.q3": "ต้องสมัครสมาชิก AI เพิ่มเติมเพื่อใช้ Codark หรือไม่?",
  "home.faq.a3.p1": "ไม่จำเป็นเสมอไป Codark มาพร้อมกับชุดโมเดลฟรีที่คุณสามารถใช้ได้โดยไม่ต้องสร้างบัญชี",
  "home.faq.a3.p2.beforeZen": "นอกจากนี้ คุณสามารถใช้โมเดลยอดนิยมใดก็ได้โดยการสร้างบัญชี",
  "home.faq.a3.p2.afterZen": "",
  "home.faq.a3.p3":
    "แม้เราจะแนะนำให้ใช้ Zen แต่ Codark ก็ทำงานร่วมกับผู้ให้บริการยอดนิยมทั้งหมด เช่น OpenAI, Anthropic, xAI เป็นต้น",
  "home.faq.a3.p4.beforeLocal": "คุณยังสามารถเชื่อมต่อกับ",
  "home.faq.a3.p4.localLink": "โมเดล Local ของคุณ",
  "home.faq.q4": "ฉันสามารถใช้การสมัครสมาชิก AI ที่มีอยู่กับ Codark ได้หรือไม่?",
  "home.faq.a4.p1":
    "ได้ Codark รองรับแผนการสมัครสมาชิกจากผู้ให้บริการหลักทั้งหมด คุณสามารถใช้การสมัครสมาชิก Claude Pro/Max, ChatGPT Plus/Pro หรือ GitHub Copilot ของคุณได้",
  "home.faq.q5": "ฉันใช้ Codark ได้เฉพาะในเทอร์มินัลใช่หรือไม่?",
  "home.faq.a5.beforeDesktop": "ไม่อีกต่อไป! Codark มีแอปสำหรับ",
  "home.faq.a5.desktop": "เดสก์ท็อป",
  "home.faq.a5.and": "และ",
  "home.faq.a5.web": "เว็บ",
  "home.faq.q6": "Codark ราคาเท่าไหร่?",
  "home.faq.a6":
    "Codark ใช้งานได้ฟรี 100% และมาพร้อมกับชุดโมเดลฟรี อาจมีค่าใช้จ่ายเพิ่มเติมหากคุณเชื่อมต่อกับผู้ให้บริการรายอื่น",
  ...
  "home.faq.q8": "Codark เป็นโอเพนซอร์สหรือไม่?",
  "home.faq.a8.p1": "ใช่ Codark เป็นโอเพนซอร์สเต็มรูปแบบ ซอร์สโค้ดเปิดเผยต่อสาธารณะบน",
  ...
  "home.zenCta.body":
    "Zen ให้คุณเข้าถึงชุดโมเดล AI ที่คัดสรรมาแล้ว ซึ่ง Codark ได้ทดสอบและทำเบนช์มาร์กโดยเฉพาะสำหรับเอเจนต์เขียนโค้ด ไม่ต้องกังวลเรื่องประสิทธิภาพและคุณภาพที่ไม่สม่ำเสมอจากผู้ให้บริการ ใช้โมเดลที่ผ่านการตรวจสอบแล้วว่าใช้งานได้จริง",
  ...
  "zen.hero.body":
    "Zen ให้คุณเข้าถึงชุดโมเดล AI ที่คัดสรรมาแล้ว ซึ่ง Codark ได้ทดสอบและทำเบนช์มาร์กโดยเฉพาะสำหรับเอเจนต์เขียนโค้ด ไม่ต้องกังวลเรื่องประสิทธิภาพและคุณภาพที่ไม่สม่ำเสมอ ใช้โมเดลที่ผ่านการตรวจสอบแล้วว่าใช้งานได้จริง",

  "zen.faq.q1": "OpenCode Zen คืออะไร?",
  "zen.faq.a1":
    "Zen คือชุดโมเดล AI ที่คัดสรรมาอย่างดี ผ่านการทดสอบและทำเบนช์มาร์กสำหรับเอเจนต์เขียนโค้ด สร้างโดยทีมงานผู้อยู่เบื้องหลัง Codark",
  ...
  "zen.faq.a3":
    "Zen ไม่ได้แสวงหากำไร Zen ส่งผ่านต้นทุนจากผู้ให้บริการโมเดลมาถึงคุณ ยิ่งมีการใช้งาน Zen มากเท่าไหร่ Codark ก็ยิ่งสามารถต่อรองเรตราคาที่ดีกว่าและส่งต่อให้คุณได้มากขึ้นเท่านั้น",
  ...
  "zen.faq.a4.p3":
    "เพื่อครอบคลุมต้นทุน Codark คิดค่าธรรมเนียมการประมวลผลการชำระเงินเพียงเล็กน้อย $1.23 ต่อการเติมเงิน $20",
  ...
  "zen.faq.a8":
    "แม้ว่า Zen จะทำงานได้ดีเยี่ยมกับ Codark แต่คุณสามารถใช้ Zen กับเอเจนต์ใดก็ได้ เพียงทำตามคำแนะนำการตั้งค่าในเอเจนต์เขียนโค้ดที่คุณต้องการ",
  ...
  "zen.problem.subtitle": "เรากำลังแก้ไขปัญหานี้สำหรับทุกคน ไม่ใช่แค่ผู้ใช้ Codark เท่านั้น",
  ...
  "zen.how.body": "แม้เราจะแนะนำให้คุณใช้ Zen กับ Codark แต่คุณสามารถใช้ Zen กับเอเจนต์ใดก็ได้",
  ...
  "go.problem.body":
    "เรามุ่งมั่นที่จะนำประสบการณ์ Codark ไปสู่ผู้คนให้ได้มากที่สุด OpenCode Go เป็นการสมัครสมาชิกราคาประหยัด: $5 สำหรับเดือนแรก จากนั้น $10/เดือน โดยมอบขีดจำกัดที่เอื้อเฟื้อและการเข้าถึงโมเดลโอเพนซอร์สที่มีความสามารถสูงสุดอย่างเชื่อถือได้",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go เริ่มต้นที่ $5 สำหรับเดือนแรก จากนั้น $10/เดือน คุณสามารถใช้กับ Codark หรือเอเจนต์ใดก็ได้",
  ...
  "workspace.newUser.feature.lockin.body":
    "ใช้ Zen กับเอเจนต์เขียนโค้ดใดก็ได้ และกลับมาใช้ผู้ให้บริการรายอื่นด้วย Codark ได้ทุกเมื่อที่คุณต้องการ",
  ...
  "workspace.newUser.step.login.after": "และเลือก Codark",
  "workspace.newUser.step.pasteKey": "วาง API key ของคุณ",
  "workspace.newUser.step.models.before": "เริ่ม Codark และรัน",
  ...
  "workspace.keys.subtitle": "จัดการ API keys ของคุณสำหรับการเข้าถึงบริการ Codark",
  "workspace.keys.create": "สร้าง API Key",
  "workspace.keys.placeholder": "ป้อนชื่อ Key",
  "workspace.keys.empty": "สร้าง Codark Gateway API key",
  ...
  "download.title": "Codark | ดาวน์โหลด",
  "download.meta.description": "ดาวน์โหลด Codark สำหรับ macOS, Windows และ Linux",
  "download.hero.title": "ดาวน์โหลด Codark สำหรับเดสก์ท็อป",
  ...
  "download.section.extensions": "ส่วนขยาย Codark",
  "download.section.integrations": "การเชื่อมต่อ Codark",
  ...
  "download.faq.a3.beforeLocal":
    "ไม่จำเป็นเสมอไป แต่อาจจะต้องมี คุณจะต้องมีการสมัครสมาชิก AI หากต้องการเชื่อมต่อ Codark กับผู้ให้บริการที่มีค่าใช้จ่าย แม้ว่าคุณจะสามารถทำงานกับ",
  "download.faq.a3.localLink": "โมเดล Local",
  "download.faq.a3.afterLocal.beforeZen": "ได้ฟรี แม้ว่าเราจะแนะนำให้ผู้ใช้ใช้งาน",
  "download.faq.a3.afterZen": ", Codark ก็ทำงานร่วมกับผู้ให้บริการยอดนิยมทั้งหมด เช่น OpenAI, Anthropic, xAI เป็นต้น",

  "download.faq.a5.p1": "Codark ใช้งานได้ฟรี 100%",
  "download.faq.a5.p2.beforeZen":
    "ค่าใช้จ่ายเพิ่มเติมใดๆ จะมาจากการสมัครสมาชิกของคุณกับผู้ให้บริการโมเดล แม้ว่า Codark จะทำงานร่วมกับผู้ให้บริการโมเดลใดก็ได้ แต่เราแนะนำให้ใช้",
  "download.faq.a5.p2.afterZen": "",

  "download.faq.a6.p1": "ข้อมูลของคุณจะถูกจัดเก็บเฉพาะเมื่อคุณสร้างลิงก์ที่แชร์ได้ใน Codark เท่านั้น",
  "download.faq.a6.p2.beforeShare": "เรียนรู้เพิ่มเติมเกี่ยวกับ",
  "download.faq.a6.shareLink": "หน้าแชร์",

  "enterprise.title": "Codark | โซลูชันระดับองค์กรสำหรับองค์กรของคุณ",
  "enterprise.meta.description": "ติดต่อ Codark สำหรับโซลูชันระดับองค์กร",
  "enterprise.hero.title": "โค้ดของคุณเป็นของคุณ",
  "enterprise.hero.body1":
    "Codark ทำงานอย่างปลอดภัยภายในองค์กรของคุณ โดยไม่มีการจัดเก็บข้อมูลหรือบริบท และไม่มีข้อจำกัดด้านไลเซนส์หรือการอ้างสิทธิ์ความเป็นเจ้าของ เริ่มทดลองใช้งานกับทีมของคุณ แล้วนำไปใช้งานทั่วทั้งองค์กรโดยการผสานรวมกับ SSO และ AI gateway ภายในของคุณ",
  ...
  "enterprise.faq.a2":
    "เพียงเริ่มจากการทดลองใช้งานภายในกับทีมของคุณ โดยค่าเริ่มต้น Codark ไม่จัดเก็บโค้ดหรือข้อมูลบริบทของคุณ ทำให้เริ่มต้นได้ง่าย จากนั้นติดต่อเราเพื่อพูดคุยเรื่องราคาและตัวเลือกการติดตั้งใช้งาน",
  ...
  "enterprise.faq.a4":
    "ใช่ Codark ไม่จัดเก็บโค้ดหรือข้อมูลบริบทของคุณ การประมวลผลทั้งหมดเกิดขึ้นในเครื่องหรือผ่านการเรียก API โดยตรงไปยังผู้ให้บริการ AI ของคุณ ด้วยการตั้งค่าแบบศูนย์กลางและการผสานรวม SSO ข้อมูลของคุณจะยังคงปลอดภัยอยู่ภายในโครงสร้างพื้นฐานขององค์กร",

  "brand.title": "Codark | แบรนด์",
  "brand.meta.description": "แนวทางการใช้แบรนด์ Codark",
  "brand.heading": "แนวทางการใช้แบรนด์",
  "brand.subtitle": "ทรัพยากรและแอสเซทเพื่อช่วยให้คุณใช้งานแบรนด์ Codark",
  "brand.downloadAll": "ดาวน์โหลดแอสเซททั้งหมด",

  "changelog.title": "Codark | บันทึกการเปลี่ยนแปลง",
  "changelog.meta.description": "บันทึกการออกรุ่นและบันทึกการเปลี่ยนแปลง Codark",
  "changelog.hero.title": "บันทึกการเปลี่ยนแปลง",
  "changelog.hero.subtitle": "การอัปเดตและการปรับปรุงใหม่ใน Codark",
