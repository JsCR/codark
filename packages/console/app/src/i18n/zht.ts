...
export const dict = {
  ...
  "app.meta.description": "Codark - 開源編碼代理。",

  "home.title": "Codark | 開源 AI 編碼代理",

  "temp.title": "Codark | 專為終端打造的 AI 編碼代理",
  ...
  "temp.feature.zen.afterLink": "由 Codark 提供",
  "temp.feature.models.beforeLink": "透過",
  "temp.feature.models.afterLink": "支援 75+ 家 LLM 供應商，包括本地模型",
  "temp.screenshot.caption": "使用 tokyonight 主題的 Codark TUI",
  "temp.screenshot.alt": "使用 tokyonight 主題的 Codark TUI",
  ...
  "home.what.title": "什麼是 Codark？",
  "home.what.body": "Codark 是一個開源代理，幫助你在終端、IDE 或桌面端編寫程式碼。",
  ...
  "home.growth.body":
    "擁有超過 <strong>{{stars}}</strong> 個 GitHub Star、<strong>{{contributors}}</strong> 位貢獻者以及超過 <strong>{{commits}}</strong> 次提交，Codark 每月被超過 <strong>{{monthlyUsers}}</strong> 名開發者使用並信賴。",
  "home.growth.githubStars": "GitHub Star",
  "home.growth.contributors": "貢獻者",
  "home.growth.monthlyDevs": "每月活躍開發者",

  "home.privacy.title": "隱私優先",
  "home.privacy.body": "Codark 不儲存你的程式碼或上下文資料，因此可以在注重隱私的環境中運作。",
  "home.privacy.learnMore": "了解更多關於",
  "home.privacy.link": "隱私",

  "home.faq.q1": "什麼是 Codark？",
  "home.faq.a1":
    "Codark 是一個開源代理，幫助你使用任意 AI 模型編寫並執行程式碼。它提供終端介面、桌面應用程式或 IDE 擴充功能。",
  "home.faq.q2": "如何使用 Codark？",
  "home.faq.a2.before": "最簡單的方式是先閱讀",
  "home.faq.a2.link": "入門介紹",
  "home.faq.q3": "使用 Codark 需要額外的 AI 訂閱嗎？",
  "home.faq.a3.p1": "不一定。Codark 自帶一組免費模型，無需建立帳號即可使用。",
  "home.faq.a3.p2.beforeZen": "此外，你可以透過建立",
  "home.faq.a3.p2.afterZen": "帳號使用常見的編碼模型。",
  "home.faq.a3.p3": "我們鼓勵使用 Zen，但 Codark 也支援 OpenAI、Anthropic、xAI 等主流供應商。",
  "home.faq.a3.p4.beforeLocal": "你還可以連接你的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "可以使用我現有的 AI 訂閱嗎？",
  "home.faq.a4.p1":
    "可以。Codark 支援主流供應商的訂閱方案，包括 Claude Pro/Max、ChatGPT Plus/Pro 與 GitHub Copilot。",
  "home.faq.q5": "Codark 只能在終端中使用嗎？",
  "home.faq.a5.beforeDesktop": "不再是了！Codark 現在也提供",
  "home.faq.a5.desktop": "桌面端",
  "home.faq.a5.and": "與",
  "home.faq.a5.web": "網頁端",
  "home.faq.q6": "Codark 價格如何？",
  "home.faq.a6": "Codark 100% 免費使用。它也自帶一組免費模型。如果你連接其他供應商，可能會產生額外費用。",
  ...
  "home.faq.q8": "Codark 是開源的嗎？",
  "home.faq.a8.p1": "是的，Codark 完全開源。原始碼公開在",
  "home.faq.a8.p2": "並採用",
  ...
  "home.zenCta.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 Codark 為了編碼代理專門測試與評測過的。無需擔心不同供應商之間效能與品質參差不齊，使用經過驗證的模型即可。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "OpenCode Zen | 專為編碼代理精選的可靠最佳化模型",
  "zen.hero.title": "專為編碼代理提供的可靠最佳化模型",
  "zen.hero.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 Codark 為了編碼代理專門測試與評測過的。無需擔心效能與品質參差不齊，使用經過驗證的模型即可。",

  "zen.faq.q1": "什麼是 OpenCode Zen？",
  "zen.faq.a1": "Zen 是由 Codark 團隊打造、專為編碼代理測試與評測的 AI 模型精選集合。",
  "zen.faq.q2": "是什麼讓 Zen 更準確？",
  "zen.faq.a2": "Zen 只提供專為編碼代理測試與評測的模型。你不會用奶油刀切牛排，也別用糟糕的模型來寫程式。",
  "zen.faq.q3": "Zen 更便宜嗎？",
  "zen.faq.a3":
    "Zen 不以營利為目的。Zen 會把模型供應商的成本原樣轉給你。Zen 的使用量越高，Codark 就越能談到更好的價格並把優惠讓利給你。",
  ...
  "zen.faq.a4.p3": "為了覆蓋成本，Codark 只會收取很小的支付處理費：每次儲值 $20 會額外收取 $1.23。",
  "zen.faq.q5": "資料與隱私如何？",
  ...
  "zen.faq.a8":
    "Zen 與 Codark 搭配得很好，但你也可以在任何代理中使用 Zen。請在你偏好的編碼代理中按照設定說明進行配置。",
  ...
  "zen.problem.subtitle": "我們正在為所有人解決此問題，而不僅僅是 Codark 使用者。",
  ...
  "zen.how.body": "雖然我們建議你將 Zen 與 Codark 一起使用，但你可以將 Zen 與任何代理一起使用。",
  ...
  "go.problem.body":
    "我們致力於將 Codark 體驗帶給盡可能多的人。OpenCode Go 是一款低成本訂閱服務：首月 $5，之後 $10/月。它提供充裕的額度，並讓您能可靠地使用最強大的開源模型。",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 起價為首月 $5，之後 $10/月。您可以將其與 Codark 或任何代理搭配使用。",
  ...
  "workspace.newUser.feature.lockin.body":
    "將 Zen 與任何編碼代理結合使用，並在需要時隨時使用 Codark 連接其他供應商。",
  ...
  "workspace.newUser.step.login.after": "並選擇 Codark",
  "workspace.newUser.step.pasteKey": "貼上你的 API 金鑰",
  "workspace.newUser.step.models.before": "啟動 Codark 並執行",
  ...
  "workspace.keys.subtitle": "管理你的 API 金鑰以存取 Codark 服務。",
  "workspace.keys.create": "建立 API 金鑰",
  "workspace.keys.placeholder": "輸入金鑰名稱",
  "workspace.keys.empty": "建立 Codark 閘道器 API 金鑰",
  ...
  "download.title": "Codark | 下載",
  "download.meta.description": "下載適用於 macOS、Windows 與 Linux 的 Codark",
  "download.hero.title": "下載 Codark 桌面版",
  "download.hero.subtitle": "適用於 macOS、Windows 與 Linux 的 Beta 版現已提供",
  "download.hero.button": "下載 {{os}} 版",
  "download.section.terminal": "Codark 終端",
  "download.section.desktop": "Codark 桌面版",
  "download.section.extensions": "Codark 擴充功能",
  "download.section.integrations": "Codark 整合",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但很可能需要。如果你想將 Codark 連接到付費供應商，你需要 AI 訂閱，不過你也可以使用",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免費。我們也推薦使用",
  "download.faq.a3.afterZen": "，但 Codark 同樣支援 OpenAI、Anthropic、xAI 等所有主流供應商。",

  "download.faq.a5.p1": "Codark 100% 免費使用。",
  "download.faq.a5.p2.beforeZen": "額外費用來自你對模型供應商的訂閱。雖然 Codark 支援任何模型供應商，但我們建議使用",
  "download.faq.a5.p2.afterZen": "。",

  "download.faq.a6.p1": "你的資料與資訊只會在你於 Codark 中建立可分享連結時被儲存。",
  "download.faq.a6.p2.beforeShare": "了解更多關於",
  "download.faq.a6.shareLink": "分享頁面",

  "enterprise.title": "Codark | 面向組織的企業解決方案",
  "enterprise.meta.description": "聯絡 Codark 取得企業解決方案",
  "enterprise.hero.title": "你的程式碼屬於你",
  "enterprise.hero.body1":
    "Codark 在你的組織內部安全運作，不會儲存任何資料或上下文，也沒有授權限制或所有權主張。你可以先與團隊進行試用，然後透過與你的 SSO 與內部 AI 閘道器整合，將其部署到整個組織。",
  ...
  "enterprise.faq.a2":
    "只要先以團隊的內部試用開始。Codark 預設不會儲存你的程式碼或上下文資料，所以上手非常容易。之後聯絡我們，討論定價與完整實作方案。",
  ...
  "enterprise.faq.a4":
    "是的。Codark 不會儲存你的程式碼或上下文資料。所有處理都會在本地或透過直接呼叫你的 AI 供應商 API 完成。透過中央化設定與 SSO 整合，你的資料會安全保留在組織的基礎設施內部。",

  "brand.title": "Codark | 品牌",
  "brand.meta.description": "Codark 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "協助你使用 Codark 品牌的資源與素材。",
  "brand.downloadAll": "下載所有素材",

  "changelog.title": "Codark | 更新日誌",
  "changelog.meta.description": "Codark 發布說明與更新日誌",
  "changelog.hero.title": "更新日誌",
  "changelog.hero.subtitle": "Codark 的新更新與改善",
