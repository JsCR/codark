...
export const dict = {
  ...
  "app.meta.description": "Codark - وكيل البرمجة مفتوح المصدر.",

  "home.title": "Codark | وكيل برمجة بالذكاء الاصطناعي مفتوح المصدر",
  ...
  "temp.screenshot.caption": "واجهة Codark الطرفية مع سمة tokyonight",
  "temp.screenshot.alt": "واجهة Codark الطرفية بسمة tokyonight",
  ...
  "home.what.title": "ما هو Codark؟",
  "home.what.body": "Codark وكيل مفتوح المصدر يساعدك على كتابة الكود في الطرفية، IDE، أو سطح المكتب.",
  ...
  "home.growth.body":
    "مع أكثر من <strong>{{stars}}</strong> نجمة على GitHub، و<strong>{{contributors}}</strong> مساهمًا، وأكثر من <strong>{{commits}}</strong> Commit، يستخدم Codark ويثق به أكثر من <strong>{{monthlyUsers}}</strong> مطوّر كل شهر.",
  ...
  "home.privacy.body": "لا يخزّن Codark أي كود أو بيانات سياق، ليتمكن من العمل في بيئات حساسة للخصوصية.",
  "home.privacy.learnMore": "اعرف المزيد عن",
  "home.privacy.link": "الخصوصية",

  "home.faq.q1": "ما هو Codark؟",
  "home.faq.a1":
    "Codark وكيل مفتوح المصدر يساعدك على كتابة وتشغيل الكود مع أي نموذج ذكاء اصطناعي. متاح كواجهة طرفية، وتطبيق سطح مكتب، أو امتداد IDE.",
  "home.faq.q2": "كيف أستخدم Codark؟",
  "home.faq.a2.before": "أسهل طريقة للبدء هي قراءة",
  "home.faq.a2.link": "المقدمة",
  "home.faq.q3": "هل أحتاج لاشتراكات ذكاء اصطناعي إضافية لاستخدام Codark؟",
  "home.faq.a3.p1":
    "ليس بالضرورة، فـ Codark يأتي مع مجموعة من النماذج المجانية التي تستطيع استخدامها دون إنشاء حساب.",
  "home.faq.a3.p2.beforeZen": "وبخلاف ذلك، يمكنك استخدام أي من نماذج البرمجة الشائعة بإنشاء حساب",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "مع أننا نشجّع المستخدمين على استخدام Zen، فإن Codark يعمل أيضًا مع كل المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",
  "home.faq.a3.p4.beforeLocal": "ويمكنك أيضًا ربط",
  "home.faq.a3.p4.localLink": "النماذج المحلية",
  "home.faq.q4": "هل يمكنني استخدام اشتراكاتي الحالية مع Codark؟",
  "home.faq.a4.p1":
    "نعم، يدعم Codark خطط الاشتراك من كل المزودين الرئيسيين. يمكنك استخدام اشتراكات Claude Pro/Max، ChatGPT Plus/Pro، أو GitHub Copilot.",
  "home.faq.q5": "هل يمكنني استخدام Codark في الطرفية فقط؟",
  "home.faq.a5.beforeDesktop": "ليس بعد الآن! Codark متاح الآن كتطبيق لـ",
  "home.faq.a5.desktop": "سطح المكتب",
  "home.faq.a5.and": "و",
  "home.faq.a5.web": "الويب",
  "home.faq.q6": "كم تكلفة Codark؟",
  "home.faq.a6":
    "Codark مجاني 100% للاستخدام. كما يأتي مع مجموعة من النماذج المجانية. قد توجد تكاليف إضافية إذا ربطت مزوّدًا آخر.",
  ...
  "home.faq.q8": "هل Codark مفتوح المصدر؟",
  "home.faq.a8.p1": "نعم، Codark مفتوح المصدر بالكامل. الكود المصدري متاح علنًا على",
  ...
  "home.zenCta.body":
    "يمنحك Zen الوصول إلى مجموعة مختارة بعناية من نماذج الذكاء الاصطناعي التي اختبرها Codark وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة بين المزودين، استخدم نماذج محققة تعمل بكفاءة.",
  ...
  "zen.hero.body":
    "يمنحك Zen الوصول إلى مجموعة منسقة من نماذج الذكاء الاصطناعي التي اختبرها Codark وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة، استخدم نماذج محققة تعمل بكفاءة.",

  "zen.faq.q1": "ما هو OpenCode Zen؟",
  "zen.faq.a1":
    "Zen هو مجموعة منسقة من نماذج الذكاء الاصطناعي التي تم اختبارها وقياس أدائها لوكلاء البرمجة، أنشأها الفريق المطور لـ Codark.",
  ...
  "zen.faq.a3":
    "Zen ليس للربح. يمرر Zen التكاليف من مزودي النماذج إليك مباشرة. كلما زاد استخدام Zen، تمكن Codark من التفاوض على أسعار أفضل وتمريرها إليك.",
  ...
  "zen.faq.a4.p3":
    "لتغطية التكاليف، يضيف Codark فقط رسومًا صغيرة لمعالجة الدفع قدرها 1.23 دولار لكل إعادة شحن رصيد بقيمة 20 دولارًا.",
  ...
  "zen.faq.a8":
    "بينما يعمل Zen بشكل رائع مع Codark، يمكنك استخدام Zen مع أي وكيل. اتبع تعليمات الإعداد في وكيل البرمجة المفضل لديك.",
  ...
  "zen.problem.subtitle": "نحن نعمل على إصلاح هذا للجميع، وليس فقط لمستخدمي Codark.",
  ...
  "zen.how.body": "بينما نقترح عليك استخدام Zen مع Codark، يمكنك استخدام Zen مع أي وكيل.",
  ...
  "go.problem.body":
    "نحن نركز على تقديم تجربة Codark لأكبر عدد ممكن من الناس. OpenCode Go هو اشتراك منخفض التكلفة: $5 للشهر الأول، ثم $10/شهر. يوفر حدودا سخية ووصولا موثوقا إلى نماذج المصدر المفتوح الأكثر قدرة.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "يبدأ Go من $5 للشهر الأول، ثم $10/شهر. يمكنك استخدامه مع Codark أو أي وكيل.",
  ...
  "download.title": "Codark | تنزيل",
  "download.meta.description": "نزّل Codark لـ macOS، Windows، وLinux",
  "download.hero.title": "تنزيل Codark لسطح المكتب",
  "download.hero.subtitle": "متاح في نسخة تجريبية لـ macOS، Windows، وLinux",
  "download.hero.button": "تنزيل لـ {{os}}",
  "download.section.terminal": "Codark للطرفية",
  "download.section.desktop": "Codark لسطح المكتب",
  "download.section.extensions": "امتدادات Codark",
  "download.section.integrations": "تكاملات Codark",
  ...
  "download.faq.a3.beforeLocal":
    "ليس بالضرورة، ولكن على الأرجح. ستحتاج إلى اشتراك ذكاء اصطناعي إذا كنت تريد ربط Codark بمزوّد مدفوع، رغم أنه يمكنك العمل مع",
  "download.faq.a3.localLink": "النماذج المحلية",
  "download.faq.a3.afterLocal.beforeZen": "مجانًا. بينما نشجع المستخدمين على استخدام",
  "download.faq.a3.afterZen": "، فإن Codark يعمل مع جميع المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",

  "download.faq.a5.p1": "Codark مجاني 100% للاستخدام.",
  "download.faq.a5.p2.beforeZen":
    "أي تكاليف إضافية ستأتي من اشتراكك لدى مزود النماذج. بينما يعمل Codark مع أي مزود نماذج، نوصي باستخدام",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "يتم حفظ بياناتك ومعلوماتك فقط عند إنشاء روابط قابلة للمشاركة في Codark.",
  "download.faq.a6.p2.beforeShare": "اعرف المزيد عن",
  "download.faq.a6.shareLink": "صفحات المشاركة",

  "enterprise.title": "Codark | حلول المؤسسات لمنظمتك",
  "enterprise.meta.description": "تواصل مع Codark لحلول المؤسسات",
  "enterprise.hero.title": "كودك ملكك",
  "enterprise.hero.body1":
    "يعمل Codark بأمان داخل مؤسستك دون تخزين أي بيانات أو سياق، ودون قيود ترخيص أو مطالبات ملكية. ابدأ تجربة مع فريقك، ثم انشره عبر مؤسستك من خلال دمجه مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  ...
  "enterprise.faq.a2":
    "ابدأ ببساطة بتجربة داخلية مع فريقك. افتراضيًا، لا يقوم Codark بتخزين الكود أو بيانات السياق، مما يجعل البدء سهلاً. ثم اتصل بنا لمناقشة الأسعار وخيارات التنفيذ.",
  ...
  "enterprise.faq.a4":
    "نعم. لا يقوم Codark بتخزين الكود أو بيانات السياق. تتم جميع المعالجة محليًا أو عبر استدعاءات API مباشرة إلى مزود الذكاء الاصطناعي لديك. مع التكوين المركزي وتكامل SSO، تظل بياناتك آمنة داخل البنية التحتية لمؤسستك.",

  "brand.title": "Codark | العلامة التجارية",
  "brand.meta.description": "إرشادات العلامة التجارية لـ Codark",
  "brand.heading": "إرشادات العلامة التجارية",
  "brand.subtitle": "موارد وأصول لمساعدتك في العمل مع العلامة التجارية لـ Codark.",
  "brand.downloadAll": "تنزيل جميع الأصول",

  "changelog.title": "Codark | سجل التغييرات",
  "changelog.meta.description": "ملاحظات الإصدار وسجل التغييرات لـ Codark",
  "changelog.hero.title": "سجل التغييرات",
  "changelog.hero.subtitle": "تحديثات وتحسينات جديدة لـ Codark",
