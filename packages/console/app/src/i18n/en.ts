export const dict = {
  ...
  "app.meta.description": "Codark - The open source coding agent.",

  "home.title": "Codark | The open source AI coding agent",
  ...
  "home.what.title": "What is Codark?",
  "home.what.body": "Codark is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, Codark is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "Codark does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is Codark?",
  "home.faq.a1":
    "Codark is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use Codark?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use Codark?",
  "home.faq.a3.p1":
    "Not necessarily, Codark comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, Codark also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with Codark?",
  "home.faq.a4.p1":
    "Yes, Codark supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use Codark in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! Codark is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does Codark cost?",
  "home.faq.a6":
    "Codark is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is Codark open source?",
  "home.faq.a8.p1": "Yes, Codark is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that Codark has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  ...
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that Codark has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is OpenCode Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind Codark.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more Codark can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3": "To cover costs, Codark adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with Codark, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just Codark users.",
  ...
  "zen.how.body": "While we suggest you use Zen with Codark, you can use Zen with any agent.",
  ...
  "go.problem.body":
    "We're focused on bringing the Codark experience to as many people as possible. OpenCode Go is a low cost subscription: $5 for your first month, then $10/month. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go starts at $5 for your first month, then $10/month. You can use it with Codark or any agent.",
  ...
  "download.meta.description": "Download Codark for macOS, Windows, and Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect Codark to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", Codark works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Codark is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While Codark works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in Codark.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "Codark | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact Codark for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "Codark operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. Codark by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "changelog.meta.description": "Codark release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to Codark",
