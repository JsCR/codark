...
export const dict = {
  ...en,
  "app.meta.description": "Codark - L'agent de code open source.",
  "nav.github": "GitHub",
  ...
  "notFound.title": "Introuvable | Codark",
  ...
  "home.title": "Codark | L'agent de code IA open source",

  "temp.title": "Codark | Agent de code IA conçu pour le terminal",
  ...
  "temp.feature.zen.afterLink": "fournie par Codark",
  ...
  "temp.screenshot.caption": "Codark TUI avec le thème tokyonight",
  "temp.screenshot.alt": "Codark TUI avec le thème tokyonight",
  ...
  "home.what.title": "Qu'est-ce que Codark ?",
  "home.what.body":
    "Codark est un agent open source qui vous aide à écrire du code dans votre terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Avec plus de <strong>{{stars}}</strong> étoiles sur GitHub, <strong>{{contributors}}</strong> contributeurs et plus de <strong>{{commits}}</strong> commits, Codark est utilisé et approuvé par plus de <strong>{{monthlyUsers}}</strong> développeurs chaque mois.",
  ...
  "home.privacy.body":
    "Codark ne stocke ni votre code ni vos données de contexte, afin de pouvoir fonctionner dans des environnements sensibles à la confidentialité.",
  "home.privacy.learnMore": "En savoir plus sur",
  "home.privacy.link": "la confidentialité",

  "home.faq.q1": "Qu'est-ce que Codark ?",
  "home.faq.a1":
    "Codark est un agent open source qui vous aide à écrire et exécuter du code avec n'importe quel modèle d'IA. Il est disponible en interface terminal, application desktop ou extension IDE.",
  "home.faq.q2": "Comment utiliser Codark ?",
  "home.faq.a2.before": "Le moyen le plus simple de commencer est de lire l'",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Ai-je besoin d'abonnements IA supplémentaires pour utiliser Codark ?",
  "home.faq.a3.p1":
    "Pas forcément : Codark propose des modèles gratuits que vous pouvez utiliser sans créer de compte.",
  "home.faq.a3.p2.beforeZen": "En plus, vous pouvez utiliser des modèles populaires pour le code en créant un compte",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Nous encourageons l'utilisation de Zen, mais Codark fonctionne aussi avec les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Vous pouvez même connecter vos",
  "home.faq.a3.p4.localLink": "modèles locaux",
  "home.faq.q4": "Puis-je utiliser mes abonnements IA existants avec Codark ?",
  "home.faq.a4.p1":
    "Oui, Codark prend en charge les abonnements des principaux fournisseurs. Vous pouvez utiliser Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Puis-je utiliser Codark uniquement dans le terminal ?",
  "home.faq.a5.beforeDesktop": "Plus maintenant ! Codark est désormais disponible en application pour",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "et",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Combien coûte Codark ?",
  "home.faq.a6":
    "Codark est 100% gratuit. Il inclut aussi des modèles gratuits. Des coûts supplémentaires peuvent s'appliquer si vous connectez un autre fournisseur.",
  ...
  "home.faq.q8": "Codark est-il open source ?",
  "home.faq.a8.p1": "Oui, Codark est entièrement open source. Le code source est public sur",
  ...
  "home.zenCta.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que Codark a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",
  ...
  "zen.faq.a1":
    "Zen est un ensemble sélectionné de modèles d'IA testés et benchmarkés pour les agents de code, créé par l'équipe derrière Codark.",
  ...
  "zen.faq.a3":
    "Zen n'est pas à but lucratif. Zen vous facture au prix coûtant des fournisseurs de modèles. Plus Zen est utilisé, plus Codark peut négocier de meilleurs tarifs et vous les répercuter.",
  ...
  "zen.faq.a4.p3":
    "Pour couvrir les coûts, Codark ajoute uniquement de petits frais de traitement de paiement de 1,23 $ par recharge de 20 $.",
  ...
  "zen.faq.a8":
    "Zen fonctionne très bien avec Codark, mais vous pouvez utiliser Zen avec n'importe quel agent. Suivez les instructions de configuration dans votre agent préféré.",
  ...
  "zen.problem.subtitle":
    "Nous résolvons ce problème pour tout le monde, pas seulement pour les utilisateurs de Codark.",
  ...
  "zen.how.body":
    "Bien que nous vous suggérions d'utiliser Zen avec Codark, vous pouvez utiliser Zen avec n'importe quel agent.",
  ...
  "go.problem.body":
    "Nous nous efforçons d'apporter l'expérience Codark au plus grand nombre. OpenCode Go est un abonnement à faible coût : $5 pour le premier mois, puis 10 $/mois. Il offre des limites généreuses et un accès fiable aux modèles open source les plus performants.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go commence à $5 pour le premier mois, puis 10 $/mois. Vous pouvez l'utiliser avec Codark ou n'importe quel agent.",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilisez Zen avec n'importe quel agent de code et continuez à utiliser d'autres fournisseurs avec Codark quand vous le souhaitez.",
  ...
  "workspace.newUser.step.login.after": "et sélectionnez Codark",
  "workspace.newUser.step.pasteKey": "Collez votre clé API",
  "workspace.newUser.step.models.before": "Démarrez Codark et exécutez",
  ...
  "workspace.keys.subtitle": "Gérez vos clés API pour accéder aux services Codark.",
  "workspace.keys.create": "Créer une clé API",
  "workspace.keys.placeholder": "Entrez le nom de la clé",
  "workspace.keys.empty": "Créer une clé API Codark Gateway",
  ...
  "download.title": "Codark | Téléchargement",
  "download.meta.description": "Téléchargez Codark pour macOS, Windows et Linux",
  "download.hero.title": "Télécharger Codark Desktop",
  ...
  "download.section.extensions": "Extensions Codark",
  "download.section.integrations": "Intégrations Codark",
  ...
  "download.faq.a3.beforeLocal":
    "Pas forcément, mais probablement. Vous aurez besoin d'un abonnement IA si vous voulez connecter Codark à un fournisseur payant, mais vous pouvez travailler avec des",
  ...
  "download.faq.a3.afterZen":
    ", Codark fonctionne avec tous les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "Codark est 100% gratuit à utiliser.",
  "download.faq.a5.p2.beforeZen":
    "Les coûts supplémentaires viendront de votre abonnement à un fournisseur de modèle. Même si Codark fonctionne avec n'importe quel fournisseur, nous recommandons d'utiliser",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Vos données et informations ne sont stockées que lorsque vous créez des liens partageables dans Codark.",
  "download.faq.a6.p2.beforeShare": "En savoir plus sur",
  "download.faq.a6.shareLink": "les pages de partage",

  "enterprise.title": "Codark | Solutions entreprise pour votre organisation",
  "enterprise.meta.description": "Contactez Codark pour des solutions entreprise",
  "enterprise.hero.title": "Votre code vous appartient",
  "enterprise.hero.body1":
    "Codark fonctionne de manière sécurisée au sein de votre organisation, sans stocker de données ni de contexte, et sans restrictions de licence ni revendications de propriété. Démarrez un essai avec votre équipe, puis déployez-le dans votre organisation en l'intégrant à votre SSO et à votre passerelle IA interne.",
  ...
  "enterprise.faq.a2":
    "Commencez simplement par un essai interne avec votre équipe. Par défaut, Codark ne stocke pas votre code ni vos données de contexte, ce qui facilite la prise en main. Ensuite, contactez-nous pour discuter des tarifs et des options de mise en œuvre.",
  ...
  "enterprise.faq.a4":
    "Oui. Codark ne stocke pas votre code ni vos données de contexte. Tout le traitement se fait localement ou via des appels API directs vers votre fournisseur d'IA. Avec une configuration centralisée et une intégration SSO, vos données restent sécurisées au sein de l'infrastructure de votre organisation.",

  "brand.title": "Codark | Marque",
  "brand.meta.description": "Guide de marque Codark",
  "brand.heading": "Guide de marque",
  "brand.subtitle": "Ressources et éléments pour vous aider à travailler avec la marque Codark.",
  "brand.downloadAll": "Télécharger tous les assets",

  "changelog.title": "Codark | Changelog",
  "changelog.meta.description": "Notes de version et changelog d'Codark",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nouvelles mises à jour et améliorations pour Codark",
