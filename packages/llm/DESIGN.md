...
> current private `@codark-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@codark-ai/ai`
...
import { LLM } from "@codark-ai/ai"
import { OpenAI } from "@codark-ai/ai/providers/openai"
...
```ts
import { Message } from "@codark-ai/ai"
...
import { LLM, Tool } from "@codark-ai/ai"
...
```ts
import { LLM } from "@codark-ai/ai/promise"
import { OpenAI } from "@codark-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@codark-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@codark-ai/ai/provider"
...
@codark-ai/ai/promise
  Promise/AsyncIterable LLM facade

@codark-ai/ai/schema
  serializable domain schemas

@codark-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@codark-ai/ai/providers/openai
@codark-ai/ai/providers/anthropic
@codark-ai/ai/providers/google
...
```
