...
The Promise plugin API is the async/await equivalent of `@codark-ai/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@codark-ai/plugin/v2/promise"
