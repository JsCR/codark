...
import { Event } from "@codark-ai/schema/project-directories"
import { ProjectCopy } from "@codark-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@codark/ProjectCopy") {}
