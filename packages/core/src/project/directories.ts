...
import type { EffectDrizzleSqlite } from "@codark-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@codark/ProjectDirectories") {}
