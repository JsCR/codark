...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@codark-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@codark/v2/ToolRegistry") {}
