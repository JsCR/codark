...
export class Service extends Context.Service<Service, Interface>()("@codark/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.CODARK_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
