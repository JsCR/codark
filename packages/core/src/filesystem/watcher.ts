...
import { FileSystemWatcher } from "@codark-ai/schema/filesystem-watcher"
...
declare const CODARK_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CODARK_LIBC === "undefined" ? undefined : CODARK_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@codark/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CODARK_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.CODARK_EXPERIMENTAL_FILEWATCHER)) {
