...
import { ListAnchor } from "@codark-ai/schema/session"
...
import { SessionDurable } from "@codark-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@codark/v2/Session") {}
