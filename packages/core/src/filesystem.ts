...
import { Entry, FileSystem, FindInput, Match } from "@codark-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@codark-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@codark/v2/FileSystem") {}
