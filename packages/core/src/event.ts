...
import type { Data, Definition, Payload } from "@codark-ai/schema/event"
...
import { Durable } from "@codark-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@codark-ai/schema/event").ID
export type { Data, Definition, Payload } from "@codark-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@codark/Event") {}
