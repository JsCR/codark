    ...
    .add(
      HttpApiEndpoint.get("health", GlobalPaths.health, {
        ...
        OpenApi.annotations({
          ...
          summary: "Get health",
          description: "Get health information about the Codark server.",
        }),
      ),
      HttpApiEndpoint.get("event", GlobalPaths.event, {
        ...
        OpenApi.annotations({
          ...
          description: "Subscribe to global events from the Codark system using server-sent events.",
        }),
      ),
      HttpApiEndpoint.get("configGet", GlobalPaths.config, {
        ...
        OpenApi.annotations({
          ...
          description: "Retrieve the current global Codark configuration settings and preferences.",
        }),
      ),
      HttpApiEndpoint.patch("configUpdate", GlobalPaths.config, {
        ...
        OpenApi.annotations({
          ...
          description: "Update global Codark configuration settings and preferences.",
        }),
      ),
      HttpApiEndpoint.post("dispose", GlobalPaths.dispose, {
        ...
        OpenApi.annotations({
          ...
          description: "Clean up and dispose all Codark instances, releasing all resources.",
        }),
      ),
