      ...
      .add(
        HttpApiEndpoint.post("dispose", InstancePaths.dispose, {
          ...
          OpenApi.annotations({
            ...
            description: "Clean up and dispose the current Codark instance, releasing all resources.",
          }),
        ),
        HttpApiEndpoint.get("path", InstancePaths.path, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the Codark instance.",
          }),
        ),
        ...
        HttpApiEndpoint.get("command", InstancePaths.command, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all available commands in the Codark system.",
          }),
        ),
        HttpApiEndpoint.get("agent", InstancePaths.agent, {
          ...
          OpenApi.annotations({
            ...
            summary: "List agents",
            description: "Get a list of all available AI agents in the Codark system.",
          }),
        ),
        HttpApiEndpoint.get("skill", InstancePaths.skill, {
          ...
          OpenApi.annotations({
            ...
            summary: "List skills",
            description: "Get a list of all available skills in the Codark system.",
          }),
        ),
