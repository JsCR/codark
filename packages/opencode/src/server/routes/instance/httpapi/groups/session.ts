      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all Codark sessions, sorted by most recently updated.",
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific Codark session.",
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new Codark session for interacting with AI assistants and managing conversations.",
          }),
        ),
