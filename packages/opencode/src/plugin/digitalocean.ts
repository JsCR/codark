...
import { OauthCallbackPage } from "@codark-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Codark will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
