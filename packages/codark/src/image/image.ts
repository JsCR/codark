...
export class Service extends Context.Service<Service, Interface>()("@codark/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CODARK_PHOTON_WASM_PATH?: string }).__CODARK_PHOTON_WASM_PATH =
