...
import { normalizePromptContent } from "@codark-ai/tui/editor"
...
import { CODARK_BASE_MODE, useBindings } from "@codark-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Codark" } satisfies SlashOption,
    ]
