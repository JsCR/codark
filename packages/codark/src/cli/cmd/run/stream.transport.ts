...
import type { Event, GlobalEvent, OpencodeClient } from "@codark-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@codark/RunStreamTransport") {}
