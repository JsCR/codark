// Shared type vocabulary for the direct interactive mode (`codark --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@codark-ai/sdk/v2"
