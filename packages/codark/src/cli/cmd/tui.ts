...
import { errorMessage } from "@codark-ai/tui/util/error"
import { withTimeout } from "@/util/timeout"
import { withNetworkOptions, resolveNetworkOptionsNoConfig, hasArg } from "@/cli/network"
import { Filesystem } from "@/util/filesystem"
import type { GlobalEvent } from "@codark-ai/sdk/v2"
import type { EventSource } from "@codark-ai/tui/context/sdk"
import { writeHeapSnapshot } from "v8"
import { ServerAuth } from "@/server/auth"
import { validateSession } from "../tui/validate-session"
import { win32InstallCtrlCGuard } from "@codark-ai/tui/terminal-win32"

declare global {
  const CODARK_WORKER_PATH: string
}
...
async function target() {
  if (typeof CODARK_WORKER_PATH !== "undefined") return CODARK_WORKER_PATH
