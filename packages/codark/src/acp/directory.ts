...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@codark/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@codark/ACPDirectory") {}
