...
import { path } from "@codark-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@codark-ai/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@codark/Worktree") {}
