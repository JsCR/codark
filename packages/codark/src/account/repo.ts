...
import { AccountStateTable, AccountTable } from "@codark-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@codark/AccountRepo") {}
