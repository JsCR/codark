...
import { NonNegativeInt } from "@codark-ai/core/schema"
      ...
      .add(
        HttpApiEndpoint.get("capabilities", ExperimentalPaths.capabilities, {
          ...
          OpenApi.annotations({
            ...
            description: "Get experimental features enabled on the Codark server.",
          }),
        ),
        ...
        HttpApiEndpoint.post("consoleSwitch", ExperimentalPaths.consoleSwitch, {
          ...
          OpenApi.annotations({
            ...
            description: "Persist a new active Console account/org selection for the current local Codark state.",
          }),
        ),
        ...
        HttpApiEndpoint.get("session", ExperimentalPaths.session, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Get a list of all Codark sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.",
          }),
        ),
