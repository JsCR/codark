...
import { PermissionV1 } from "@codark-ai/core/v1/permission"
import { Slug } from "@codark-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@codark-ai/llm"
...
import { locationServiceMapLayer } from "@codark-ai/core/location-services"
...
import { PartTable, SessionTable } from "@codark-ai/core/session/sql"
...
import { WorkspaceV2 } from "@codark-ai/core/workspace"
import { SessionID, MessageID, PartID } from "./schema"

import type { Provider } from "@/provider/provider"
import { Global } from "@codark-ai/core/global"
import { Effect, Layer, Option, Context, Schema, Types } from "effect"
import { NonNegativeInt, optional } from "@codark-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".codark", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@codark/Session") {}
