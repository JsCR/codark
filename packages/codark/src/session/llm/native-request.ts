import type { JsonSchema, LLMRequest, ProviderMetadata } from "@codark-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@codark-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @codark-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
