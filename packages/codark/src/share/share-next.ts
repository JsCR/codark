...
import type * as SDK from "@codark-ai/sdk/v2"
...
import { SessionShareTable } from "@codark-ai/core/share/sql"
...
const disabled = process.env["CODARK_DISABLE_SHARE"] === "true" || process.env["CODARK_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@codark/ShareNext") {}
