...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@codark-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@codark/ToolRegistry") {}
