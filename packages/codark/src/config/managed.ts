...
const MANAGED_PLIST_DOMAIN = "ai.codark.managed"

// Keys injected by macOS/MDM into the managed plist that are not Codark config
...
export function managedConfigDir() {
  return process.env.CODARK_TEST_MANAGED_CONFIG_DIR || systemManagedConfigDir()
}
