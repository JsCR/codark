...
import { httpClient, path } from "@codark-ai/core/effect/app-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@codark/SkillDiscovery") {}
      ...
      const dirs = yield* Effect.forEach(
        ...
        (skill) =>
          Effect.gen(function* () {
            ...
            const versionFile = path.join(root, ".codark-version")
            ...
            if (version === undefined || current === version) {
              ...
              yield* Effect.gen(function* () {
                ...
                yield* fs.writeFileString(path.join(staging, ".codark-version"), version)
