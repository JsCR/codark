 ...
 *   "@codark/ServerAuthConfig",
 *   {
 *     password: Config.string("CODARK_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CODARK_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
