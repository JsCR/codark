...
import { EventSequenceTable, EventTable } from "@codark-ai/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@codark/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CODARK_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CODARK_WORKSPACE_ID: config.id,
        CODARK_EXPERIMENTAL_WORKSPACES: "true",
