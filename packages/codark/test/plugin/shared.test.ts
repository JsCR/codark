...
describe("parsePluginSpecifier", () => {
  ...
  test("parses scoped npm package without version", () => {
    expect(parsePluginSpecifier("@codark/acme")).toEqual({
      pkg: "@codark/acme",
      version: "latest",
    })
  })
  ...
  test("parses scoped npm package with version", () => {
    expect(parsePluginSpecifier("@codark/acme@1.0.0")).toEqual({
      pkg: "@codark/acme",
      version: "1.0.0",
    })
  })
  ...
  test("parses scoped package with git+https url", () => {
    expect(parsePluginSpecifier("@codark/acme@git+https://github.com/opencode/acme.git")).toEqual({
      pkg: "@codark/acme",
      version: "git+https://github.com/opencode/acme.git",
    })
  })
  ...
  test("parses scoped package with git+ssh url containing another @", () => {
    expect(parsePluginSpecifier("@codark/acme@git+ssh://git@github.com/opencode/acme.git")).toEqual({
      pkg: "@codark/acme",
      version: "git+ssh://git@github.com/opencode/acme.git",
    })
  })
