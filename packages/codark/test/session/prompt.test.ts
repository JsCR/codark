...
import { SessionMessageTable } from "@codark-ai/core/session/sql"
...
import { LocationServiceMap, locationServiceMapLayer } from "@codark-ai/core/location-services"
...
it.instance("does not loop empty assistant turns for a simple reply", () =>
  Effect.gen(function* () {
    ...
    yield* llm.text("packages/codark/src/session/processor.ts")
