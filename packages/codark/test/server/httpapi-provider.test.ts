...
function writeProviderAuthPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* Effect.promise(() => markPluginDependenciesReady(path.join(dir, ".codark")))

    yield* fs.writeWithDirs(
      path.join(dir, ".codark", "plugin", "provider-oauth-parity.ts"),
      [
        "export default {",
...
function writeProviderAuthValidationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".codark", "plugin", "provider-oauth-validation.ts"),
      [
        "export default {",
...
function writeFunctionOptionsPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".codark", "plugin", "provider-function-options.ts"),
      [
        "export default {",
...
function writeProviderModelsMutationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".codark", "plugin", "provider-models-mutation.ts"),
      [
        "export default {",
