...
const originalWorkspaces = Flag.CODARK_EXPERIMENTAL_WORKSPACES
...
afterEach(async () => {
  Flag.CODARK_EXPERIMENTAL_WORKSPACES = originalWorkspaces
...
describe("session HttpApi", () => {
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        const test = yield* TestInstance
        Flag.CODARK_EXPERIMENTAL_WORKSPACES = true
