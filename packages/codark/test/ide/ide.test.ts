...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CODARK_CALLER", () => {
    process.env["CODARK_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CODARK_CALLER", () => {
    process.env["CODARK_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CODARK_CALLER", () => {
    process.env["CODARK_CALLER"] = "unknown"
