...
Practical reference for the current tool-migration state in `packages/codark`.
...
Tool tests should use the existing Effect helpers in `packages/codark/test/lib/effect.ts`:
