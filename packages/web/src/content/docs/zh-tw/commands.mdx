...
您可以透過 Codark 設定或在 `commands/` 目錄中建立 markdown 檔案來新增自訂指令。

---

### JSON

在 Codark [設定](/docs/config)中使用 `command` 選項：
...
- 全域：`~/.config/codark/commands/`
- 專案層級：`.codark/commands/`
...
Codark 包含多個內建指令，如 `/init`、`/undo`、`/redo`、`/share`、`/help`；[了解更多](/docs/tui#commands)。
