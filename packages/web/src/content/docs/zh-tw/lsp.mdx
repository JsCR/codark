---
title: LSP 伺服器
description: Codark 與您的 LSP 伺服器整合。
---

Codark 可以與語言伺服器協定（LSP）伺服器整合，將診斷資訊作為 agent 的回饋。

---

## 內建支援

Codark 內建了多種適用於主流語言的 LSP 伺服器：
...
您可以透過 Codark 設定檔中的 `lsp` 部分來啟用並自訂 LSP 伺服器。
