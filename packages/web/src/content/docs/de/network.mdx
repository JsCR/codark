...
Codark unterstützt Standard-Proxy-Umgebungsvariablen und benutzerdefinierte Zertifikate für Unternehmensnetzwerkumgebungen.

---

## Proxy

Codark respektiert Standard-Proxy-Umgebungsvariablen.
...
Wenn Ihr Unternehmen benutzerdefinierte Zertifizierungsstellen für HTTPS-Verbindungen verwendet, konfigurieren Sie Codark so, dass es ihnen vertraut.
