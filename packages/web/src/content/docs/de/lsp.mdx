---
title: LSP Server
description: Codark lässt sich in Ihren LSP-Server integrieren.
---

Codark kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

Codark verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und Codark eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Codark-Konfiguration aktivieren und anpassen.
