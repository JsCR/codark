...
description: Verwenden Sie Codark in jedem ACP-kompatiblen Editor.
---

Codark unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um Codark über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `codark acp`.

Der Befehl startet Codark als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „Codark“ in der AI Chat Agent Selector.
...
Um Codark als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass Codark als ACP-Agent für den Chat verwendet wird.
...
Codark funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer Codark-Konfiguration konfiguriert sind
