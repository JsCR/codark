---
title: Teilen
description: Teile Codark-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Codark-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Codark Folgendes:
...
Codark hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Codark den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`codark.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du codark in deiner Organisation einsetzt.
