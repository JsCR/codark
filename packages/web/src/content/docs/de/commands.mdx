...
Erstellen Sie `.codark/commands/test.md`:

```md title=".codark/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Codark-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Codark [config](/docs/config):

```json title="codark.jsonc" {4-12}
{
...
- Global: `~/.config/codark/commands/`
- Pro Projekt: `.codark/commands/`

```markdown title="~/.config/codark/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".codark/commands/component.md"
---
...
```md title=".codark/commands/create-file.md"
---
...
```md title=".codark/commands/analyze-coverage.md"
---
...
```md title=".codark/commands/review-changes.md"
---
...
```md title=".codark/commands/review-component.md"
---
...
Codark enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
