...
Go funktioniert wie jeder andere Provider in Codark. Du abonnierst OpenCode Go und
...
OpenCode Go funktioniert wie jeder andere Provider in Codark.
...
Die [Modell-ID](/docs/config/#models) in deiner Codark Config verwendet das Format `codark-go/<model-id>`. Für Kimi K3 würdest du beispielsweise `codark-go/kimi-k3` in deiner Config verwenden.
...
4. **Keinen Lock-in-Effekt** zu haben, indem wir dir ermöglichen, auch jeden anderen Provider mit Codark zu nutzen.
