...
description: Crea strumenti che l'LLM puo chiamare in codark.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di codark come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.codark/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/codark/tools/`.
