---
title: Condivisione
description: Condividi le tue conversazioni Codark.
---

La funzione di condivisione di Codark ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Codark:
...
Codark supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Codark usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `codark.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare codark nella tua organizzazione.
