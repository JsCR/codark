...
Codark supporta le variabili d'ambiente standard per i proxy e certificati personalizzati per ambienti di rete enterprise.

---

## Proxy

Codark rispetta le variabili d'ambiente standard dei proxy.
...
Se la tua organizzazione usa CA personalizzate per connessioni HTTPS, configura Codark in modo che si fidi di esse.
