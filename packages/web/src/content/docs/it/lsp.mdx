---
title: Server LSP
description: Codark si integra con i tuoi server LSP.
---

Codark può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Codark include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e codark apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di codark.
