---
title: SDK
description: Client JS type-safe per il server codark.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di codark fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare codark in modo programmatico.
...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `codark.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
...
Se hai gia un'istanza di codark in esecuzione, puoi creare un client per collegarti:
