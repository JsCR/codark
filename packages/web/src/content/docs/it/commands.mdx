...
Puoi aggiungere comandi personalizzati tramite la config di Codark o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Codark:
...
- Globale: `~/.config/codark/commands/`
- Per progetto: `.codark/commands/`
...
codark include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
