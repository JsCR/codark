---
title: Zen
description: Lista curata di modelli fornita da Codark.
---
...
OpenCode Zen è un elenco di modelli testati e verificati forniti dal team di Codark.

Zen funziona come qualsiasi altro provider in Codark. Accedi a OpenCode Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Codark.
:::
...
OpenCode Zen funziona come qualsiasi altro provider in Codark.
...
Il [model id](/docs/config/#models) nella config di Codark
usa il formato `codark/<model-id>`. Per esempio, per GPT 5.5, useresti
`codark/gpt-5.5` nella tua config.
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. Codark usa questi modelli per generare i titoli delle sessioni.
...
- DeepSeek V4 Flash Free è disponibile su Codark per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su Codark per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Laguna S 2.1 Free è disponibile su Codark per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Ling-3.0-flash Free è disponibile su Codark per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su Codark per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su Codark per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Codark per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Codark.
