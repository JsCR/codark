---
title: Formattatori
description: Codark usa formattatori specifici per linguaggio.
---

Codark formatta automaticamente i file dopo che vengono scritti o modificati usando formattatori specifici per linguaggio. Questo assicura che il codice generato segua lo stile del tuo progetto.

---

## Integrati

Codark include diversi formattatori integrati per linguaggi e framework popolari. Qui sotto trovi la lista dei formattatori, delle estensioni supportate e dei comandi o opzioni di config richiesti.
...
Quindi, se il progetto ha `prettier` in `package.json`, Codark lo usera automaticamente.

---

## Come funziona

Quando Codark scrive o modifica un file:
...
Puoi personalizzare i formattatori nella sezione `formatter` della config di Codark.
