...
Codark supports standard proxy environment variables and custom certificates for enterprise network environments.
...
If your enterprise uses custom CAs for HTTPS connections, configure Codark to trust them.
