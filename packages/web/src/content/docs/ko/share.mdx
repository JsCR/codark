---
title: 공유
description: Codark 대화를 공유하세요.
---

opencode의 공유 기능은 codark 대화에 대한 공개 링크를 만들 수 있으므로 Teammates와 협업하거나 다른 곳에서 도움을받을 수 있습니다.
...
주어진 프로젝트를 위해 팀 전반에 걸쳐 이것을 시행하려면 프로젝트에 `codark.json`에 추가하고 Git로 확인하십시오.
