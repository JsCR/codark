...
커스텀 명령은 Codark 설정으로 추가하거나, `commands/` 디렉터리에 Markdown 파일을 만들어 추가할 수 있습니다.

---

### JSON

Codark [config](/docs/config)의 `command` 옵션을 사용합니다.
...
- 전역: `~/.config/codark/commands/`
- 프로젝트별: `.codark/commands/`
...
Codark는 `/init`, `/undo`, `/redo`, `/share`, `/help` 등 여러 내장 명령을 제공합니다. [더 알아보기](/docs/tui#commands).
