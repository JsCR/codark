---
title: Web
description: 브라우저에서 Codark 사용하기.
---

opencode는 브라우저에서 웹 응용 프로그램을 실행할 수 있으며 terminal을 필요로하지 않고 동일한 강력한 AI 코딩 경험을 제공합니다.

![codark Web - 새로운 세션](../../../assets/web/web-homepage-new-session.png)
...
:::tip[Windows 사용자]
최고의 경험을 위해서는 PowerShell보다 `codark web`를 실행하십시오. 적절한 파일 시스템 액세스 및 terminal 통합을 보장합니다.
:::
...
이 자동으로 `0.0.0.0`에 hostname을 설정하고 `codark.local`로 서버를 광고합니다.
...
`codark`에 대한 사용자의 기본값은 `OPENCODE_SERVER_USERNAME`로 변경할 수 있습니다.

---

## 웹 인터페이스 사용

시작되면 웹 인터페이스는 codark 세션에 액세스 할 수 있습니다.
...
![codark Web - Servers 참조](../../../assets/web/web-homepage-see-servers.png)
...
`codark.json` config 파일에서 서버 설정을 구성할 수 있습니다:
