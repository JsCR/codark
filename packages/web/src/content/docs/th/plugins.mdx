---
title: ปลั๊กอิน
description: เขียนปลั๊กอินของคุณเองเพื่อขยาย Codark
---

ปลั๊กอินช่วยให้คุณสามารถขยาย Codark ได้โดยเชื่อมโยงกับเหตุการณ์ต่างๆ และปรับแต่งลักษณะการทำงาน คุณสามารถสร้างปลั๊กอินเพื่อเพิ่มคุณสมบัติใหม่ บูรณาการกับบริการภายนอก หรือแก้ไขการทำงานเริ่มต้นของ Codark
...
- `.codark/plugins/` - ​​ปลั๊กอินระดับโครงการ
- `~/.config/codark/plugins/` - ​​ปลั๊กอินทั่วโลก
...
**ปลั๊กอิน npm** ได้รับการติดตั้งโดยอัตโนมัติโดยใช้ Bun เมื่อเริ่มต้น แพ็คเกจและการขึ้นต่อกันถูกแคชไว้ใน `~/.cache/codark/node_modules/`
...
1. การกำหนดค่าส่วนกลาง (`~/.config/codark/codark.json`)
2. การกำหนดค่าโครงการ (`codark.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/codark/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.codark/plugins/`)
...
Codark รัน `bun install` เมื่อเริ่มต้นเพื่อติดตั้งสิ่งเหล่านี้ ปลั๊กอินและเครื่องมือของคุณสามารถนำเข้าได้
...
- `client`: ไคลเอนต์ codark SDK สำหรับการโต้ตอบกับ AI
...
นี่คือตัวอย่างบางส่วนของปลั๊กอินที่คุณสามารถใช้เพื่อขยาย codark
...
:::note
หากคุณใช้แอปเดสก์ท็อป Codark แอปสามารถส่งการแจ้งเตือนของระบบโดยอัตโนมัติเมื่อมีการตอบกลับพร้อมหรือเมื่อเซสชันเกิดข้อผิดพลาด
:::
...
ป้องกันไม่ให้ codark อ่านไฟล์ `.env`:
...
ปลั๊กอินยังสามารถเพิ่มเครื่องมือที่กำหนดเองให้กับ codark:
...
ตัวช่วย `tool` สร้างเครื่องมือแบบกำหนดเองที่สามารถเรียกใช้ codark ได้ ใช้ฟังก์ชัน Zod schema และส่งกลับคำจำกัดความของเครื่องมือด้วย:
...
เครื่องมือที่คุณกำหนดเองจะพร้อมใช้งานสำหรับ codark ควบคู่ไปกับเครื่องมือในตัว
