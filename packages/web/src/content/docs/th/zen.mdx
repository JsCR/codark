---
title: เซน
description: รายการโมเดลที่คัดสรรโดย Codark
---
...
OpenCode Zen คือรายการโมเดลที่ผ่านการทดสอบและยืนยันแล้วโดยทีม Codark

Zen ทำงานเหมือน provider อื่น ๆ ใน Codark คุณล็อกอินเข้า OpenCode Zen แล้วรับ
...
:::tip
เราได้ทดสอบโมเดลและ provider ที่คัดมาแล้วกลุ่มหนึ่งซึ่งทำงานได้ดีกับ Codark
:::
...
OpenCode Zen ทำงานเหมือน provider อื่น ๆ ใน Codark
...
[model id](/docs/config/#models) ใน Codark config ของคุณใช้รูปแบบ `codark/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.5 คุณจะใช้ `codark/gpt-5.5` ใน config ของคุณ
...
คุณอาจสังเกตเห็น[โมเดลต้นทุนต่ำ](/docs/config/#models) เช่น Haiku, Nano หรือ Flash ในประวัติการใช้งานของคุณ Codark ใช้โมเดลเหล่านี้เพื่อสร้างชื่อเซสชัน
...
- DeepSeek V4 Flash Free เปิดให้ใช้บน Codark ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- MiMo-V2.5 Free เปิดให้ใช้บน Codark ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Laguna S 2.1 Free เปิดให้ใช้บน Codark ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Ling-3.0-flash Free เปิดให้ใช้บน Codark ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- North Mini Code Free เปิดให้ใช้บน Codark ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Nemotron 3 Ultra Free เปิดให้ใช้บน Codark ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
- Big Pickle เป็น stealth model ที่ใช้งานฟรีบน Codark ในช่วงเวลาจำกัด ทีมกำลังใช้ช่วงเวลานี้เพื่อเก็บ feedback และปรับปรุงโมเดล
...
4. ทำให้เกิด **no lock-in** โดยให้คุณใช้มันร่วมกับ coding agent อื่น ๆ ได้ และยังเปิดให้คุณใช้ provider อื่น ๆ กับ Codark ได้เสมอ
