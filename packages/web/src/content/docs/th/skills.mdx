...
ทักษะของเจ้าหน้าที่ช่วยให้ Codark ค้นพบคำแนะนำที่ใช้ซ้ำได้จาก repo หรือโฮมไดเร็กทอรีของคุณ
...
Codark ค้นหาตำแหน่งเหล่านี้:

- การกำหนดค่าโครงการ: `.codark/skills/<name>/SKILL.md`
- การกำหนดค่าส่วนกลาง: `~/.config/codark/skills/<name>/SKILL.md`
...
สำหรับเส้นทางภายในโปรเจ็กต์ Codark จะเดินขึ้นมาจากไดเร็กทอรีการทำงานปัจจุบันของคุณจนกว่าจะถึงแผนผังงาน git
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.codark/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง

คำจำกัดความสากลยังโหลดจาก `~/.config/codark/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` และ `~/.agents/skills/*/SKILL.md`
...
สร้าง `.codark/skills/git-release/SKILL.md` แบบนี้:
...
Codark แสดงรายการทักษะที่มีอยู่ในคำอธิบายเครื่องมือ `skill`
...
ควบคุมว่าตัวแทนทักษะใดสามารถเข้าถึงโดยใช้สิทธิ์ตามรูปแบบใน `codark.json`:
...
**สำหรับตัวแทนในตัว** (ใน `codark.json`):
