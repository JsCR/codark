...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Codark:
...
- ระดับผู้ใช้ (Global): `~/.config/codark/commands/`
- ระดับโปรเจ็กต์: `.codark/commands/`
...
Codark มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
