...
Codark มีรายการปุ่มลัดที่คุณปรับแต่งได้ผ่าน `tui.json`
...
Codark ใช้ปุ่ม `leader` สำหรับการเชื่อมโยงคีย์ส่วนใหญ่ วิธีนี้จะหลีกเลี่ยงความขัดแย้งใน terminal ของคุณ
...
การป้อนข้อมูลพร้อมท์ของแอป Codark บนเดสก์ท็อปรองรับทางลัด Readline/Emacs-style ทั่วไปสำหรับการแก้ไขข้อความ สิ่งเหล่านี้มีอยู่แล้วภายในและปัจจุบันไม่สามารถกำหนดค่าผ่าน `codark.json` ได้
