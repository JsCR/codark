---
title: การรองรับ ACP
description: ใช้ Codark ในโปรแกรมแก้ไขที่รองรับ ACP
---

Codark รองรับ [Agent Client Protocol](https://agentclientprotocol.com) (ACP) ซึ่งช่วยให้สามารถทำงานร่วมกับ editor และ IDE ต่างๆ ได้โดยตรง
...
ในการใช้ Codark ผ่าน ACP ให้กำหนดค่าโปรแกรมแก้ไขของคุณให้รันคำสั่ง `codark acp`

คำสั่งนี้จะเริ่ม Codark เป็น process ย่อยที่รองรับ ACP ซึ่งสื่อสารกับโปรแกรมแก้ไขของคุณผ่าน JSON-RPC ทาง stdio
...
นี่เป็นการเปิดให้ตัวแทน 'Codark' ในเนื้อหาของตัวแทน AI Chat
...
ลองใช้ Codark ACP ใน [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ให้เพิ่มสิ่งต่อไปนี้ใน Neovim ของคุณ:
...
คุณสามารถใช้ CodeCompanion เพื่อใช้ codark เป็น ACP agent สำหรับแชท
...
codark ทำงานผ่าน ACP เหมือนกับใน terminal และรองรับฟีเจอร์ทั้งหมด:
...
- MCP แขกที่นี่คือข้อมูลเพิ่มเติมของ Codark ของคุณ
