...
description: Codark ทำงานร่วมกับเซิร์ฟเวอร์ LSP ของคุณ
---

Codark สามารถทำงานร่วมกับเซิร์ฟเวอร์ Language Server Protocol (LSP) เพื่อใช้ diagnostics เป็น feedback สำหรับ agent

---

## บิวท์อิน

Codark มาพร้อมกับเซิร์ฟเวอร์ LSP ในตัวหลายตัวสำหรับภาษายอดนิยม:
...
เมื่อเปิดใช้งาน LSP และ codark เปิดไฟล์ มันจะ:
...
คุณสามารถเปิดใช้งานและปรับแต่งเซิร์ฟเวอร์ LSP ผ่านส่วน `lsp` ในการกำหนดค่า codark
