...
ด้วย Codark คุณสามารถเลือกจากหนึ่งในธีมที่มีอยู่แล้วภายใน ใช้ธีมที่ปรับให้เข้ากับธีม terminal ของคุณ หรือกำหนดธีมที่คุณกำหนดเองได้

ตามค่าเริ่มต้น Codark จะใช้ธีม `codark` ของเราเอง
...
Codark มาพร้อมกับธีมในตัวหลายธีม
...
- ต้องการให้ Codark ตรงกับรูปลักษณ์ของ terminal
...
Codark รองรับระบบธีมที่ใช้ JSON ที่ยืดหยุ่น ซึ่งช่วยให้ผู้ใช้สามารถสร้างและปรับแต่งธีมได้อย่างง่ายดาย
...
2. **ไดเรกทอรีกำหนดค่าผู้ใช้** - กำหนดใน `~/.config/codark/themes/*.json` หรือ `$XDG_CONFIG_HOME/codark/themes/*.json`
3. **ไดเรกทอรีรากของโครงการ** - กำหนดไว้ใน `<project-root>/.codark/themes/*.json`
4. **ไดเร็กทอรีการทำงานปัจจุบัน** - กำหนดใน `./.codark/themes/*.json`
