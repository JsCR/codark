---
title: TUI
description: การใช้อินเทอร์เฟซผู้ใช้ terminal Codark
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Codark มีอินเทอร์เฟซ terminal แบบโต้ตอบหรือ TUI สำหรับการทำงานในโครงการของคุณด้วย LLM

การรัน Codark จะเริ่มต้น TUI สำหรับไดเร็กทอรีปัจจุบัน
...
เมื่อใช้ Codark TUI คุณสามารถพิมพ์ `/` ตามด้วยชื่อคำสั่งเพื่อดำเนินการอย่างรวดเร็ว ตัวอย่างเช่น:
...
เพิ่มผู้ให้บริการให้กับ Codark ให้คุณเลือกจากผู้ให้บริการที่มีอยู่และเพิ่มคีย์ API
...
สิ่งนี้แยกจาก `codark.json` ซึ่งกำหนดค่าพฤติกรรมเซิร์ฟเวอร์/รันไทม์
...
- `leader_timeout` - ควบคุมระยะเวลาที่ Codark จะรอหลังจากกด leader key ค่าเริ่มต้นคือ `2000`
...
- `sound_pack` - sound pack ID ที่จะใช้ ค่าเริ่มต้นคือ `codark.default`
