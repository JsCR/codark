---
title: LSP Servers
description: Codark integrates with your LSP servers.
---

Codark can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Codark comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and codark opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your codark config.
