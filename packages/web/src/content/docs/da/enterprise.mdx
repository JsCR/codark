---
title: Enterprise
description: Brug af Codark sikkert i din organisation.
---
...
:::note
Codark gemmer ingen af ​​din kode eller kontekstdata.
:::
...
Codark er open source og gemmer ingen af ​​din kode eller kontekstdata, så dine udviklere kan simpelthen [get started](/docs/) og udføre en prøveversion.

---

### Datahåndtering

**Codark gemmer ikke din kode eller kontekstdata.** Al behandling sker lokalt eller gennem direkte API-opkald til din AI-udbyder.

Det betyder, at så længe du bruger en udbyder, du stoler på, eller en intern
AI-gateway, du kan bruge Codark sikkert.
...
**Du ejer al kode produceret af Codark.** Der er ingen licensbegrænsninger eller ejerskabskrav.
...
Når du har afsluttet din prøveperiode, og du er klar til at bruge Codark kl
...
Vi kan konfigurere Codark til at bruge en enkelt central konfiguration for hele din organisation.
...
Gennem den centrale konfiguration kan Codark integreres med din organisationer SSO-udbyder til godkendelse.

Denne giver Codark mulighed for at få legitimationsoplysninger til din interne AI-gateway gennem dette eksisterende identitetsadministrationssystem.

---

### Intern AI-gateway

Med den centrale konfiguration kan Codark også konfigureres til kun at bruge din interne AI-gateway.
...
Du skal blot starte med en intern prøveperiode med dit team. Codark gemmer som standard ikke din kode eller kontekstdata, hvilket gør det nemt at komme i gang.
...
Ja. Codark gemmer ikke din kode eller kontekstdata. Al behandling sker lokalt eller gennem direkte API-opkald til din AI-udbyder. Med central konfiguration og SSO-integration forbliver dine data sikre i din organisationers infrastruktur.
...
Codark understøtter private npm registre gennem Buns oprindelige `.npmrc` filunderstøttelse. Hvis din organisation bruger et privat register, såsom JFrog Artifactory, Nexus eller lignende, skal du sikre dig, at udviklerne er godkendt, før de kører Codark.
...
Dette opretter `~/.npmrc` med godkendelsesdetaljer. Codark vil automatisk
samle dette op.

:::caution
Du skal være logget ind i det private register, før du kører Codark.
:::
...
Udviklere skal være logget ind på det private register, før de kører Codark for at sikre, at pakker kan installeres fra din virksomhedsregistrering.
