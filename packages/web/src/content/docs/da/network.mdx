...
Codark understøtter standard proxymiljøvariabler og brugerdefinerede certifikater til virksomhedsnetværksmiljøer.

---

## Proxy

Codark respekterer standard proxy-miljøvariabler.
...
Hvis din virksomhed bruger tilpassede CA'er til HTTPS-forbindelser, skal du konfigurere Codark til at stole på dem.
