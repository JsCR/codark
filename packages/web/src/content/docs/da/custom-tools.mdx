...
description: Opret værktøjer, som LLM kan kalde codark ind.
---
...
- Lokalt ved at placere dem i biblioteket `.codark/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/codark/tools/`.
