...
Codark har en liste over nøglebindinger, som du kan tilpasse gennem `tui.json`.
...
Codark bruger en `leader` nøgle til de fleste smagsbindinger. Dette undgår konflikter i din terminal.
...
Codark desktop app prompt input understøtter almindelige Readline/Emacs-style genveje til redigering af tekst. Disse er indbyggede og i øjeblikket ikke konfigurerede via `codark.json`.
