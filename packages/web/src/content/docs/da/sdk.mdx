...
Brug den til at bygge integrasjoner og kontrollere codark programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `codark.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av codark, kan du oprete en klientforekomst for at koble til den:
