...
Her er alle de innebygde verktøyene som er tilgængelige i Codark.
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Codark-leverandøren eller når miljøvariabelen `OPENCODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
