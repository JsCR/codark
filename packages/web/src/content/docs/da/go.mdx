...
Go fungerer som enhver anden udbyder i Codark. Du abonnerer på OpenCode Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Codark.
:::
...
OpenCode Go fungerer som enhver anden udbyder i Codark.
...
Dit [model id](/docs/config/#models) i din Codark config
bruger formatet `codark-go/<model-id>`. For eksempel for Kimi K3, vil du
bruge `codark-go/kimi-k3` i din config.
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med Codark.
