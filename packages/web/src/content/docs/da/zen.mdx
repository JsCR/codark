---
title: Zen
description: Udvalgt liste over modeller leveret af Codark.
---
...
OpenCode Zen er en liste over testede og verificerede modeller leveret af Codark-teamet.

Zen fungerer som enhver anden udbyder i Codark. Du logger ind på OpenCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Codark.
:::
...
OpenCode Zen fungerer som enhver anden udbyder i Codark.
...
[model id](/docs/config/#models) i din Codark-konfiguration
bruger formatet `codark/<model-id>`. For eksempel ville du for GPT 5.5
bruge `codark/gpt-5.5` i din konfiguration.
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. Codark bruger disse modeller til at generere sessionstitler.
...
- DeepSeek V4 Flash Free er tilgængelig på Codark i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på Codark i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Laguna S 2.1 Free er tilgængelig på Codark i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ling-3.0-flash Free er tilgængelig på Codark i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på Codark i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på Codark i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Codark i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Codark også.
