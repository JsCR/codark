---
title: LSP-servere
description: Codark integreres med dine LSP-servere.
---

Codark kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Codark leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og codark åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din codark-konfiguration.
