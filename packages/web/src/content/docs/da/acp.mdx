...
description: Brug Codark i enhver ACP-kompatibel editor.
---

Codark understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge Codark via ACP, konfigurer din editor til at køre kommandoen `codark acp`.

Kommandoen starter Codark som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'Codark'-agent i AI Chat-agentvælgeren.
...
For at bruge Codark som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge Codark som ACP-agent til chat.
...
Codark fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din Codark-konfiguration
