---
title: TUI
description: Usando a interface de usuário de terminal codark.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O codark fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar codark inicia o TUI para o diretório atual.
...
Ao usar o TUI do codark, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao codark. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do codark. _Aliases_: `/quit`, `/q`
...
Isso é separado do `codark.json`, que configura o comportamento do servidor/runtime.
...
- `leader_timeout` - Controla por quanto tempo o Codark espera depois da leader key. O padrão é `2000`.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `codark.default`.
