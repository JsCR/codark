---
title: SDK
description: Cliente JS seguro em tipos para o servidor codark.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do codark fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o codark programaticamente.
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `codark.json`, mas você pode substituir ou adicionar configuração inline:
...
Se você já tem uma instância do codark em execução, pode criar uma instância de cliente para se conectar a ela:
