...
O codark suporta variáveis de ambiente de proxy padrão e certificados personalizados para ambientes de rede corporativa.

---

## Proxy

O codark respeita variáveis de ambiente de proxy padrão.
...
Se sua empresa usa CAs personalizadas para conexões HTTPS, configure o codark para confiá-las.
