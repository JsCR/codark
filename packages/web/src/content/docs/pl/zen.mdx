---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Codark.
---
...
OpenCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Codark.

Zen działa jak każdy inny dostawca w Codark. Logujesz się do OpenCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Codark.
:::
...
OpenCode Zen działa jak każdy inny dostawca w Codark.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Codark używa formatu
`codark/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`codark/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. Codark używa tych modeli do generowania tytułów sesji.
...
- DeepSeek V4 Flash Free jest dostępny w Codark przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w Codark przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Laguna S 2.1 Free jest dostępny w Codark przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling-3.0-flash Free jest dostępny w Codark przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w Codark przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Codark przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Codark przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Codark także dowolnego innego dostawcy.
