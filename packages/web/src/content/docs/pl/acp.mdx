---
title: ACP
description: Używanie Codark z protokołem Agent Client Protocol (ACP).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Codark obsługuje [Agent Client Protocol](https://agentclientprotocol.com) (ACP), który umożliwia korzystanie z Codark bezpośrednio w edytorach i środowiskach IDE.
...
Aby używać Codark przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `codark acp`.

Uruchamia to Codark jako podproces zgodny z ACP, który komunikuje się z edytorem za pomocą JSON-RPC przez stdio.
...
Następnie wybierz „Codark” w selektorze agentów AI Chat.
...
Aby używać Codark jako agenta ACP w [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodaj następującą konfigurację do Neovim:
...
Ta konfiguracja sprawia, że CodeCompanion używa Codark jako agenta ACP do czatu.
...
Codark działa przez ACP tak samo, jak w terminalu. Obsługiwane są wszystkie główne funkcje:
...
- Serwery MCP zdefiniowane w konfiguracji Codark
