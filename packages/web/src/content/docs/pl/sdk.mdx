---
title: SDK
description: Typowany klient JS dla serwera Codark.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS Codark zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli Codark.
...
Można przekazać obiekt konfiguracyjny, aby dostosować zachowanie. Instancja nadal pobiera `codark.json`, ale możesz zastąpić lub dodać konfigurację bezpośrednio:
...
Jeśli masz już działającą instancję Codark, możesz utworzyć instancję klienta, aby się z nią połączyć:
