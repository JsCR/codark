---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala codark.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

codark zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie codark uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI codark, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do codark. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij codark. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `codark.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Codark czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `codark.default`.
