---
title: Serwery LSP
description: Codark integruje się z serwerami LSP.
---

Codark może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

Codark posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i Codark otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji Codark.
