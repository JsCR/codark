...
Utwórz `.codark/commands/test.md`:
...
Możesz zdefiniować polecenia w `codark.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji codark:
...
- Globalnie: `~/.config/codark/commands/`
- Na projekt: `.codark/commands/`
...
codark zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
