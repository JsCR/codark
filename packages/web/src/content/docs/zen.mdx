---
title: Zen
description: Curated list of models provided by Codark.
---
...
OpenCode Zen is a list of tested and verified models provided by the Codark team.

Zen works like any other provider in Codark. You login to OpenCode Zen and get
...
:::tip
We tested a select group of models and providers that work well with Codark.
:::
...
OpenCode Zen works like any other provider in Codark.
...
The [model id](/docs/config/#models) in your Codark config
uses the format `codark/<model-id>`. For example, for GPT 5.5, you would
use `codark/gpt-5.5` in your config.
...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. Codark uses these models to generate session titles.
...
- DeepSeek V4 Flash Free is available on Codark for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on Codark for a limited time. The team is using this time to collect feedback and improve the model.
- Laguna S 2.1 Free is available on Codark for a limited time. The team is using this time to collect feedback and improve the model.
- Ling-3.0-flash Free is available on Codark for a limited time. The team is using this time to collect feedback and improve the model.
- North Mini Code Free is available on Codark for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on Codark for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Codark for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Codark as well.
