---
title: SDK
description: Type-safe JS client for codark server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The codark JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control codark programmatically.
...
You can pass a configuration object to customize behavior. The instance still picks up your `codark.json`, but you can override or add configuration inline:
...
If you already have a running instance of codark, you can create a client instance to connect to it:
