...
يوفّر Codark قائمة باختصارات لوحة المفاتيح يمكنك تخصيصها عبر إعدادات Codark.
...
يستخدم Codark مفتاح `leader` لمعظم اختصارات لوحة المفاتيح. يساعد ذلك على تجنّب التعارضات في terminal لديك.
...
يدعم حقل إدخال الموجّه في تطبيق Codark لسطح المكتب اختصارات شائعة لتحرير النص على نمط Readline/Emacs. هذه الاختصارات مدمجة حاليا ولا يمكن تخصيصها عبر `codark.json`.
