---
title: خوادم LSP
description: يتكامل Codark مع خوادم LSP لديك.
---

يمكن أن يتكامل Codark مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Codark مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح codark لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات codark.
