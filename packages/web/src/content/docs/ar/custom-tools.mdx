...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في codark.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في codark مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.codark/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/codark/tools/`.
