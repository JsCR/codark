...
يعمل Go مثل أي مزود آخر في Codark. تشترك في OpenCode Go وتحصل على مفتاح API الخاص بك. وهو **اختياري تمامًا**، ولا تحتاج إلى استخدامه لاستخدام Codark.
...
:::tip
اختبرنا مجموعة مختارة من النماذج والمزودين الذين يعملون جيدًا مع Codark.
:::
...
يعمل OpenCode Go مثل أي مزود آخر في Codark.
...
يستخدم [model id](/docs/config/#models) في إعدادات Codark لديك التنسيق `codark-go/<model-id>`. على سبيل المثال، بالنسبة إلى Kimi K3، ستستخدم `codark-go/kimi-k3` في إعداداتك.
...
4. **عدم فرض قيود ارتباط** من خلال السماح لك أيضًا باستخدام أي مزود آخر مع Codark.
