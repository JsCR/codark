---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها Codark.
---
...
OpenCode Zen هي قائمة بالنماذج التي اختبرها فريق Codark وتحقّق منها.

يعمل Zen مثل أي مزوّد آخر في Codark. تسجّل الدخول إلى OpenCode Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام Codark.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع Codark.
:::
...
يعمل OpenCode Zen مثل أي مزوّد آخر في Codark.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات Codark الصيغة `codark/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.5، ستستخدم `codark/gpt-5.5` في إعداداتك.
...
قد تلاحظ [نماذج منخفضة التكلفة](/docs/config/#models)، مثل Haiku أو Nano أو Flash، في سجل الاستخدام. يستخدم Codark هذه النماذج لإنشاء عناوين الجلسات.
...
- DeepSeek V4 Flash Free متاح على Codark لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- MiMo-V2.5 Free متاح على Codark لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Laguna S 2.1 Free متاح على Codark لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Ling-3.0-flash Free متاح على Codark لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- North Mini Code Free متاح على Codark لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Nemotron 3 Ultra Free متاح على Codark لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على Codark لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. **عدم فرض أي ارتباط حصري** عبر تمكينك من استخدامه مع أي عامل برمجة آخر. ومع إبقاء إمكانية استخدام أي مزوّد آخر مع Codark أيضا دائما.
