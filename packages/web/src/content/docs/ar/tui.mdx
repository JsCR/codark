---
title: TUI
description: استخدام واجهة المستخدم TUI في Codark.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Codark واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Codark إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Codark في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Codark. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Codark. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `codark.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Codark بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `codark.default`.
