---
title: المُنسِّقات
description: يستخدم Codark مُنسِّقات خاصة بكل لغة.
---

يُنسِّق Codark الملفات تلقائيا بعد كتابتها أو تعديلها باستخدام مُنسِّقات خاصة بكل لغة. يضمن ذلك أن الشيفرة التي يتم توليدها تتبع أساليب التنسيق المعتمدة في مشروعك.

---

## مُضمَّنة

يأتي Codark مع عدة مُنسِّقات مُضمَّنة للغات وأطر العمل الشائعة. فيما يلي قائمة بالمُنسِّقات وامتدادات الملفات المدعومة والأوامر أو خيارات الإعداد التي تحتاجها.
...
لذا إذا كان مشروعك يتضمن `prettier` ضمن `package.json`، فسيستخدمه Codark تلقائيا.

---

## كيف يعمل

عندما يكتب Codark ملفا أو يحرره، فإنه:
...
يمكنك تخصيص المُنسِّقات عبر قسم `formatter` في إعدادات Codark.
