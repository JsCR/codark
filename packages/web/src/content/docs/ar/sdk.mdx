...
description: عميل JavaScript آمن الأنواع لخادم codark.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

توفر SDK الخاصة بـ codark لـ JS/TS عميلا آمنا للأنواع للتفاعل مع الخادم.
استخدمها لبناء التكاملات والتحكم في codark برمجيا.
...
يمكنك تمرير كائن إعدادات لتخصيص السلوك. سيستمر المثيل في التقاط `codark.json` لديك، لكن يمكنك تجاوز الإعدادات أو إضافة إعدادات مباشرة:
...
إذا كان لديك مثيل codark يعمل بالفعل، يمكنك إنشاء مثيل عميل للاتصال به:
