---
title: Enterprise
description: Using Codark securely in your organization.
---
...
:::note
Codark does not store any of your code or context data.
:::
...
Codark is open source and does not store any of your code or context data, so your developers can simply [get started](/docs/) and carry out a trial.

---

### Data handling

**Codark does not store your code or context data.** All processing happens locally or through direct API calls to your AI provider.

This means that as long as you are using a provider you trust, or an internal
AI gateway, you can use Codark securely.
...
**You own all code produced by Codark.** There are no licensing restrictions or ownership claims.
...
Once you have completed your trial and you are ready to use Codark at
...
We can set up Codark to use a single central config for your entire organization.
...
Through the central config, Codark can integrate with your organization's SSO provider for authentication.

This allows Codark to obtain credentials for your internal AI gateway through your existing identity management system.

---

### Internal AI gateway

With the central config, Codark can also be configured to use only your internal AI gateway.
...
Simply start with an internal trial with your team. Codark by default does not store your code or context data, making it easy to get started.
...
Yes. Codark does not store your code or context data. All processing happens locally or through direct API calls to your AI provider. With central config and SSO integration, your data remains secure within your organization's infrastructure.
...
Codark supports private npm registries through Bun's native `.npmrc` file support. If your organization uses a private registry, such as JFrog Artifactory, Nexus, or similar, ensure developers are authenticated before running Codark.
...
This creates `~/.npmrc` with authentication details. Codark will automatically
pick this up.

:::caution
You must be logged into the private registry before running Codark.
:::
...
Developers must be logged into the private registry before running Codark to ensure packages can be installed from your enterprise registry.
