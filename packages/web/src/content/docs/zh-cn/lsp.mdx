---
title: LSP 服务器
description: Codark 与你的 LSP 服务器集成。
---

Codark 可以与语言服务器协议（LSP）服务器集成，将诊断信息作为 agent 的反馈。

---

## 内置支持

Codark 内置了多种适用于主流语言的 LSP 服务器：
...
你可以通过 codark 配置文件中的 `lsp` 部分来启用并自定义 LSP 服务器。
