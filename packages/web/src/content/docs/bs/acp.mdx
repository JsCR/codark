---
title: ACP podrška
description: Koristite Codark u bilo kojem uređivaču kompatibilnom sa ACP.
---

Codark podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili Codark putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `codark acp`.

Naredba pokreće Codark kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "Codark" agenta u AI Chat agent selektoru.
...
Da koristite Codark kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi Codark kao ACP chat agenta.
...
Codark radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj Codark konfiguraciji
