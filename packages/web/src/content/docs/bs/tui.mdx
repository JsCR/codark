---
title: TUI
description: Korištenje korisničkog interfejsa Codark terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Codark pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Codark pokreće TUI za trenutni direktorij.
...
Kada koristite Codark TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Codark. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Codark. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `codark.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Codark čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `codark.default`.
