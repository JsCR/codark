...
Kreiraj `.codark/commands/test.md`:
...
Možete dodati prilagođene komande kroz Codark konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Codark [config](/docs/config):
...
- Globalno: `~/.config/codark/commands/`
- Po projektu: `.codark/commands/`
...
Codark uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
