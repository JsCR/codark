---
title: Zen
description: Kurirana lista modela koje nudi Codark.
---
...
OpenCode Zen je lista testiranih i provjerenih modela koje pruža Codark tim.

Zen radi kao i svaki drugi provajder u Codark. Prijavite se na OpenCode Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili Codark.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s Codark.
:::
...
OpenCode Zen radi kao i svaki drugi provajder u Codark.
...
[model id](/docs/config/#models) u vašoj Codark konfiguraciji koristi format
`codark/<model-id>`. Na primjer, za GPT 5.5 u konfiguraciji biste
koristili `codark/gpt-5.5`.
...
U historiji korištenja možete primijetiti [jeftinije modele](/docs/config/#models), kao što su Haiku, Nano ili Flash. Codark koristi ove modele za generisanje naslova sesija.
...
- DeepSeek V4 Flash Free je dostupan na Codark ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na Codark ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Laguna S 2.1 Free je dostupan na Codark ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Ling-3.0-flash Free je dostupan na Codark ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- North Mini Code Free je dostupan na Codark ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na Codark ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na Codark ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u Codark.
