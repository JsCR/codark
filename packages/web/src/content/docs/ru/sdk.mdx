---
title: SDK
description: Типобезопасный JS-клиент для сервера codark.
---
...
Вы можете передать объект конфигурации для настройки поведения. Экземпляр по-прежнему получает ваш `codark.json`, но вы можете переопределить или добавить встроенную конфигурацию:
...
Если у вас уже есть работающий экземпляр codark, вы можете создать экземпляр клиента для подключения к нему:
