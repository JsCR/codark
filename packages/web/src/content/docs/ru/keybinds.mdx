...
codark имеет список сочетаний клавиш, которые вы можете настроить через `tui.json`.
...
codark использует клавишу `leader` для большинства сочетаний клавиш. Это позволяет избежать конфликтов в вашем терминале.
...
Ввод приглашения настольного приложения codark поддерживает распространенные сочетания клавиш в стиле Readline/Emacs для редактирования текста. Они встроены и в настоящее время не настраиваются через `codark.json`.
