---
title: Zen
description: Liste organisée de modèles fournis par Codark.
---
...
OpenCode Zen est une liste de modèles testés et vérifiés fournie par l'équipe Codark.

Zen fonctionne comme n'importe quel autre fournisseur dans Codark. Vous vous connectez à OpenCode Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Codark.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec Codark.
:::
...
OpenCode Zen fonctionne comme n'importe quel autre fournisseur dans Codark.
...
Le [model id](/docs/config/#models) dans votre configuration Codark utilise le format `codark/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `codark/gpt-5.5` dans votre configuration.
...
Vous remarquerez peut-être des [modèles à faible coût](/docs/config/#models), tels que Haiku, Nano ou Flash, dans votre historique d'utilisation. Codark utilise ces modèles pour générer les titres des sessions.
...
- DeepSeek V4 Flash Free est disponible sur Codark pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo-V2.5 Free est disponible sur Codark pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Laguna S 2.1 Free est disponible sur Codark pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Ling-3.0-flash Free est disponible sur Codark pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- North Mini Code Free est disponible sur Codark pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Ultra Free est disponible sur Codark pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur Codark pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec Codark également.
