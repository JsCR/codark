...
description: Créez des outils que le LLM peut appeler dans codark.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de codark comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.codark/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/codark/tools/`.
