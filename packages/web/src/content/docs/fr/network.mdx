...
Codark prend en charge les variables d'environnement proxy standard et les certificats personnalisés pour les environnements réseau d'entreprise.

---

## Proxy

Codark respecte les variables d'environnement proxy standard.
...
Si votre entreprise utilise des autorités de certification personnalisées pour les connexions HTTPS, configurez Codark pour leur faire confiance.
