...
`.codark/commands/test.md` oluştur:
...
codark işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

codark [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/codark/commands/`
- Proje başına: `.codark/commands/`
...
codark, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
