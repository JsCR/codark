...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @codark-ai/sdk aracılığıyla OpenCode kullanmak için Vercel AI SDK sağlayıcısı |
