...
codark, kurumsal ağ ortamları için standart proxy ortam değişkenlerini ve özel sertifikaları destekler.

---

## Vekil Sunucu

codark respects standard proxy environment variables.
...
Kuruluşunuz HTTPS bağlantıları için özel CA'lar kullanıyorsa, codark'u bunlara güvenecek şekilde yapılandırın.
