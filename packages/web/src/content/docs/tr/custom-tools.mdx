---
title: Özel Araçlar
description: LLM'un codark'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. codark'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.codark/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/codark/tools/` içine yerleştirerek.
