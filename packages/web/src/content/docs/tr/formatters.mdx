...
description: codark dile özgü biçimlendiriciler kullanır.
---

codark, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

codark, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, codark bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

codark bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri codark yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
