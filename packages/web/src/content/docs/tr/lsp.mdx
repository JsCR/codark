...
description: Codark, LSP sunucularınızla bütünleşir.
---

Codark, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

Codark, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP etkinleştirildiğinde ve codark bir dosyayı açtığında:
...
LSP sunucularını, codark yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
