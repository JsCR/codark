---
title: Zen
description: codark tarafından sağlanan seçilmiş modeller listesi.
---
...
OpenCode Zen, Codark ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Codark'daki diğer sağlayıcılar gibi çalışır. OpenCode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Codark kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Codark ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
OpenCode Zen, Codark'daki diğer sağlayıcılar gibi çalışır.
...
Codark yapılandırmanızdaki [model id](/docs/config/#models) `codark/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `codark/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. Codark, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Codark'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Codark'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Laguna S 2.1 Free, sınırlı bir süre için Codark'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Ling-3.0-flash Free, sınırlı bir süre için Codark'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Codark'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Codark'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Codark'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Codark ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
