---
title: LSPサーバー
description: Codark は LSP サーバーと統合します。
---

Codark は Language Server Protocol (LSP) サーバーと統合し、診断を agent へのフィードバックとして使用できます。

---

## 組み込み

Codark には、一般的な言語用のいくつかの組み込み LSP サーバーが付属しています。
...
LSP が有効で Codark がファイルを開くと、次のようになります。
...
Codark 設定の `lsp` セクションを通じて LSP サーバーを有効化し、カスタマイズできます。
