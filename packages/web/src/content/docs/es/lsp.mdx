...
description: Codark se integra con sus servidores LSP.
---

Codark puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

Codark viene con varios servidores LSP integrados para idiomas populares:
...
Cuando LSP está habilitado y codark abre un archivo:
...
Puede habilitar y personalizar los servidores LSP a través de la sección `lsp` en su configuración codark.
