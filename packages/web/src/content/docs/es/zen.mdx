---
title: Zen
description: Lista seleccionada de modelos proporcionada por Codark.
---
...
OpenCode Zen es una lista de modelos probados y verificados proporcionada por el equipo de Codark.

Zen funciona como cualquier otro proveedor en Codark. Inicias sesión en OpenCode Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Codark.
:::
...
OpenCode Zen funciona como cualquier otro proveedor en Codark.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Codark
usa el formato `codark/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`codark/gpt-5.5` en tu configuración.
...
Puede que notes [modelos de bajo costo](/docs/config/#models), como Haiku, Nano o Flash, en tu historial de uso. Codark usa estos modelos para generar títulos de sesiones.
...
- DeepSeek V4 Flash Free está disponible en Codark por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en Codark por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Laguna S 2.1 Free está disponible en Codark por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Ling-3.0-flash Free está disponible en Codark por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- North Mini Code Free está disponible en Codark por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en Codark por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Codark por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Codark.
