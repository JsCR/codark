...
Puede agregar comandos personalizados a través de la configuración Codark o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Codark [config](/docs/config):
...
codark incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
