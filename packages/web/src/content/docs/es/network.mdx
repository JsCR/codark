...
Codark admite variables de entorno de proxy estándar y certificados personalizados para entornos de red empresarial.

---

## Proxy

Codark respeta las variables de entorno de proxy estándar.
...
Si su empresa utiliza CA personalizadas para conexiones HTTPS, configure Codark para confiar en ellas.
