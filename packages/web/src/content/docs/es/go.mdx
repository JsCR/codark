...
Go funciona como cualquier otro proveedor en Codark. Te suscribes a OpenCode Go y
...
OpenCode Go funciona como cualquier otro proveedor en Codark.
...
El [ID del modelo](/docs/config/#models) en tu configuración de Codark
usa el formato `codark-go/<model-id>`. Por ejemplo, para Kimi K3, usarías
`codark-go/kimi-k3` en tu configuración.
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con Codark.
