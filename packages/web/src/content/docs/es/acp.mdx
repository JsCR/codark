---
title: Soporte ACP
description: Utilice Codark en cualquier editor compatible con ACP.
---

Codark admite el [Agent Client Protocol](https://agentclientprotocol.com) o (ACP), lo que le permite usarlo directamente en editores e IDE compatibles.
...
Para usar Codark a través de ACP, configure su editor para ejecutar el comando `codark acp`.

El comando inicia Codark como un subproceso compatible con ACP que se comunica con su editor a través de JSON-RPC a través de stdio.
...
Para abrirlo, use el nuevo agente 'Codark' en el selector de agentes de AI Chat.
...
Para usar Codark como agente ACP en [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), agregue lo siguiente a su configuración de Neovim:
...
Esta configuración configura CodeCompanion para usar Codark como agente ACP para el chat.
...
Codark funciona igual a través de ACP que en la terminal. Todas las funciones son compatibles:
...
- Servidores MCP configurados en su configuración Codark
