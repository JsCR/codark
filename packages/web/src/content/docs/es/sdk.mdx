---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor codark.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK codark JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar codark mediante programación.
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `codark.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de codark, puede crear una instancia de cliente para conectarse a ella:
