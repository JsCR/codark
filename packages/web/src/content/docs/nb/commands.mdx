...
Opprett `.codark/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Codark-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Codark [config](/docs/config):
...
Codark inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
