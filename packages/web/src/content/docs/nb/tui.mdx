---
title: TUI
description: Bruke codark-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Codark gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Codark starter TUI for gjeldende katalog.
...
Når du bruker Codark TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Codark. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Codark. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `codark.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Codark venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `codark.default`.
