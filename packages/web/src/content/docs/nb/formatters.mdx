---
title: Formattere
description: Codark bruker språkspesifikke formattere.
---

Codark formaterer automatisk filer etter at de er skrevet eller redigert ved hjelp av språkspesifikke formattere. Dette sikrer at koden som genereres følger kodestilene til prosjektet ditt.

---

## Innebygde formattere

Codark kommer med flere innebygde formattere for populære språk og rammeverk. Nedenfor er en liste over formattere, støttede filendelser og kommandoer eller konfigurasjonsalternativer den krever.
...
Så hvis prosjektet ditt har `prettier` i `package.json`, vil Codark automatisk bruke det.

---

## Slik fungerer det

Når Codark skriver eller redigerer en fil, gjør den:
...
Du kan tilpasse formattere gjennom `formatter`-delen i Codark-konfigurasjonen.
