---
title: LSP-servere
description: codark integreres med LSP-serverne dine.
---

Codark kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Codark kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og codark åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Codark-konfigurasjonen.
