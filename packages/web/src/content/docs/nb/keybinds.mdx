...
Codark har en liste over tastebindinger som du kan tilpasse gjennom `tui.json`.
...
Codark bruker en `leader`-tast for de fleste tastebindinger. Dette unngår konflikter i terminalen din.
...
Prompt-feltet for Codark-skrivebordsappen støtter vanlige snarveier i Readline/Emacs-stil for redigering av tekst. Disse er innebygd og foreløpig ikke konfigurerbare via `codark.json`.
