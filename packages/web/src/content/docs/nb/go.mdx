...
Go fungerer som enhver annen leverandør i Codark. Du abonnerer på OpenCode Go og
...
OpenCode Go fungerer som enhver annen leverandør i Codark.
...
[Modell-ID-en](/docs/config/#models) i din Codark-konfigurasjon
bruker formatet `codark-go/<model-id>`. For eksempel, for Kimi K3, vil du
bruke `codark-go/kimi-k3` i konfigurasjonen din.
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Codark også.
