...
Codark støtter standard proxy-miljøvariabler og tilpassede sertifikater for bedriftsnettverksmiljøer.
...
Hvis bedriften din bruker egendefinerte CA-er for HTTPS-tilkoblinger, konfigurer Codark til å stole på dem.
