---
title: Zen
description: Utvalgt liste over modeller levert av Codark.
---
...
OpenCode Zen er en liste over testede og verifiserte modeller levert av Codark-teamet.

Zen fungerer som enhver annen leverandør i Codark. Du logger inn på OpenCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Codark.
:::
...
OpenCode Zen fungerer som enhver annen leverandør i Codark.
...
[modell-id](/docs/config/#models) i Codark-konfigurasjonen din
bruker formatet `codark/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `codark/gpt-5.5` i konfigurasjonen din.
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. Codark bruker disse modellene til å generere økttitler.
...
- DeepSeek V4 Flash Free er tilgjengelig på Codark i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på Codark i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Laguna S 2.1 Free er tilgjengelig på Codark i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling-3.0-flash Free er tilgjengelig på Codark i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på Codark i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på Codark i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Codark i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Codark også.
