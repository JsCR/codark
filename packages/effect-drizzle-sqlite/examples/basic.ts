...
class Database extends Context.Service<Database, DatabaseShape>()("@codark/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@codark/example/UserStore") {
