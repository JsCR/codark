...
export const TypeId: TypeId = "~@codark-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@codark-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@codark-ai/effect-sqlite-node/NodeSqliteClient")
