...
function useShareUrl() {
  return isMock() ? "https://dev.codark.ai" : "https://opencode.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.codark.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.codark.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
