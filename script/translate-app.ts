...
async function translate(
  ...
  env.CODARK_DISABLE_PROJECT_CONFIG = "1"
  env.CODARK_CONFIG_CONTENT = JSON.stringify(
    translationConfig(
      agent,
      model,
...
function isolatedEnvironment() {
  ...
  delete env.CODARK_CONFIG
  delete env.CODARK_CONFIG_DIR
  delete env.CODARK_CONFIG_CONTENT
  delete env.CODARK_PERMISSION
  delete env.CODARK_AUTO_SHARE
  return env
}
