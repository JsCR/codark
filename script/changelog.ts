...
Generates UPCOMING_CHANGELOG.md by running the codark changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for codark run (default: low)
      --quiet            Suppress codark command output unless it fails
